...
`,Pi=T.div`
    ...
    user-select: none;
    touch-action: none;
`,Ui=({cellWidth:e=120,fullHeight:t=800.5,lectureSummary:n,setTimeFilter:r,hover:i,setHover:o,selected:s,setSelected:a,removeFunction:d})=>{const{t:h}=Ie(),u=5,f=5,m=8,p=l.useRef(null),A=[h("common.days.monday"),h("common.days.tuesday"),h("common.days.wednesday"),h("common.days.thursday"),h("common.days.friday")];bi(n);const g=32,b=24,x=l.useMemo(()=>t/32,[t]),E=l.useMemo(()=>({"--cell-height":`${x}px`,"--cell-width":`${e}px`,"--col-padding":`${u}px`}),[x,e,u]),[D,S]=l.useState(!1),[N,R]=l.useState(null),[M,v]=l.useState(null),[C,B]=l.useState(null),[k,F]=l.useState(new Map(Array.from({length:f},(z,U)=>[U,Array(g).fill(null)]))),Q=l.useRef(null),X=l.useRef(null),K=l.useRef(null);Q.current=N,X.current=M,K.current=C;const Se=l.useCallback(z=>{if(p.current&&i==null&&s==null){const U=p.current.getBoundingClientRect(),Y=z.clientX-U.left,y=z.clientY-U.top,I=Math.floor(y/x),O=$n(Y,f,[],0,e,u,0);I>=0&&I<g&&O>=0&&O<f&&(S(!0),R(I),v(I),B(O),a(null))}},[i,s,x,g,f,e,u,a]),J=l.useCallback(z=>{if(D&&p.current){const U=p.current.getBoundingClientRect(),Y=z.clientY-U.top,y=Math.floor(Y/x);y>=0&&y<g&&C!=null&&C>=0&&C<f&&y!==M&&v(y)}},[D,x,g,f,C,M]),_=l.useCallback(()=>{F(new Map(Array.from({length:f},(y,I)=>[I,Array(g).fill(null)])));const z=Q.current,U=X.current,Y=K.current;if(z!=null&&U!=null&&Y!=null){const y=Math.min(z,U),I=Math.max(z,U),O={day:Y,begin:y*30+480,end:(I+1)*30+480};r(O)}R(null),v(null),S(!1)},[f,g,r]),H=l.useCallback(z=>{if(p.current&&i==null&&s==null){const U=z.touches[0];if(!U)return;const Y=p.current.getBoundingClientRect(),y=U.clientX-Y.left,I=U.clientY-Y.top,O=Math.floor(I/x),G=$n(y,f,[],0,e,u,0);O>=0&&O<g&&G>=0&&G<f&&(S(!0),R(O),v(O),B(G),a(null))}},[i,s,x,g,f,e,u,a]),ee=l.useCallback(z=>{if(D&&p.current){const U=z.touches[0];if(!U)return;const Y=p.current.getBoundingClientRect(),y=U.clientY-Y.top,I=Math.floor(y/x);I>=0&&I<g&&C!=null&&C>=0&&C<f&&I!==M&&v(I)}},[D,x,g,f,C,M]),ce=l.useCallback(()=>{_()},[_]);l.useEffect(()=>(D&&window.addEventListener("mouseup",_),()=>{window.removeEventListener("mouseup",_)}),[D,_]);const q=(z,U,Y)=>{const y=new Map(Array.from({length:f},(I,O)=>[O,Array(g).fill(null)]));for(let I=z;I<U+1;I++)y.get(Y)[I]=!0;return y};l.useLayoutEffect(()=>{if(p.current&&D){const z=Math.min(N,M),U=Math.max(N,M),Y=q(z,U,C);F(Y)}},[M,N,D,C,f,g]);const V=l.useMemo(()=>wi(g,f,e,x,u,[],10,0),[g,f,e,x,u]),re=l.useMemo(()=>xi(n,e,x,u,s,a,i,o,D,d),[n,e,x,u,s,a,i,o,D,d]),we=l.useCallback(()=>{a(null)},[a]),ie=l.useCallback(z=>{z.stopPropagation(),_()},[_]);return w(Oi,{style:E,children:[c(Bi,{children:Array.from({length:b-m+1},(z,U)=>U+m).map(z=>c(P,{color:"Text.default",children:z%12||12},z))}),w(L,{direction:"column",gap:0,children:[c(L,{direction:"row",gap:5,children:A.map((z,U)=>z!=="none"&&c(zi,{style:z===""?{width:"10px"}:void 0,children:c(P,{color:"Text.default",children:z})},U))}),w(Pi,{ref:p,onClick:we,onMouseDown:Se,onMouseMove:J,onMouseUp:ie,onTouchStart:H,onTouchMove:ee,onTouchEnd:ce,children:[V,Ei(!0,k,"rgba(229, 76, 101, 0.5)",x,e,2,u,[],0,0),re]})]})]})},jn=se.memo(Ui);function Dr(e){return e.map(t=>t.name).join(", ")}function Fi(e){return e.slice().sort((n,r)=>{const i=n.day,o=r.day;return i!==o?i-o:n.begin-r.begin}).map(n=>n.str).join(" / ")}function $i(e){const t={};return e.forEach(n=>{const r=n.buildingCode,i=n.roomName;r in t?t[r]&&!t[r].includes(i)&&(t[r]=t[r].concat(`, ${i}`)):t[r]=i}),Object.entries(t).map(([n,r])=>`(${n}) ${r}`).join(" / ")}const ji=T(L)`
    width: 100%;
`,Wi=T(L)`
    width: 300px;
    padding: 10px;
...
`,qn=T.div`
    ...
    align-self: center;
`,ro=({course:e,selectedLecture:t,hoveredLecture:n,isInWish:r,isWishlist:i,currentTimetableId:o,timetableLectures:s,isAddTimetablePending:a,setHoveredLecture:d,setSelectedLecture:h,handleLikeClick:u,handleAddToTimetable:f,t:m})=>{const{status:p}=xt(),A=je(),g=$e("tablet"),b=e.lectures[0]?.courseId??-1,x=t!=null&&t.courseId!==b?.3:1;return w(eo,{isSelected:t?.courseId===b,style:{opacity:x},children:[w(to,{children:[w(L,{direction:"row",gap:6,style:{opacity:e.completed?.3:1},children:[c(P,{type:"NormalBold",color:"Text.default",children:e.name}),c(P,{type:"Normal",color:"Text.default",children:e.code})]}),e.completed?c(P,{type:"Normal",color:"Text.default",children:m("common.completedCourse")}):c(P,{type:"Normal",color:"Highlight.default",children:e.type})]}),c(qn,{}),e.lectures.map((E,D)=>{const S=r.includes(E.id),N=n?.some(R=>R.id===E.id)===!0;return w(se.Fragment,{children:[w(no,{"data-lecture-id":E.id,onMouseEnter:()=>{g||d([E])},onMouseLeave:()=>{g||d(null)},onClick:()=>{if(E.id===t?.id){h(null);return}h(E)},isHighlighted:t?.id===E.id||N,children:[w(L,{direction:"column",gap:0,children:[g&&N&&w(P,{type:"Small",color:"Text.placeholder",children:[E.department.name," / ",E.type]}),w(L,{direction:"row",gap:6,style:{opacity:e.completed?.3:1},children:[c(P,{type:"NormalBold",color:"Text.default",children:E.classNo}),c(P,{type:"Normal",color:"Text.default",children:Dr(E.professors)})]}),g&&N&&w(P,{type:"Small",color:"Text.placeholder",children:[E.classes[0]?.buildingName," ",E.classes[0]?.roomName," /"," ",E.limitPeople]})]}),w(L,{direction:"row",gap:6,onClick:R=>R.stopPropagation(),children:[!g&&p==="success"&&(S||i?c(ne,{size:15,color:A.colors.Highlight.default,onClick:()=>u(S,E.id),children:c(bn,{})}):c(ne,{size:15,color:A.colors.Text.default,onClick:()=>u(S,E.id),children:c(Cr,{})})),(!g||n?.some(R=>R.id===E.id))&&c("span",{title:o==null&&p==="success"?m("timetable.myTimeTableLectureAddWarning"):"",style:{opacity:o==null&&p==="success"||s.some(R=>vt(R.classes,E.classes))?.3:1,cursor:a?"wait":"pointer"},children:c(ne,{size:g?30:15,color:A.colors.Text.default,onClick:()=>f(E),children:c(yn,{})})})]})]}),D!==e.lectures.length-1&&c(qn,{})]},E.id)})]})},io=l.memo(ro,(e,t)=>{if(e.course!==t.course||e.isInWish!==t.isInWish||e.isWishlist!==t.isWishlist||e.currentTimetableId!==t.currentTimetableId||e.timetableLectures!==t.timetableLectures||e.isAddTimetablePending!==t.isAddTimetablePending||e.selectedLecture!==t.selectedLecture)return!1;const n=e.hoveredLecture,r=t.hoveredLecture;if(n===r)return!0;const i=e.course.lectures.map(a=>a.id),o=n?.some(a=>i.includes(a.id))??!1,s=r?.some(a=>i.includes(a.id))??!1;return!o&&!s}),oo=T(L)`
    width: 100%;
    height: 100%;
    overflow: hidden;
`,ao=T(L)`
...
`,Js=T(L)`
    ...
    border-radius: 12px;
    white-space: nowrap;
`,bl=gi(function(){const{status:t}=xt(),n=vn(),r=je(),i=$e("tablet"),o=$e("laptop"),s=$e("desktop"),a=l.useRef(null),d=l.useRef(null),h=l.useRef(null),[u,f]=l.useState(null),[m,p]=l.useState(null),[A,g]=l.useState(null),[b,x]=l.useState(null),[E,D]=l.useState(""),[S,N]=l.useState(-1),[R,M]=l.useState(1),[v,C]=l.useState(0),[B,k]=l.useState(0),[F,Q]=l.useState(!1),[X,K]=l.useState([]),{query:Se}=ue("GET",`/timetables/${b}`,{enabled:b!==null&&t==="success"}),{query:J,setParams:_}=ue("GET","/timetables/my-timetable",{enabled:b===null&&t==="success"}),H=t!=="success"?X:b===null?J.data?.lectures??[]:Se.data?.lectures??[],{requestFunction:ee}=ue("PATCH",`/timetables/${b}`,{onSuccess:()=>{n.invalidateQueries({queryKey:[`/timetables/${b}`]}).then(()=>{p(null),f(null)})}}),ce=l.useCallback(V=>{K(re=>re.filter(we=>we.id!==V)),p(null),f(null)},[]),q=l.useCallback(V=>{ee({action:"delete",lectureId:V})},[ee]);return l.useEffect(()=>{f(null),p(null)},[F]),l.useEffect(()=>{function V(){d.current&&(C(d.current.offsetWidth),k(d.current.offsetHeight))}return V(),window.addEventListener("resize",V),()=>window.removeEventListener("resize",V)},[F]),l.useEffect(()=>{const V=re=>{a.current&&!a.current.contains(re.target)&&d.current&&!d.current.contains(re.target)&&h.current&&h.current.contains(re.target)&&p(null)};return document.addEventListener("mousedown",V),()=>document.removeEventListener("mousedown",V)},[]),l.useEffect(()=>{p(null),f(null),S!==-1&&_({year:S,semester:R}),K([])},[S,R]),l.useEffect(()=>{p(null),f(null)},[b]),l.useEffect(()=>{A!==null&&i&&Q(!0)},[A]),c(Xs,{direction:i?"column":"row",align:"stretch",justify:"center",gap:i?8:12,flex:"1 0 0",ref:h,children:i?w(et,{children:[w(yr,{direction:"column",gap:0,align:"stretch",justify:"stretch",style:F?{flex:"1 1 0",minHeight:0}:void 0,children:[c(or,{timeTableLectures:H,currentTimetableId:b,setCurrentTimetableId:x,setCurrentTimetableName:D,year:S,semester:R,setYear:N,setSemester:M}),c(br,{direction:"column",gap:12,align:"stretch",justify:"flex-start",flex:"1 0 0",children:c(xr,{direction:"column",gap:0,ref:d,children:c(jn,{cellWidth:(v-60)/5,fullHeight:B-60,lectureSummary:H,setTimeFilter:g,hover:u,setHover:f,selected:m,setSelected:p,removeFunction:t==="success"?b===null?void 0:q:ce})})})]}),c(Er,{children:c(mr,{timetableName:E,timetableLectures:H,hover:u,setHover:f,year:S,semester:R})}),w(Js,{direction:"row",gap:0,children:[c(mn,{timetableName:E,timetableLectures:H,year:S,semester:R}),w(L,{direction:"row",gap:4,align:"center",style:{height:"100%"},onClick:()=>{Q(!F)},children:[c(ne,{size:16,color:r.colors.Highlight.default,children:c(mi,{})}),c(P,{type:"Normal",color:"Highlight.default",children:F?"검색 닫기":"과목 검색하기"})]})]}),F&&c(vr,{direction:"row",align:"flex-start",gap:12,ref:a,children:c(wr,{children:c(Yn,{timetableLectures:H,year:S,semester:R,setNonLoginTimetable:K,hoveredLecture:u,selectedLecture:m,setSelectedLecture:p,setHoveredLecture:f,timeFilter:A,setTimeFilter:g,currentTimetableId:b})})}),m&&c(vi,{isOpen:!!m,onClose:()=>{},fullScreen:!0,header:!1,children:c(Hn,{setNonLoginTimetable:K,handleRemoveFromTimetable:t==="success"?b===null?void 0:q:ce,selectedLecture:m||(u?.length==1?u[0]:null),year:S,semester:R,onMobileModalClose:()=>{f(null),p(null)},currentTimetableId:b,timetableLectures:H})})]}):w(et,{children:[w(vr,{direction:s?"column-reverse":"row",align:"flex-start",gap:12,ref:a,children:[o&&c(Qs,{children:c(mn,{timetableName:E,timetableLectures:H,year:S,semester:R})}),c(wr,{style:{overflow:"auto"},children:c(Yn,{timetableLectures:H,year:S,semester:R,setNonLoginTimetable:K,hoveredLecture:u,selectedLecture:m,setSelectedLecture:p,setHoveredLecture:f,timeFilter:A,setTimeFilter:g,currentTimetableId:b})}),!s&&c(ft,{direction:"column"}),c(Ks,{style:{overflow:"auto"},children:c(Hn,{selectedLecture:m||(u?.length==1?u[0]:null),year:S,semester:R})})]}),c(L,{direction:"row",gap:0,children:w(yr,{direction:"column",gap:0,children:[c(or,{timeTableLectures:H,currentTimetableId:b,setCurrentTimetableId:x,setCurrentTimetableName:D,year:S,semester:R,setYear:N,setSemester:M}),w(br,{direction:o?"column":"row",gap:o?12:30,align:"stretch",justify:"flex-start",flex:"1 0 0",children:[c(xr,{direction:"column",gap:0,ref:d,children:c(jn,{cellWidth:100,fullHeight:o?B-60:B-36,lectureSummary:H,setTimeFilter:g,hover:u,setHover:f,selected:m,setSelected:p,removeFunction:t==="success"?b===null?void 0:q:ce})}),!o&&c(ft,{direction:"column"}),c(Er,{children:c(mr,{timetableName:E,timetableLectures:H,hover:u,setHover:f,year:S,semester:R})})]})]})})]})})});export{bl as default};
//# sourceMappingURL=timetable-CFO9ixTs.js.map
