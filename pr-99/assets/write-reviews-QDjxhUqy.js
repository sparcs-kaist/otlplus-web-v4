import{r as p,p as v,w as D}from"./chunk-EPOLDU6W-KpoCz4BB.js";import{a as l,j as t,u as q,F as j}from"./emotion-react-jsx-runtime.browser.esm-8UMkxFz9.js";import{n as f,F as n}from"./FlexWrapper-B5D4Zkyg.js";import{I as T,k as B,g as $,l as L,u as O,q as G,e as k}from"./useIsDevice-Cuofnmc6.js";import{L as _}from"./Lock-B90oHjHy.js";import{L as M}from"./Line-CY5GzvPT.js";import{L as b}from"./LoadingCircle-8Hs_QblI.js";import{T as u}from"./Typography-KcI2YyzW.js";import{W as z}from"./Widget-Dmlt48UI.js";import{E as A,a as K,u as P,b as W,S as U,C as Y}from"./Credits-DEzHjgjB.js";import{u as S}from"./useTranslation-ByazR4ZC.js";import{m as F}from"./media-BxBRMMAq.js";import{a as J}from"./handleLoginLogout-_lrm3xlO.js";import{u as I}from"./useUserStore-BX_Omjgh.js";import{R as E,F as Q,a as X}from"./ReviewBlock-UPj_rFBj.js";import{T as C}from"./Trans-l4mlJpBm.js";import{t as Z}from"./index-D47CrH3F.js";import{R as ee}from"./ReviewWritingBlock-eP9mpV_N.js";import"./env-DAdN_rdt.js";import"./IconButton-DcufPfG_.js";import"./infiniteQueryBehavior-DBr2B1Se.js";import"./queryPersister-DpBE5i1r.js";import"./TextInputArea-8AkKuCau.js";(function(){try{var e=typeof window<"u"?window:typeof global<"u"?global:typeof globalThis<"u"?globalThis:typeof self<"u"?self:{};e.SENTRY_RELEASE={id:"d1eb23f3da0295132181d6b2224cb1631fc7940e"}}catch{}})();try{(function(){var e=typeof window<"u"?window:typeof global<"u"?global:typeof globalThis<"u"?globalThis:typeof self<"u"?self:{},r=new e.Error().stack;r&&(e._sentryDebugIds=e._sentryDebugIds||{},e._sentryDebugIds[r]="abace3b3-c61c-4ea3-b7ac-ed0c3c1b8795",e._sentryDebugIdIdentifier="sentry-dbid-abace3b3-c61c-4ea3-b7ac-ed0c3c1b8795")})()}catch{}const te=f.div`
    width: 200px;
    flex-shrink: 1;
    position: relative;
    user-select: none;
...
`;function ue({lecture:e,isSelected:r,written:o}){const{status:c}=I(),[d,s]=p.useState(!1);return l(de,{direction:"column",align:"center",gap:2,padding:"8px 10px",isHovered:d,isSelected:r,written:o,onMouseOver:()=>{c!=="idle"&&s(!0)},onMouseLeave:()=>{c!=="idle"&&s(!1)},children:[l(n,{direction:"row",gap:8,justify:o?"space-between":"center",align:"center",style:{width:"100%"},children:[o&&t("div",{style:{width:"37px"}}),t(u,{type:"NormalBold",color:"Text.default",children:e.name}),o&&t(u,{type:"Smaller",color:"Text.lighter",children:"작성 완료"})]}),t(u,{type:"Normal",color:"Text.default",children:e.code})]})}function V(e,r,o,c){return e.courseId===r.courseId&&o===r.year&&c===r.semester}function pe({lectureWrapIndex:e,lecturesWrap:r,selectedLecture:o,setSelectedLecture:c,setSelectedLectureIndex:d,last:s}){const{status:a}=I();return l(n,{direction:"column",align:"stretch",justify:"stretch",gap:10,children:[l(u,{type:"NormalBold",color:"Text.default",children:[r.year," ",B(r.semester)]}),t(n,{direction:"column",align:"stretch",justify:"stretch",gap:8,children:r.lectures.map((h,g)=>t(n,{direction:"column",gap:0,align:"stretch",justify:"stretch",onClick:()=>{if(a==="idle")return;if(o&&V(h,o,r.year,r.semester)){c(null),d(null);return}const{name:y,courseId:w,professors:i}=h,{year:x,semester:m}=r;c({name:y,courseId:w,lectureId:h.lectureId,professors:i,year:x,semester:m}),d([e,g])},children:t(ue,{lecture:h,isSelected:o?V(h,o,r.year,r.semester):!1,written:h.written},g)},g))}),!s&&t(M,{height:2,color:"Line.divider"})]})}const H=p.memo(pe),he=f(n)`
    min-height: 0;
...
//# sourceMappingURL=write-reviews-QDjxhUqy.js.map
