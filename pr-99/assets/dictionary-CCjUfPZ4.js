import{p as O,r as l,z as P,w as X}from"./chunk-EPOLDU6W-KpoCz4BB.js";import{j as t,a as i,u as N,F as C}from"./emotion-react-jsx-runtime.browser.esm-8UMkxFz9.js";import{n as r,F as a}from"./FlexWrapper-B5D4Zkyg.js";import{M as Z}from"./Modal-ClsSGgFq.js";import{W as J}from"./Widget-Dmlt48UI.js";import{m as Q,C as ee}from"./proxy-xnzn-AwB.js";import{u as F,b as _,C as te,S as oe}from"./Credits-DEzHjgjB.js";import{L as S}from"./LoadingCircle-8Hs_QblI.js";import{R as re}from"./ReviewWritingBlock-eP9mpV_N.js";import{e as G,g as V,I as $,k as ne,t as E,v as ie,u as le}from"./useIsDevice-Cuofnmc6.js";import{T as u}from"./Typography-KcI2YyzW.js";import{I as ce}from"./IconButton-DcufPfG_.js";import{p as ae,R as se}from"./ReviewBlock-UPj_rFBj.js";import{u as T}from"./useTranslation-ByazR4ZC.js";import{c as H,S as de}from"./checkEmpty-BAHS_Rtx.js";import{t as R}from"./index-D47CrH3F.js";import{T as pe}from"./Trans-l4mlJpBm.js";import{m as I}from"./media-BxBRMMAq.js";import"./index-BTs-AZcE.js";import"./infiniteQueryBehavior-DBr2B1Se.js";import"./TextInputArea-8AkKuCau.js";import"./useUserStore-BX_Omjgh.js";import"./env-DAdN_rdt.js";(function(){try{var e=typeof window<"u"?window:typeof global<"u"?global:typeof globalThis<"u"?globalThis:typeof self<"u"?self:{};e.SENTRY_RELEASE={id:"d1eb23f3da0295132181d6b2224cb1631fc7940e"}}catch{}})();try{(function(){var e=typeof window<"u"?window:typeof global<"u"?global:typeof globalThis<"u"?globalThis:typeof self<"u"?self:{},o=new e.Error().stack;o&&(e._sentryDebugIds=e._sentryDebugIds||{},e._sentryDebugIds[o]="497e25c8-8087-4969-ac41-7eebafccd428",e._sentryDebugIdIdentifier="sentry-dbid-497e25c8-8087-4969-ac41-7eebafccd428")})()}catch{}const q=G(O.jsx("path",{d:"M12 2C6.47 2 2 6.47 2 12s4.47 10 10 10 10-4.47 10-10S17.53 2 12 2"})),ue=G(O.jsx("path",{d:"M7.41 8.59 12 13.17l4.59-4.58L18 10l-6 6-6-6z"})),U=r.div`
    min-width: 150px;
    height: 28px;
    display: inline-flex;
    padding: 8px 16px;
...
`,z=({selectedCourseId:e,isMobileModal:o=!1,onMobileModalClose:d})=>{const p=N(),[f,x]=P(),{query:s}=le("GET",`/courses/${e}`,{enabled:e!==null}),[w,y]=l.useState(null),[c,g]=l.useState([]);return l.useEffect(()=>{if(s.data){const n=[];s.data.history.forEach(m=>{if(m.myLectureId!==null){const h=m.classes.find(k=>k.lectureId===m.myLectureId)?.professors||[];n.push({name:s.data.name,lectureId:m.myLectureId,professors:h,year:m.year,semester:m.semester})}}),g(n)}},[s.data]),l.useEffect(()=>{y(null);const n=f.get("professorId");if(n){const m=parseInt(n,10);isNaN(m)?y(null):(y(m),x({}))}},[e]),t(Re,{direction:"column",gap:12,align:"center",justify:e?"start":"center",children:e?s.isLoading?t(S,{}):i(C,{children:[i(Me,{direction:"column",gap:2,align:"center",justify:"center",children:[i(a,{direction:"row",align:"center",gap:8,justify:o?"space-between":"center",style:{width:"100%"},children:[o&&t("div",{style:{width:20}}),t(u,{type:"Bigger",color:"Text.default",children:s.data?.name}),o&&t($,{size:20,onClick:d,color:p.colors.Text.default,children:t(ee,{})})]}),t(u,{type:"Big",color:"Text.default",children:s.data?.code})]}),t(j,{direction:"column",gap:10,align:"center",children:t(Be,{courseDetail:s.data})}),t(D,{}),t(j,{direction:"column",gap:0,children:t(ke,{courseDetail:s.data,selectedProfessorId:w,setSelectedProfessorId:y})}),t(D,{}),t(j,{direction:"column",gap:10,flex:"1 1 auto",children:t(Pe,{selectedCourseId:e,selectedProfessorId:w,writableReviewProps:c})})]}):t(te,{})})},He=r.div`
    width: 100%;
    border-radius: 7px;
    padding: 8px 10px;
