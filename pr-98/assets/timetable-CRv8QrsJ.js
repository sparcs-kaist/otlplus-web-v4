import{p as rt,R as se,r as l,L as gi,w as mi}from"./chunk-EPOLDU6W-B8pbzjzn.js";import{a as w,j as c,F as tt,u as We}from"./emotion-react-jsx-runtime.browser.esm-CDSRZb9c.js";import{n as T,F as L}from"./FlexWrapper-B3ayG6XS.js";import{C as sn,S as vi}from"./proxy-0Eh_byPi.js";import{u as bn,t as Oe}from"./index-CjmaIs_R.js";import{M as bi}from"./Modal-uLtOsEsy.js";import{S as pt}from"./StyledDivider-D9j3PItC.js";import{e as it,t as _e,g as je,u as ue,I as re,k as ln,q as Ve,W as Re,w as yi}from"./useIsDevice-B4XmIr43.js";import{T as z}from"./Typography-BI6YlVsB.js";import{c as wi,r as xi,a as Ei,b as Ti,d as bt}from"./renderTargetArea-vKsQsogt.js";import{u as Ie}from"./useTranslation-DcygOF4d.js";import{A as yn,S as Si,c as Ci,C as Vt}from"./checkEmpty-DEFte7zt.js";import{R as Di,F as wn,p as Ri}from"./ReviewBlock-FBf6qgCF.js";import{B as Gt,m as W}from"./media-D8HfPojw.js";import{u as Sr,b as Cr,C as Ai,S as Ii}from"./Credits-D6mGogts.js";import{u as Et}from"./useUserStore-BXC7wunu.js";import{L as cn}from"./LoadingCircle-ByjUXXHJ.js";import{a as ft}from"./index-DkMko15w.js";import{I as nt}from"./IconButton-BQahT8lO.js";import"./env-DlHMDNNS.js";import"./infiniteQueryBehavior-CyNQWS9g.js";const Ni=it(rt.jsx("path",{d:"M19 4h-1V2h-2v2H8V2H6v2H5c-1.11 0-1.99.9-1.99 2L3 20c0 1.1.89 2 2 2h14c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2m0 16H5V10h14zM9 14H7v-2h2zm4 0h-2v-2h2zm4 0h-2v-2h2zm-8 4H7v-2h2zm4 0h-2v-2h2zm4 0h-2v-2h2z"})),xn=it(rt.jsx("path",{d:"M16 1H4c-1.1 0-2 .9-2 2v14h2V3h12zm3 4H8c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h11c1.1 0 2-.9 2-2V7c0-1.1-.9-2-2-2m0 16H8V7h11z"})),Dr=it(rt.jsx("path",{d:"M16.5 3c-1.74 0-3.41.81-4.5 2.09C10.91 3.81 9.24 3 7.5 3 4.42 3 2 5.42 2 8.5c0 3.78 3.4 6.86 8.55 11.54L12 21.35l1.45-1.32C18.6 15.36 22 12.28 22 8.5 22 5.42 19.58 3 16.5 3m-4.4 15.55-.1.1-.1-.1C7.14 14.24 4 11.39 4 8.5 4 6.5 5.5 5 7.5 5c1.54 0 3.04.99 3.57 2.36h1.87C13.46 5.99 14.96 5 16.5 5c2 0 3.5 1.5 3.5 3.5 0 2.89-3.14 5.74-7.9 10.05"})),Mi=it(rt.jsx("path",{d:"M21 19V5c0-1.1-.9-2-2-2H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2M8.5 13.5l2.5 3.01L14.5 12l4.5 6H5z"})),Li=it(rt.jsx("path",{d:"M15.41 7.41 14 6l-6 6 6 6 1.41-1.41L10.83 12z"})),ki=it(rt.jsx("path",{d:"M10 6 8.59 7.41 13.17 12l-4.58 4.59L10 18l6-6z"})),Oi=(e,t,n,r,i,o)=>{const s=[0];let a=0;for(let d=0;d<e;d++)t.includes(d+o)?(a+=n+i,s.push(a)):(a+=r+i,s.push(a));return s},jn=(e,t,n,r,i,o,s)=>{const a=Oi(t,n,r,i,o,s);for(let d=0;d<t+1;d++){const f=a[d];if(f!==void 0&&f>e)return d-1}return t},Bi=T.div`
    display: flex;
    flex-direction: row;
    gap: 5px;
    align-items: center;
...
`,Ki=({selectedCourseId:e,selectedProfessorId:t})=>{const{t:n}=Ie(),[r,i]=l.useState(!1),{query:o,setParams:s,data:a}=Sr("GET","/reviews",{gcTime:0,infinites:["reviews"],limit:20}),{ref:d,inView:f}=Cr({threshold:0});return l.useEffect(()=>{i(!1);const u=setTimeout(()=>{s({mode:"default",courseId:e??void 0,professorId:t??void 0}),i(!0)},1e3);return()=>clearTimeout(u)},[e,t]),l.useEffect(()=>{f&&o.hasNextPage&&!o.isFetchingNextPage&&o.fetchNextPage()},[f,o]),!a||!r?c(cn,{}):w(tt,{children:[c(L,{direction:"row",gap:0,justify:"center",align:"center",style:{width:"100%"},children:c(Vi,{direction:"row",gap:0,justify:"space-between",align:"center",children:[[_e(a?.averageGrade,a?.reviews.length),n("common.grade")],[_e(a?.averageLoad,a?.reviews.length),n("common.load")],[_e(a?.averageSpeech,a?.reviews.length),n("common.speech")]].map(([u,h],m)=>w(Gi,{direction:"column",gap:0,align:"center",children:[c(z,{type:"Bigger",color:"Text.default",children:u}),c(z,{type:"Smaller",color:"Text.default",children:h})]},m))})}),c(Xi,{}),a?.reviews.map(u=>c(Di,{review:u,linkToDictionary:!0},u.id)),o.hasNextPage&&c(cn,{ref:d})]})},Qi=T(L)`
    width: 100%;
    height: 100%;
    overflow-x: hidden;
    overflow-y: auto;
...
`,e+="DURATION:"+Ze(this.data.repeat.interval)+`\r
...
`),this.data.ttl&&(e+="REFRESH-INTERVAL;VALUE=DURATION:"+Ze(this.data.ttl)+`\r
`,e+="X-PUBLISHED-TTL:"+Ze(this.data.ttl)+`\r
