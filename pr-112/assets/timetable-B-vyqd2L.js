...
`;function to({year:e,semester:t,timeFilter:n,setTimeFilter:r,data:i,setSearchResult:o,isWishlist:a,setIsWishlist:s,setWishlist:d,sortOption:h,setSortOption:u,handleSearch:f,t:g}){const p=$e(),{user:A,status:v}=ot(),{query:m,setParams:y}=ne("GET",`/users/${A?.id}/wishlist`,{enabled:v==="success"&&e!=-1});return c.useEffect(()=>{m.data!==void 0&&o(a?m.data:i??{courses:[]})},[a,i]),c.useEffect(()=>{m.data!==void 0&&(d(m.data.courses.flatMap(S=>S.lectures).map(S=>S.id)),a&&o(m.data))},[m.data]),c.useEffect(()=>{o({courses:[]}),e!==-1&&y({year:e,semester:t})},[e,t]),c.useEffect(()=>{i!==void 0&&(o(i),s(!1))},[i]),w(We,{children:[l(Zi,{direction:"row",justify:"stretch",gap:0,children:l(wi,{options:["type","department","level","term","time"],timeFilter:n,setTimeFilter:r,onSearch:f})}),w(L,{direction:"row",gap:0,justify:"space-between",align:"center",children:[w(eo,{isSelected:a,onClick:()=>{s(S=>!S)},style:{paddingBlock:10},children:[l(X,{size:15,color:p.colors.Highlight.default,children:a?l(yn,{}):l(Tr,{})}),l(z,{type:"Normal",color:"Highlight.default",children:g("common.wishlist")})]}),l(_i,{direction:"row",gap:0,children:l(Ci,{options:[g("dictionary.sortOptions.code"),g("dictionary.sortOptions.popularity"),g("dictionary.sortOptions.studentCount")],setSelectedOption:u,selectedOption:h})})]})]})}const no=c.memo(to,(e,t)=>e.year===t.year&&e.semester===t.semester&&e.timeFilter===t.timeFilter&&e.sortOption===t.sortOption&&e.isWishlist===t.isWishlist&&e.data===t.data),ro=x(L)`
    width: 100%;
    height: 100%;
    overflow: hidden;
`,io=x(z)`
