(function(){try{var e=typeof window<`u`?window:typeof global<`u`?global:typeof globalThis<`u`?globalThis:typeof self<`u`?self:{};e.SENTRY_RELEASE={id:`04f99a84a33da6b2411eaa4f28e597f199cd8304`};var t=new e.Error().stack;t&&(e._sentryDebugIds=e._sentryDebugIds||{},e._sentryDebugIds[t]=`1680e6ac-fefa-48c0-b30c-7dcd7cf1d2e4`,e._sentryDebugIdIdentifier=`sentry-dbid-1680e6ac-fefa-48c0-b30c-7dcd7cf1d2e4`)}catch{}})();import{n as e,s as t}from"./jsx-runtime-DQZkNfYZ.js";import{n,r}from"./emotion-react-jsx-runtime.browser.esm-BIbiulM2.js";import{n as i,t as a}from"./FlexWrapper-xkL9gFG_.js";import{i as o,n as s}from"./emotion-react.browser.esm-CnS4UFBy.js";import{i as c}from"./useAPI-B6EvQyYy.js";import{t as l}from"./Icon-YPAC_3r9.js";import{t as u}from"./IconButton-l5eMYWHq.js";import{t as d}from"./useTranslation-DvcTptMS.js";import{t as f}from"./Close-IT9ogkMZ.js";import{t as p}from"./Typography-BwL_QPxQ.js";var m=t(e()),h=i.div`
    width: 100%;
    height: 100%;
    display: grid;
    position: relative;
...
`;function P({lecture:e,classIdx:t,deleteLecture:i}){let o=t==null?null:e.classes[t],{t:s}=d();return r(M,{direction:`column`,gap:2,align:`stretch`,justify:`stretch`,padding:`2px`,flex:`1 1 auto`,lectureId:e.id,children:[n(a,{direction:`column`,gap:0,align:`center`,children:o!=null&&g[o.day]&&o.begin!=null&&o.end!=null?r(p,{type:`Smaller`,color:`Text.light`,children:[s(`common.days.${g[o.day]}`),` `,Math.floor(o.begin/60),`:`,o.begin%60==0?`00`:`30`,` - `,Math.floor(o.end/60),`:`,o.end%60==0?`00`:`30`]}):n(p,{type:`Smaller`,color:`Text.light`,children:s(`timetable.noTimeInfo`)})}),r(N,{direction:`column`,gap:0,align:`flex-start`,padding:`6px`,courseId:e.courseId,lectureId:e.id,flex:`1 1 auto`,className:x,children:[n(p,{type:`SmallMedium`,className:`lecture-title`,color:`TimeTable.title`,children:e.name+` `+e.subtitle}),n(p,{type:`Small`,className:`lecture-info`,color:`TimeTable.detail`,children:e.professors.map(e=>e.name).join(`, `)}),n(p,{type:`Small`,className:`lecture-info`,color:`TimeTable.detail`,children:o==null?``:`(${o.buildingCode}) ${o.roomName}`}),i&&n(E,{direction:`column`,flex:`1 1 auto`,gap:0,className:`lecture-delete-wrapper`,onPointerDown:e=>e.stopPropagation(),onClick:e=>e.stopPropagation(),children:n(u,{styles:{padding:3},onClick:()=>i(),children:n(l,{size:12,style:{color:`rgba(255, 255, 255, 0.6)`,opacity:1,pointerEvents:`auto`},children:n(f,{})})})})]})]})}var F=8,te=24,I=Array.from({length:17},(e,t)=>F+t),L=I.map(e=>(e%12||12).toString()),R=(L.length-1)*2,z=[`monday`,`tuesday`,`wednesday`,`thursday`,`friday`],B=20,ne=.8,V=5,H=1,re=i(h)`
    z-index: 1;
`,ie=i(a)`
    grid-row: 1 / ${R+5};
    user-select: none;
