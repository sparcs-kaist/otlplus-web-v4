import{R as ne,r as l,L as pi,w as gi}from"./chunk-UIGDSWPH-C2ktfSeF.js";import{a as nt,b,j as c,F as et,u as je}from"./emotion-react-jsx-runtime.browser.esm-B1jPEyiZ.js";import{n as S,F as L}from"./FlexWrapper-BDdwpRDn.js";import{C as Er,S as mi}from"./proxy-CHNK_1cF.js";import{e as rt,z as Ze,g as hn,i as $e,u as le,I as re,w as tn,y as Ye,W as De,B as vi}from"./useIsDevice-BpsLcui9.js";import{M as yi}from"./Modal-D3IaEUVT.js";import{S as ft}from"./StyledDivider-B37NlZR4.js";import{T as P}from"./Typography-DRNB4_Lw.js";import{c as bi,r as wi,a as xi,b as Ei,d as fn}from"./renderTargetArea-CN9PESTO.js";import{u as Ae,B as Un,m as W}from"./media-ipby3jlC.js";import{A as pn,S as Si,c as Ti,C as Wt}from"./checkEmpty-DLf17azL.js";import{R as Ci,F as gn,p as Di}from"./ReviewBlock-Dc8_OrXf.js";import{u as Sr,b as Tr,C as Ri,S as Ai,I as tt}from"./Credits-CgqZHXWr.js";import{u as mn}from"./useUserStore-CAEcH707.js";import{L as nn}from"./LoadingCircle-B_VhuW7O.js";import{a as ht}from"./index-TI0EkQ6W.js";import"./env-dr94Te9_.js";import"./infiniteQueryBehavior-DT-wsYXb.js";const Ii=rt(nt.jsx("path",{d:"M19 4h-1V2h-2v2H8V2H6v2H5c-1.11 0-1.99.9-1.99 2L3 20c0 1.1.89 2 2 2h14c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2m0 16H5V10h14zM9 14H7v-2h2zm4 0h-2v-2h2zm4 0h-2v-2h2zm-8 4H7v-2h2zm4 0h-2v-2h2zm4 0h-2v-2h2z"})),vn=rt(nt.jsx("path",{d:"M16 1H4c-1.1 0-2 .9-2 2v14h2V3h12zm3 4H8c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h11c1.1 0 2-.9 2-2V7c0-1.1-.9-2-2-2m0 16H8V7h11z"})),Cr=rt(nt.jsx("path",{d:"M16.5 3c-1.74 0-3.41.81-4.5 2.09C10.91 3.81 9.24 3 7.5 3 4.42 3 2 5.42 2 8.5c0 3.78 3.4 6.86 8.55 11.54L12 21.35l1.45-1.32C18.6 15.36 22 12.28 22 8.5 22 5.42 19.58 3 16.5 3m-4.4 15.55-.1.1-.1-.1C7.14 14.24 4 11.39 4 8.5 4 6.5 5.5 5 7.5 5c1.54 0 3.04.99 3.57 2.36h1.87C13.46 5.99 14.96 5 16.5 5c2 0 3.5 1.5 3.5 3.5 0 2.89-3.14 5.74-7.9 10.05"})),Ni=rt(nt.jsx("path",{d:"M21 19V5c0-1.1-.9-2-2-2H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2M8.5 13.5l2.5 3.01L14.5 12l4.5 6H5z"})),Mi=rt(nt.jsx("path",{d:"M15.41 7.41 14 6l-6 6 6 6 1.41-1.41L10.83 12z"})),Li=rt(nt.jsx("path",{d:"M10 6 8.59 7.41 13.17 12l-4.58 4.59L10 18l6-6z"})),ki=(e,t,n,r,i,o)=>{const a=[0];let s=0;for(let u=0;u<e;u++)t.includes(u+o)?(s+=n+i,a.push(s)):(s+=r+i,a.push(s));return a},Fn=(e,t,n,r,i,o,a)=>{const s=ki(t,n,r,i,o,a);for(let u=0;u<t+1;u++){const h=s[u];if(h!==void 0&&h>e)return u-1}return t},Oi=S.div`
    display: flex;
    flex-direction: row;
    gap: 5px;
    align-items: center;
...
`,Pi=S.div`
    ...
    user-select: none;
    touch-action: none;
`,Ui=({cellWidth:e=120,fullHeight:t=800.5,lectureSummary:n,setTimeFilter:r,hover:i,setHover:o,selected:a,setSelected:s,removeFunction:u})=>{const{t:h}=Ae(),d=5,f=5,m=8,g=l.useRef(null),M=[h("common.days.monday"),h("common.days.tuesday"),h("common.days.wednesday"),h("common.days.thursday"),h("common.days.friday")];bi(n);const p=32,v=24,w=l.useMemo(()=>t/32,[t]),R=l.useMemo(()=>({"--cell-height":`${w}px`,"--cell-width":`${e}px`,"--col-padding":`${d}px`}),[w,e,d]),[y,A]=l.useState(!1),[C,I]=l.useState(null),[N,x]=l.useState(null),[D,O]=l.useState(null),[B,q]=l.useState(new Map(Array.from({length:f},(F,U)=>[U,Array(p).fill(null)]))),Y=l.useRef(null),V=l.useRef(null),ie=l.useRef(null);Y.current=C,V.current=N,ie.current=D;const G=l.useCallback(F=>{if(g.current&&i==null&&a==null){const U=g.current.getBoundingClientRect(),T=F.clientX-U.left,E=F.clientY-U.top,k=Math.floor(E/w),z=Fn(T,f,[],0,e,d,0);k>=0&&k<p&&z>=0&&z<f&&(A(!0),I(k),x(k),O(z),s(null))}},[i,a,w,p,f,e,d,s]),X=l.useCallback(F=>{if(y&&g.current){const U=g.current.getBoundingClientRect(),T=F.clientY-U.top,E=Math.floor(T/w);E>=0&&E<p&&D!=null&&D>=0&&D<f&&E!==N&&x(E)}},[y,w,p,f,D,N]),K=l.useCallback(()=>{q(new Map(Array.from({length:f},(E,k)=>[k,Array(p).fill(null)])));const F=Y.current,U=V.current,T=ie.current;if(F!=null&&U!=null&&T!=null){const E=Math.min(F,U),k=Math.max(F,U),z={day:T,begin:E*30+480,end:(k+1)*30+480};r(z)}I(null),x(null),A(!1)},[f,p,r]),H=l.useCallback(F=>{if(g.current&&i==null&&a==null){const U=F.touches[0];if(!U)return;const T=g.current.getBoundingClientRect(),E=U.clientX-T.left,k=U.clientY-T.top,z=Math.floor(k/w),_=Fn(E,f,[],0,e,d,0);z>=0&&z<p&&_>=0&&_<f&&(A(!0),I(z),x(z),O(_),s(null))}},[i,a,w,p,f,e,d,s]),oe=l.useCallback(F=>{if(y&&g.current){const U=F.touches[0];if(!U)return;const T=g.current.getBoundingClientRect(),E=U.clientY-T.top,k=Math.floor(E/w);k>=0&&k<p&&D!=null&&D>=0&&D<f&&k!==N&&x(k)}},[y,w,p,f,D,N]),ue=l.useCallback(()=>{K()},[K]);l.useEffect(()=>(y&&window.addEventListener("mouseup",K),()=>{window.removeEventListener("mouseup",K)}),[y,K]);const Z=(F,U,T)=>{const E=new Map(Array.from({length:f},(k,z)=>[z,Array(p).fill(null)]));for(let k=F;k<U+1;k++)E.get(T)[k]=!0;return E};l.useLayoutEffect(()=>{if(g.current&&y){const F=Math.min(C,N),U=Math.max(C,N),T=Z(F,U,D);q(T)}},[N,C,y,D,f,p]);const he=l.useMemo(()=>wi(p,f,e,w,d,[],10,0),[p,f,e,w,d]),we=l.useMemo(()=>xi(n,e,w,d,a,s,i,o,y,u),[n,e,w,d,a,s,i,o,y,u]),Se=l.useCallback(()=>{s(null)},[s]),Q=l.useCallback(F=>{F.stopPropagation(),K()},[K]);return b(Oi,{style:R,children:[c(Bi,{children:Array.from({length:v-m+1},(F,U)=>U+m).map(F=>c(P,{color:"Text.default",children:F%12||12},F))}),b(L,{direction:"column",gap:0,children:[c(L,{direction:"row",gap:5,children:M.map((F,U)=>F!=="none"&&c(zi,{style:F===""?{width:"10px"}:void 0,children:c(P,{color:"Text.default",children:F})},U))}),b(Pi,{ref:g,onClick:Se,onMouseDown:G,onMouseMove:X,onMouseUp:Q,onTouchStart:H,onTouchMove:oe,onTouchEnd:ue,children:[he,Ei(!0,B,"rgba(229, 76, 101, 0.5)",w,e,2,d,[],0,0),we]})]})]})},$n=ne.memo(Ui);function Dr(e){return e.map(t=>t.name).join(", ")}function Fi(e){return e.slice().sort((n,r)=>{const i=n.day,o=r.day;return i!==o?i-o:n.begin-r.begin}).map(n=>n.str).join(" / ")}function $i(e){const t={};return e.forEach(n=>{const r=n.buildingCode,i=n.roomName;r in t?t[r]&&!t[r].includes(i)&&(t[r]=t[r].concat(`, ${i}`)):t[r]=i}),Object.entries(t).map(([n,r])=>`(${n}) ${r}`).join(" / ")}const ji=S(L)`
    width: 100%;
`,Wi=S(L)`
    width: 300px;
    padding: 10px;
