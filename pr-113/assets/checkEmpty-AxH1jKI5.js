import{j as i,a as T,u as Q,c as ne,g as Y,s as G,i as oe}from"./emotion-react-jsx-runtime.browser.esm-BkQGdiC-.js";import{p as J,r as g}from"./chunk-JZWAC4HX-rllJF5Ya.js";import{s as b,F as x}from"./FlexWrapper-CqZEbmNr.js";import{T as $}from"./Typography-kAuAnoEJ.js";import{e as U,I as A,x as re,j as P,u as ie}from"./useIsDevice-BOJY-dbT.js";import{u as k}from"./useTranslation-Ckij_wXc.js";import{C as ce,S as se,m as ae,A as le}from"./proxy-vUeRKXPb.js";import{B as L}from"./media-Dx7In9SJ.js";(function(){try{var e=typeof window<"u"?window:typeof global<"u"?global:typeof globalThis<"u"?globalThis:typeof self<"u"?self:{};e.SENTRY_RELEASE={id:"cd61e8cbd077489d354d385d242852c757690997"};var n=new e.Error().stack;n&&(e._sentryDebugIds=e._sentryDebugIds||{},e._sentryDebugIds[n]="810c9adf-6cf3-4b7b-834c-a77f3e278dba",e._sentryDebugIdIdentifier="sentry-dbid-810c9adf-6cf3-4b7b-834c-a77f3e278dba")}catch{}})();const me=U(J.jsx("path",{d:"M19 13h-6v6h-2v-6H5v-2h6V5h2v6h6z"})),de=U(J.jsx("path",{d:"M9 16.17 4.83 12l-1.42 1.41L9 19 21 7l-1.41-1.41z"})),X=b.div`
    display: inline-flex;
    padding: 8px;
...
`;function Oe({options:e,onChange:n,timeFilter:t,setTimeFilter:c,resetTrigger:h,onResetTriggerComplete:d}){const{t:f}=k(),p=new Set(e);function m(o){return p.has(o)}const[s,a]=g.useState(B),[S,I]=g.useState({});function B(){const o={};return e.filter(r=>r in N).forEach(r=>{const l=N[r].length;w(r)?o[r]=null:o[r]=Array(l).fill(!1)}),o}function R(o){const r={};return Object.keys(o).forEach(l=>{const C=Z[l];w(l)?o[l]==null?r[l]=null:r[l]=C[o[l]]:r[l]=o[l].map((u,y)=>u?C[y]:null).filter(u=>u!=null)}),r}function O(o){const r={};for(const l in o){const C=o[l];C!=null&&(F(s,l)?w(l)?s[l]==null?delete r[l]:r[l]=C:!s[l].includes(!0)?delete r[l]:r[l]=C:l=="time"&&(r[l]=C))}return r}function D(o,r){a(l=>{if(w(r))return{...l,[r]:o};{const u=l[r].map((y,v)=>v===o?!y:y);return{...l,[r]:u}}})}function H(o){w(o)?a(r=>({...r,[o]:null})):a(r=>({...r,[o]:r[o].map(()=>!1)}))}function M(o,r){return w(r)?o[r]==null:!o[r].includes(!0)}return g.useEffect(()=>{const o=R(s),r={time:t};I(m("time")?{...o,...r}:o)},[s,t]),g.useEffect(()=>{const o=O(S);n(o)},[S]),g.useEffect(()=>{h&&(a(B()),m("time")&&c&&c(null),d())},[h]),i(Be,{direction:"column",align:"stretch",gap:12,children:e.map(o=>T(x,{direction:"column",gap:6,flex:"1 1 auto",children:[i($,{type:"NormalBold",color:"Text.default",children:f(`common.search.${o}`)}),i(x,{direction:"column",gap:0,style:{width:"100%"},children:(()=>{if(F(s,o)&&o in s)return i(Se,{nameList:N[o].map(r=>r[1]),chosenList:s[o],handleOptionClick:r=>{D(r,o)},handleSelectAllClick:()=>{H(o)},isSingleSelect:w(o),selectedAll:M(s,o)});if(o=="time")return i(we,{timeFilter:t,setTimeFilter:c})})()})]},o))})}function V(e,n){if(e.inserted[n.name]===void 0)return e.insert("",n,e.sheet,!0)}function K(e,n,t){var c=[],h=Y(e,c,t);return c.length<2?t:h+n(c)}var je=function(n){var t=ne(n);t.sheet.speedy=function(p){this.isSpeedy=p},t.compat=!0;var c=function(){for(var m=arguments.length,s=new Array(m),a=0;a<m;a++)s[a]=arguments[a];var S=G(s,t.registered,void 0);return oe(t,S,!1),t.key+"-"+S.name},h=function(){for(var m=arguments.length,s=new Array(m),a=0;a<m;a++)s[a]=arguments[a];var S=G(s,t.registered),I="animation-"+S.name;return V(t,{name:S.name,styles:"@keyframes "+I+"{"+S.styles+"}"}),I},d=function(){for(var m=arguments.length,s=new Array(m),a=0;a<m;a++)s[a]=arguments[a];var S=G(s,t.registered);V(t,S)},f=function(){for(var m=arguments.length,s=new Array(m),a=0;a<m;a++)s[a]=arguments[a];return K(t.registered,c,Ae(s))};return{css:c,cx:f,injectGlobal:d,keyframes:h,hydrate:function(m){m.forEach(function(s){t.inserted[s]=!0})},flush:function(){t.registered={},t.inserted={},t.sheet.flush()},sheet:t.sheet,cache:t,getRegisteredStyles:Y.bind(null,t.registered),merge:K.bind(null,t.registered,c)}},Ae=function e(n){for(var t="",c=0;c<n.length;c++){var h=n[c];if(h!=null){var d=void 0;switch(typeof h){case"boolean":break;case"object":{if(Array.isArray(h))d=e(h);else{d="";for(var f in h)h[f]&&f&&(d&&(d+=" "),d+=f)}break}default:d=h}d&&(t&&(t+=" "),t+=d)}}return t},ke=je({key:"css"}),_=ke.css;const Re=_`
    border-color: red;
`,De=_`
