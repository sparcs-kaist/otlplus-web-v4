import{p as M,r as c,z as O,w as J}from"./chunk-UIGDSWPH-ClC-Bows.js";import{j as t,a as i,u as N,F as v}from"./emotion-react-jsx-runtime.browser.esm-Cql-SmI8.js";import{n as o,F as l}from"./FlexWrapper-B3Tmr1Ow.js";import{M as Q}from"./Modal-DDP_uQXX.js";import{W as X}from"./Widget-Crs3_Da_.js";import{m as Y,C as _}from"./proxy-C1eNn18-.js";import{e as D,i as F,I as $,q as ee,w as j,x as te,u as oe,g as B}from"./useIsDevice-DnuNoJZ_.js";import{u as q,b as G,C as re,S as ne}from"./Credits-BM3jnb7t.js";import{L as T}from"./LoadingCircle-CrscqRbC.js";import{R as ie}from"./ReviewWritingBlock-D7j7hTR1.js";import{T as d}from"./Typography-YMZw2QHy.js";import{p as ce,R as le}from"./ReviewBlock-DEVNBjcP.js";import{u as S}from"./index-DasAm1UD.js";import{c as W,S as ae}from"./checkEmpty-DOWghJLg.js";import{T as se}from"./Trans-f23ayD2D.js";import"./index-BPHQ0OFD.js";import"./env-x7j716XO.js";import"./infiniteQueryBehavior-CwQvu0GK.js";import"./TextInputArea-CSuzkfcU.js";import"./useUserStore-B-P0R9Aj.js";const U=D(M.jsx("path",{d:"M12 2C6.47 2 2 6.47 2 12s4.47 10 10 10 10-4.47 10-10S17.53 2 12 2"})),de=D(M.jsx("path",{d:"M7.41 8.59 12 13.17l4.59-4.58L18 10l-6 6-6-6z"})),V=o.div`
    width: 150px;
    height: 28px;
    display: inline-flex;
    padding: 8px 16px;
...
`,z=({selectedCourseId:e,isMobileModal:r=!1,onMobileModalClose:a})=>{const s=N(),{query:n}=oe("GET",`/courses/${e}`,{enabled:e!==null}),[p,f]=c.useState(null),[w,m]=c.useState([]);return c.useEffect(()=>{if(n.data){const h=[];n.data.history.forEach(u=>{if(u.myLectureId!==null){const x=u.classes.find(b=>b.lectureId===u.myLectureId)?.professors||[];h.push({name:n.data.name,lectureId:u.myLectureId,professors:x,year:u.year,semester:u.semester})}}),m(h)}},[n.data]),c.useEffect(()=>{f(null)},[e]),t(Pe,{direction:"column",gap:12,align:"center",justify:e?"start":"center",children:e?n.isLoading?t(T,{}):i(v,{children:[i(Re,{direction:"column",gap:2,align:"center",justify:"center",children:[i(l,{direction:"row",align:"center",gap:8,justify:r?"space-between":"center",style:{width:"100%"},children:[r&&t("div",{style:{width:20}}),t(d,{type:"Bigger",color:"Text.default",children:n.data?.name}),r&&t($,{size:20,onClick:a,color:s.colors.Text.default,children:t(_,{})})]}),t(d,{type:"Big",color:"Text.default",children:n.data?.code})]}),t(E,{direction:"column",gap:10,align:"center",children:t(Te,{courseDetail:n.data})}),t(H,{}),t(E,{direction:"column",gap:10,children:t(ye,{courseDetail:n.data,selectedProfessorId:p,setSelectedProfessorId:f})}),t(H,{}),t(E,{direction:"column",gap:10,flex:"1 1 auto",children:t(Ee,{selectedCourseId:e,selectedProfessorId:p,writableReviewProps:w})})]}):t(re,{})})},We=o.div`
    width: 100%;
    border-radius: 7px;
    padding: 8px 10px;
...
`,A=20;function Ve({selectedCourseId:e,setSelectedCourseId:r}){const{t:a}=S(),s=N(),[n]=O(),[p,f]=c.useState(0),[w,m]=c.useState(!1),[h,u]=c.useState({courses:[],totalCount:0}),{query:x,setParams:b,data:g}=q("GET","/courses",{infinites:["courses"],limit:A,enabled:w}),{inView:C,ref:I}=G({threshold:0});c.useEffect(()=>{C&&x.hasNextPage&&!x.isFetchingNextPage&&x.fetchNextPage()},[C]),c.useEffect(()=>{const y=n.get("term")?parseInt(n.get("term")):void 0,k={keyword:n.get("keyword")||"",type:n.getAll("type"),department:n.getAll("department").map(L=>parseInt(L)),level:n.getAll("level").map(L=>parseInt(L))};y!==void 0&&(k.term=y),!W(k)&&R(k)},[]),c.useEffect(()=>{g!==void 0&&u(g)},[g]),c.useEffect(()=>{p==0&&w==!1||(u({courses:[],totalCount:0}),b(y=>({...y,order:["code","popular","studentCount"][p]??"code",offset:0})),m(!0))},[p]);const R=y=>{if(W(y)){alert(a("common.search.empty"));return}const k={...y,order:["code","popular","studentCount"][p]??"code",offset:0,limit:A};b(k),m(!0)};return i(Me,{direction:"column",justify:"stretch",align:"stretch",gap:8,children:[t(Oe,{children:t(ae,{options:["type","department","level","term"],onSearch:R})}),h.courses.length!==0?i(v,{children:[i(l,{direction:"row",gap:0,justify:"space-between",align:"center",children:[t(Fe,{color:"Text.default",children:t(se,{i18nKey:"dictionary.courseCountInfo",count:g?.totalCount,components:{bold:t(d,{type:"NormalBold",children:void 0}),icon:t($,{size:12,color:s.colors.Highlight.default,children:t(U,{})}),space:t(v,{children:" "})}})}),i(qe,{direction:"row",gap:8,align:"center",children:[t(d,{type:"NormalBold",color:"Text.default",children:a("dictionary.sort")}),t(Ge,{direction:"row",gap:0,children:t(ne,{options:[a("dictionary.sortOptions.code"),a("dictionary.sortOptions.popularity"),a("dictionary.sortOptions.studentCount")],setSelectedOption:f,selectedOption:p})})]})]}),i(Ue,{direction:"column",gap:12,children:[h.courses.map((y,k)=>t(Ae,{course:y,isSelected:e==y.id,selectCourseId:r},k)),x.hasNextPage&&t(T,{ref:I})]})]}):x.isLoading?t(T,{}):t(De,{type:"Bigger",color:"Text.placeholder",children:a("dictionary.noResults")})]})}const Ke=o(l)`
    flex: 1 0 0;
    min-height: 0;
...
`,mt=J(function(){const r=F("tablet"),[a]=O(),[s,n]=c.useState(!1),[p,f]=c.useState(null);c.useEffect(()=>{const m=a.get("courseId");if(m){const h=parseInt(m,10);isNaN(h)?f(null):f(h)}},[]),c.useEffect(()=>{r?p!==null&&n(!0):n(!1)},[r]),c.useEffect(()=>{r&&p!==null&&n(!0)},[p]);const w=c.useCallback(()=>{n(!1),f(null)},[]);return i(Ke,{direction:"row",align:"stretch",justify:"center",gap:12,children:[t(Ze,{direction:"column",align:"stretch",gap:0,borderRadius:12,children:t(Ve,{selectedCourseId:p,setSelectedCourseId:f})}),t(Je,{direction:"column",align:"stretch",gap:0,borderRadius:12,children:t(z,{selectedCourseId:p})}),r&&t(Q,{isOpen:s,onClose:w,header:!1,fullScreen:!0,children:t(z,{selectedCourseId:p,isMobileModal:!0,onMobileModalClose:w})})]})});export{mt as default};
//# sourceMappingURL=dictionary-zARYMH30.js.map
