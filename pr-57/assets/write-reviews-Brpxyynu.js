import{r as d,p as v,w as z}from"./chunk-UIGDSWPH-ClC-Bows.js";import{a as c,j as t,F as V}from"./emotion-react-jsx-runtime.browser.esm-Cql-SmI8.js";import{n as x,F as n}from"./FlexWrapper-B3Tmr1Ow.js";import{I as P,q as I,i as B,t as C,g as T,u as L,v as q,e as k}from"./useIsDevice-DnuNoJZ_.js";import{L as M}from"./Line-DqqpvMJr.js";import{W}from"./Widget-Crs3_Da_.js";import{E as G,a as D,u as F,b as $,S as K,C as A}from"./Credits-BM3jnb7t.js";import{T as u}from"./Typography-YMZw2QHy.js";import{u as b}from"./index-DasAm1UD.js";import{u as E}from"./useUserStore-B-P0R9Aj.js";import{L as y}from"./LoadingCircle-CrscqRbC.js";import{R,F as U,a as J}from"./ReviewBlock-DEVNBjcP.js";import{T as O}from"./Trans-f23ayD2D.js";import{R as Q}from"./ReviewWritingBlock-D7j7hTR1.js";import"./env-x7j716XO.js";import"./infiniteQueryBehavior-CwQvu0GK.js";import"./TextInputArea-CSuzkfcU.js";const X=x.div`
    width: 200px;
    flex-shrink: 1;
    position: relative;
    user-select: none;
...
`;function ue({selectedLecture:e,setSelectedLecture:r}){const o=B("mobile"),{user:s,status:l}=E(),{query:i}=L("GET",`/users/${s?.id}/lectures`,{enabled:l==="success"}),[h,m]=d.useState(null);return d.useEffect(()=>{if(!i.isLoading&&i.data&&i.data.lecturesWrap.length>0){const f=i.data.lecturesWrap[h?.[0]??0],p=f?.lectures[h?.[1]??0];f&&p&&r({name:p.name,lectureId:p.lectureId,courseId:p.courseId,professors:p.professors,year:f.year,semester:f.semester})}},[i.data]),c(de,{direction:o?"row":"column",align:o?"center":"stretch",justify:o?"space-between":"stretch",gap:12,borderRadius:12,children:[t(re,{totalLectures:i.data?i.data.totalLecturesCount:0,reviewedLectures:i.data?i.data.reviewedLecturesCount:0,totalLikes:i.data?i.data.totalLikesCount:0}),!o&&t(M,{height:2,color:"Line.divider"}),o?t(te,{lecturesWrap:i.data?.lecturesWrap,selectedLecture:e,setSelectedLecture:r,setSelectedLectureIndex:m}):t(le,{direction:"column",align:"stretch",gap:24,children:i.data?.lecturesWrap.map((f,p)=>t(ae,{lectureWrapIndex:p,lecturesWrap:f,selectedLecture:e,setSelectedLecture:r,setSelectedLectureIndex:m,last:p===i.data.lecturesWrap.length-1},p))})]})}const he=["write","recentFeed","hallOfFameFeed","liked"],me=x(n)`
    width: 225px;
    height: 36px;
`,fe=20;function pe(){const{t:e}=b(),{query:r}=L("GET","/semesters",{select:a=>({...a,semesters:a.semesters.filter(w=>w.year>=2013)})}),{query:o,setParams:s,data:l}=F("GET","/reviews",{gcTime:0,infinites:["reviews"],limit:fe}),{ref:i,inView:h}=$({threshold:0});d.useEffect(()=>{h&&o.hasNextPage&&!o.isFetchingNextPage&&o.fetchNextPage()},[h,o]);const[m,f]=d.useState(0),[p,S]=d.useState(0);return d.useEffect(()=>{s({mode:"hall-of-fame"})},[]),d.useEffect(()=>{if(m===0){s({mode:"hall-of-fame"});return}s({mode:"hall-of-fame",year:r.data?.semesters[m-1]?.year??2025,semester:r.data?.semesters[m-1]?.semester??q.SPRING})},[m]),c(n,{direction:"column",align:"stretch",gap:12,children:[c(n,{direction:"row",align:"center",gap:8,children:[t(u,{type:"NormalBold",color:"Text.default",children:e("common.year")}),t(me,{direction:"row",gap:0,children:t(K,{options:[e("writeReviews.hallOfFameFeed.total")].concat(r.data?.semesters?r.data.semesters.map(a=>`${a.year} ${I(a.semester)}`):[]),selectedOption:m,setSelectedOption:f})})]}),o.isLoading?t(y,{}):c(V,{children:[c(n,{direction:"column",align:"center",gap:12,children:[t(u,{type:"NormalBold",color:"Text.default",children:m===0?e("writeReviews.hallOfFameFeed.total"):t(O,{i18nKey:"writeReviews.hallOfFameFeed.title",values:{year:r.data?.semesters[m-1]?.year??"",semester:r.data?.semesters[m-1]?.semester?I(r.data.semesters[m-1]?.semester):""},components:{space:t(V,{children:" "})}})}),c(n,{direction:"column",align:"center",gap:0,children:[t(u,{type:"Bigger",color:"Text.default",children:l?.reviews.length}),t(u,{type:"Smaller",color:"Text.default",children:e("writeReviews.hallOfFameFeed.total")})]})]}),c(n,{direction:"column",align:"stretch",gap:12,children:[l?.reviews.map(a=>t(R,{review:a},a.id)),o.hasNextPage&&t(y,{ref:i})]})]})]})}function ge(){const{t:e}=b(),{user:r,status:o}=E(),{query:s,setParams:l,data:i}=F("GET",`/users/${r?.id}/reviews/liked`,{enabled:o==="success",infinites:["reviews"],limit:10}),{ref:h,inView:m}=$({threshold:0});return d.useEffect(()=>{m&&s.hasNextPage&&!s.isFetchingNextPage&&s.fetchNextPage()},[m,s]),d.useEffect(()=>{r!==null&&l({userId:r.id})},[]),c(n,{direction:"column",align:"stretch",gap:12,children:[t(n,{direction:"column",align:"center",gap:12,children:t(u,{type:"NormalBold",color:"Text.default",children:e("writeReviews.likedReviews.title")})}),s.isLoading?t(y,{}):c(n,{direction:"column",align:"stretch",gap:12,children:[i?.reviews.map(f=>t(R,{review:f},f.id)),s.hasNextPage&&t(y,{ref:h})]})]})}function xe(){const{t:e}=b(),{query:r,setParams:o,data:s}=F("GET","/reviews",{infinites:["reviews"],gcTime:0,initialOffset:0,limit:10}),{ref:l,inView:i}=$({threshold:0});return d.useEffect(()=>{i&&r.hasNextPage&&!r.isFetchingNextPage&&r.fetchNextPage()},[i,r]),d.useEffect(()=>{o({mode:"recent"})},[]),c(n,{direction:"column",align:"stretch",gap:12,children:[t(n,{direction:"column",align:"center",gap:12,children:t(u,{type:"NormalBold",color:"Text.default",children:e("writeReviews.tabs.recentFeed")})}),r.isLoading?t(y,{}):c(n,{direction:"column",align:"stretch",gap:12,children:[s?.reviews.map(h=>t(R,{review:h},h.id)),r.hasNextPage&&t(y,{ref:l})]})]})}const we=k(v.jsx("path",{d:"M3 17.25V21h3.75L17.81 9.94l-3.75-3.75zM20.71 7.04c.39-.39.39-1.02 0-1.41l-2.34-2.34a.996.996 0 0 0-1.41 0l-1.83 1.83 3.75 3.75z"})),ye=k(v.jsx("path",{d:"m14.06 9.02.92.92L5.92 19H5v-.92zM17.66 3c-.25 0-.51.1-.7.29l-1.83 1.83 3.75 3.75 1.83-1.83c.39-.39.39-1.02 0-1.41l-2.34-2.34c-.2-.2-.45-.29-.71-.29m-3.6 3.19L3 17.25V21h3.75L17.81 9.94z"})),ve=k(v.jsx("path",{d:"M19 5h-2V3H7v2H5c-1.1 0-2 .9-2 2v1c0 2.55 1.92 4.63 4.39 4.94.63 1.5 1.98 2.63 3.61 2.96V19H7v2h10v-2h-4v-3.1c1.63-.33 2.98-1.46 3.61-2.96C19.08 12.63 21 10.55 21 8V7c0-1.1-.9-2-2-2M5 8V7h2v3.82C5.84 10.4 5 9.3 5 8m14 0c0 1.3-.84 2.4-2 2.82V7h2z"})),ke=k(v.jsx("path",{d:"M19 5h-2V3H7v2H5c-1.1 0-2 .9-2 2v1c0 2.55 1.92 4.63 4.39 4.94.63 1.5 1.98 2.63 3.61 2.96V19H7v2h10v-2h-4v-3.1c1.63-.33 2.98-1.46 3.61-2.96C19.08 12.63 21 10.55 21 8V7c0-1.1-.9-2-2-2M5 8V7h2v3.82C5.84 10.4 5 9.3 5 8m7 6c-1.65 0-3-1.35-3-3V5h6v6c0 1.65-1.35 3-3 3m7-6c0 1.3-.84 2.4-2 2.82V7h2z"})),be=k(v.jsx("path",{d:"M13.5.67s.74 2.65.74 4.8c0 2.06-1.35 3.73-3.41 3.73-2.07 0-3.63-1.67-3.63-3.73l.03-.36C5.21 7.51 4 10.62 4 14c0 4.42 3.58 8 8 8s8-3.58 8-8C20 8.61 17.41 3.8 13.5.67M11.71 19c-1.78 0-3.22-1.4-3.22-3.14 0-1.62 1.05-2.76 2.81-3.12 1.77-.36 3.6-1.21 4.62-2.58.39 1.29.59 2.65.59 4.04 0 2.65-2.15 4.8-4.8 4.8"})),Se=k(v.jsx("path",{d:"M11.57 13.16c-1.36.28-2.17 1.16-2.17 2.41 0 1.34 1.11 2.42 2.49 2.42 2.05 0 3.71-1.66 3.71-3.71 0-1.07-.15-2.12-.46-3.12-.79 1.07-2.2 1.72-3.57 2M13.5.67s.74 2.65.74 4.8c0 2.06-1.35 3.73-3.41 3.73-2.07 0-3.63-1.67-3.63-3.73l.03-.36C5.21 7.51 4 10.62 4 14c0 4.42 3.58 8 8 8s8-3.58 8-8C20 8.61 17.41 3.8 13.5.67M12 20c-3.31 0-6-2.69-6-6 0-1.53.3-3.04.86-4.43 1.01 1.01 2.41 1.63 3.97 1.63 2.66 0 4.75-1.83 5.28-4.43C17.34 8.97 18 11.44 18 14c0 3.31-2.69 6-6 6"})),Ie={write:ye,recentFeed:Se,hallOfFameFeed:ke,liked:J},Te={write:we,recentFeed:be,hallOfFameFeed:ve,liked:U},Be=({theme:e})=>C`
...
`,Ye=z(function(){const r=B("mobile"),[o,s]=d.useState(null);return t(n,{direction:"column",align:"center",justify:"stretch",gap:0,flex:"1 0 0",children:c(Pe,{direction:r?"column":"row",align:"stretch",justify:"center",gap:12,flex:"1 0 0",children:[t(ue,{selectedLecture:o,setSelectedLecture:s}),t(je,{selectedLecture:o,setSelectedLecture:s})]})})});export{Ye as default};
//# sourceMappingURL=write-reviews-Brpxyynu.js.map
