import{p as M,r as c,z as O,w as J}from"./chunk-UIGDSWPH-ClC-Bows.js";import{j as t,a as i,u as N,F as v}from"./emotion-react-jsx-runtime.browser.esm-Cql-SmI8.js";import{n as o,F as l}from"./FlexWrapper-B3Tmr1Ow.js";import{M as Q}from"./Modal-C8nPdcbG.js";import{W as X}from"./Widget-Crs3_Da_.js";import{m as Y,C as _}from"./proxy-CmpsyFYq.js";import{e as D,u as S,q as F,l as $,x as ee,A as j,C as te,k as oe,j as B}from"./useIsDevice-BAiF1JW-.js";import{u as q,b as G,C as re,S as ne}from"./Credits-oz-0BYU-.js";import{L as T}from"./LoadingCircle-DHrVWZ4h.js";import{R as ie}from"./ReviewWritingBlock-CHY0_6JR.js";import{T as d}from"./Typography-YMZw2QHy.js";import{p as ce,R as le}from"./ReviewBlock-4_usj_tf.js";import{c as W,S as ae}from"./checkEmpty-DQTYS7Mw.js";import{T as se}from"./Trans-BnR27Moe.js";import"./index-BPHQ0OFD.js";import"./index-CtIsX8Fj.js";import"./env-x7j716XO.js";import"./infiniteQueryBehavior-BsCduBtR.js";import"./TextInputArea-BXb0NBEQ.js";import"./useUserStore-BwfaEJsV.js";const U=D(M.jsx("path",{d:"M12 2C6.47 2 2 6.47 2 12s4.47 10 10 10 10-4.47 10-10S17.53 2 12 2"})),de=D(M.jsx("path",{d:"M7.41 8.59 12 13.17l4.59-4.58L18 10l-6 6-6-6z"})),V=o.div`
    width: 150px;
    height: 28px;
    display: inline-flex;
    padding: 8px 16px;
...
`,z=20;function Ve({selectedCourseId:e,setSelectedCourseId:r}){const{t:a}=S(),s=N(),[n]=O(),[p,f]=c.useState(0),[y,m]=c.useState(!1),[h,u]=c.useState({courses:[],totalCount:0}),{query:x,setParams:b,data:g}=q("GET","/courses",{infinites:["courses"],limit:z,enabled:y}),{inView:C,ref:I}=G({threshold:0});c.useEffect(()=>{C&&x.hasNextPage&&!x.isFetchingNextPage&&x.fetchNextPage()},[C]),c.useEffect(()=>{const w=n.get("term")?parseInt(n.get("term")):void 0,k={keyword:n.get("keyword")||"",type:n.getAll("type"),department:n.getAll("department").map(L=>parseInt(L)),level:n.getAll("level").map(L=>parseInt(L))};w!==void 0&&(k.term=w),!W(k)&&R(k)},[]),c.useEffect(()=>{g!==void 0&&u(g)},[g]),c.useEffect(()=>{p==0&&y==!1||(u({courses:[],totalCount:0}),b(w=>({...w,order:["code","popular","studentCount"][p]??"code",offset:0})),m(!0))},[p]);const R=w=>{if(W(w)){alert(a("common.search.empty"));return}const k={...w,order:["code","popular","studentCount"][p]??"code",offset:0,limit:z};b(k),m(!0)};return i(Me,{direction:"column",justify:"stretch",align:"stretch",gap:8,children:[t(Oe,{children:t(ae,{options:["type","department","level","term"],onSearch:R})}),h.courses.length!==0?i(v,{children:[i(l,{direction:"row",gap:0,justify:"space-between",align:"center",children:[t(Fe,{color:"Text.default",children:t(se,{i18nKey:"dictionary.courseCountInfo",count:g?.totalCount,components:{bold:t(d,{type:"NormalBold",children:void 0}),icon:t($,{size:12,color:s.colors.Highlight.default,children:t(U,{})}),space:t(v,{children:" "})}})}),i(qe,{direction:"row",gap:8,align:"center",children:[t(d,{type:"NormalBold",color:"Text.default",children:a("dictionary.sort")}),t(Ge,{direction:"row",gap:0,children:t(ne,{options:[a("dictionary.sortOptions.code"),a("dictionary.sortOptions.popularity"),a("dictionary.sortOptions.studentCount")],setSelectedOption:f,selectedOption:p})})]})]}),i(Ue,{direction:"column",gap:12,children:[h.courses.map((w,k)=>t(ze,{course:w,isSelected:e==w.id,selectCourseId:r},k)),x.hasNextPage&&t(T,{ref:I})]})]}):x.isLoading?t(T,{}):t(De,{type:"Bigger",color:"Text.placeholder",children:a("dictionary.noResults")})]})}const Ke=o(l)`
    flex: 1 0 0;
    min-height: 0;
...
//# sourceMappingURL=dictionary-C0NVI_BA.js.map
