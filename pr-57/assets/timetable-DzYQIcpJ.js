...
`,Pi=S.div`
    ...
    user-select: none;
    touch-action: none;
`,Ui=({cellWidth:e=120,fullHeight:t=800.5,lectureSummary:n,setTimeFilter:r,hover:i,setHover:o,selected:a,setSelected:s,removeFunction:u})=>{const{t:h}=Ae(),d=5,f=5,m=8,g=l.useRef(null),M=[h("common.days.monday"),h("common.days.tuesday"),h("common.days.wednesday"),h("common.days.thursday"),h("common.days.friday")];bi(n);const p=32,v=24,w=l.useMemo(()=>t/32,[t]),R=l.useMemo(()=>({"--cell-height":`${w}px`,"--cell-width":`${e}px`,"--col-padding":`${d}px`}),[w,e,d]),[y,A]=l.useState(!1),[C,I]=l.useState(null),[N,x]=l.useState(null),[D,O]=l.useState(null),[z,q]=l.useState(new Map(Array.from({length:f},(F,U)=>[U,Array(p).fill(null)]))),Y=l.useRef(null),V=l.useRef(null),ie=l.useRef(null);Y.current=C,V.current=N,ie.current=D;const G=l.useCallback(F=>{if(g.current&&i==null&&a==null){const U=g.current.getBoundingClientRect(),T=F.clientX-U.left,E=F.clientY-U.top,k=Math.floor(E/w),B=Fn(T,f,[],0,e,d,0);k>=0&&k<p&&B>=0&&B<f&&(A(!0),I(k),x(k),O(B),s(null))}},[i,a,w,p,f,e,d,s]),X=l.useCallback(F=>{if(y&&g.current){const U=g.current.getBoundingClientRect(),T=F.clientY-U.top,E=Math.floor(T/w);E>=0&&E<p&&D!=null&&D>=0&&D<f&&E!==N&&x(E)}},[y,w,p,f,D,N]),K=l.useCallback(()=>{q(new Map(Array.from({length:f},(E,k)=>[k,Array(p).fill(null)])));const F=Y.current,U=V.current,T=ie.current;if(F!=null&&U!=null&&T!=null){const E=Math.min(F,U),k=Math.max(F,U),B={day:T,begin:E*30+480,end:(k+1)*30+480};r(B)}I(null),x(null),A(!1)},[f,p,r]),H=l.useCallback(F=>{if(g.current&&i==null&&a==null){const U=F.touches[0];if(!U)return;const T=g.current.getBoundingClientRect(),E=U.clientX-T.left,k=U.clientY-T.top,B=Math.floor(k/w),_=Fn(E,f,[],0,e,d,0);B>=0&&B<p&&_>=0&&_<f&&(A(!0),I(B),x(B),O(_),s(null))}},[i,a,w,p,f,e,d,s]),oe=l.useCallback(F=>{if(y&&g.current){const U=F.touches[0];if(!U)return;const T=g.current.getBoundingClientRect(),E=U.clientY-T.top,k=Math.floor(E/w);k>=0&&k<p&&D!=null&&D>=0&&D<f&&k!==N&&x(k)}},[y,w,p,f,D,N]),ue=l.useCallback(()=>{K()},[K]);l.useEffect(()=>(y&&window.addEventListener("mouseup",K),()=>{window.removeEventListener("mouseup",K)}),[y,K]);const Z=(F,U,T)=>{const E=new Map(Array.from({length:f},(k,B)=>[B,Array(p).fill(null)]));for(let k=F;k<U+1;k++)E.get(T)[k]=!0;return E};l.useLayoutEffect(()=>{if(g.current&&y){const F=Math.min(C,N),U=Math.max(C,N),T=Z(F,U,D);q(T)}},[N,C,y,D,f,p]);const he=l.useMemo(()=>wi(p,f,e,w,d,[],10,0),[p,f,e,w,d]),we=l.useMemo(()=>xi(n,e,w,d,a,s,i,o,y,u),[n,e,w,d,a,s,i,o,y,u]),Se=l.useCallback(()=>{s(null)},[s]),Q=l.useCallback(F=>{F.stopPropagation(),K()},[K]);return b(Oi,{style:R,children:[c(zi,{children:Array.from({length:v-m+1},(F,U)=>U+m).map(F=>c(P,{color:"Text.default",children:F%12||12},F))}),b(L,{direction:"column",gap:0,children:[c(L,{direction:"row",gap:5,children:M.map((F,U)=>F!=="none"&&c(Bi,{style:F===""?{width:"10px"}:void 0,children:c(P,{color:"Text.default",children:F})},U))}),b(Pi,{ref:g,onClick:Se,onMouseDown:G,onMouseMove:X,onMouseUp:Q,onTouchStart:H,onTouchMove:oe,onTouchEnd:ue,children:[he,Ei(!0,z,"rgba(229, 76, 101, 0.5)",w,e,2,d,[],0,0),we]})]})]})},$n=ne.memo(Ui);function Dr(e){return e.map(t=>t.name).join(", ")}function Fi(e){return e.slice().sort((n,r)=>{const i=n.day,o=r.day;return i!==o?i-o:n.begin-r.begin}).map(n=>n.str).join(" / ")}function $i(e){const t={};return e.forEach(n=>{const r=n.buildingCode,i=n.roomName;r in t?t[r]&&!t[r].includes(i)&&(t[r]=t[r].concat(`, ${i}`)):t[r]=i}),Object.entries(t).map(([n,r])=>`(${n}) ${r}`).join(" / ")}const ji=S(L)`
    width: 100%;
`,Wi=S(L)`
    width: 300px;
    padding: 10px;
...
`,_i=S.a`
    text-decoration: none;
`,Wn=({selectedLecture:e,onMobileModalClose:t,year:n,semester:r,currentTimetableId:i,timetableLectures:o})=>{const a=hn(),s=je(),{t:u}=Ae(),{user:h,status:d}=mn(),f=$e("tablet"),{requestFunction:m}=le("PATCH",`/timetables/${i}`,{onSuccess:()=>{a.invalidateQueries({queryKey:[`/timetables/${i}`]})}}),[g,M]=l.useState([]),{query:p,setParams:v}=le("GET",`/users/${h?.id}/wishlist`,{enabled:d==="success"&&n!=-1});l.useEffect(()=>{v({year:n,semester:r})},[n,r,i]),l.useEffect(()=>{p.data&&M(p.data.courses.flatMap(I=>I.lectures).map(I=>I.id))},[p.data]);const{requestFunction:w}=le("PATCH",`/users/${h?.id}/wishlist`,{onSuccess:()=>{a.invalidateQueries({queryKey:[`/users/${h?.id}/wishlist`]})}}),R=l.useRef(null),y=I=>{const N={syy:String(n),smtDivCd:String(r),subjtCd:I.code,syllabusOpenYn:"1"};return`https://erp.kaist.ac.kr/com/lgin/SsoCtr/initExtPageWork.do?link=estblSubjt&params=${btoa(JSON.stringify(N))}`},A=async I=>{if(o){if(i){if(o.some(N=>fn(N.classes,I.classes))){alert(u("timetable.addLectureConflict"));return}}else{console.warn("No timetable selected");return}m({action:"add",lectureId:I.id})}},C=async(I,N)=>{d!=="idle"&&w({lectureId:N,mode:I?"delete":"add"})};return c(Ki,{direction:"column",gap:12,align:"center",justify:e?"start":"center",children:e?b(et,{children:[b(Qi,{direction:"column",gap:2,align:"center",justify:"center",children:[b(L,{direction:"row",align:"center",gap:8,justify:f?"space-between":"center",style:{width:"100%"},children:[f&&c("div",{style:{width:20}}),c(P,{type:"Bigger",color:"Text.default",children:e.name}),f&&c(re,{size:20,onClick:t,color:s.colors.Text.default,children:c(Er,{})})]}),c(P,{type:"Big",color:"Text.default",children:e.code})]}),b(L,{direction:"row",gap:8,justify:"flex-end",style:{width:"100%"},children:[c(Zi,{to:`/dictionary?courseId=${e.courseId}`,children:c(P,{type:"Normal",color:"Highlight.default",style:{cursor:"pointer"},children:u("header.dictionary")})}),c(_i,{href:y(e),target:"_blank",children:c(P,{type:"Normal",color:"Highlight.default",style:{cursor:"pointer"},children:u("header.syllabus")})})]}),c(jn,{direction:"column",gap:10,align:"center",children:c(qi,{selectedLecture:e})}),c(jn,{ref:R,direction:"column",gap:10,children:c(Xi,{selectedCourseId:e.courseId,selectedProfessorId:e.professors[0]?.id??-1})}),f&&b(Ji,{direction:"row",gap:12,justify:"flex-end",children:[!g.includes(e.id)&&b(Un,{onClick:()=>{C(g.includes(e.id),e.id),t&&t()},children:[c(re,{size:15,children:c(gn,{})}),c(P,{type:"NormalBold",children:"찜목록에 추가"})]}),!o?.some(I=>I.id===e.id)&&i&&b(Un,{type:"selected",onClick:()=>{A(e),t&&t()},children:[c(re,{size:15,children:c(pn,{})}),c(P,{type:"NormalBold",children:"시간표에 추가"})]})]})]}):c(Ri,{})})},eo=S.div`
    width: 100%;
    display: flex;
    flex-direction: column;
    border-radius: 8px;
...
`,Hn=S.div`
    ...
    align-self: center;
`,ro=({course:e,selectedLecture:t,hoveredLecture:n,isInWish:r,isWishlist:i,currentTimetableId:o,timetableLectures:a,isAddTimetablePending:s,setHoveredLecture:u,setSelectedLecture:h,handleLikeClick:d,handleAddToTimetable:f,t:m})=>{const g=$e("tablet"),M=e.lectures[0]?.courseId??-1,p=t!=null&&t.courseId!==M?.3:1;return b(eo,{isSelected:t?.courseId===M,style:{opacity:p},children:[b(to,{children:[b(L,{direction:"row",gap:6,style:{opacity:e.completed?.3:1},children:[c(P,{type:"NormalBold",color:"Text.default",children:e.name}),c(P,{type:"Normal",color:"Text.default",children:e.code})]}),e.completed?c(P,{type:"Normal",color:"Text.default",children:m("common.completedCourse")}):c(P,{type:"Normal",color:"Highlight.default",children:e.type})]}),c(Hn,{}),e.lectures.map((v,w)=>{const R=r.includes(v.id),y=n?.some(A=>A.id===v.id)===!0;return b(ne.Fragment,{children:[b(no,{"data-lecture-id":v.id,onMouseEnter:()=>{g||u([v])},onMouseLeave:()=>{g||u(null)},onClick:()=>{if(v.id===t?.id){h(null);return}h(v)},isHighlighted:t?.id===v.id||y,children:[b(L,{direction:"column",gap:0,children:[g&&y&&b(P,{type:"Small",color:"Text.placeholder",children:[v.department.name," / ",v.type]}),b(L,{direction:"row",gap:6,style:{opacity:e.completed?.3:1},children:[c(P,{type:"NormalBold",color:"Text.default",children:v.classNo}),c(P,{type:"Normal",color:"Text.default",children:Dr(v.professors)})]}),g&&y&&b(P,{type:"Small",color:"Text.placeholder",children:[v.classes[0]?.buildingName," ",v.classes[0]?.roomName," /"," ",v.limitPeople]})]}),b(L,{direction:"row",gap:6,onClick:A=>A.stopPropagation(),children:[!g&&(R||i?c(re,{size:15,color:"#E54C65",onClick:()=>d(R,v.id),children:c(gn,{})}):c(re,{size:15,onClick:()=>d(R,v.id),children:c(Cr,{})})),(!g||n?.some(A=>A.id===v.id))&&c("span",{style:{opacity:o==null||a.some(A=>fn(A.classes,v.classes))?.3:1,cursor:s?"wait":"pointer"},children:c(re,{size:g?30:15,onClick:()=>f(v),children:c(pn,{})})})]})]}),w!==e.lectures.length-1&&c(Hn,{})]},v.id)})]})},io=l.memo(ro,(e,t)=>{if(e.course.id!==t.course.id||e.isInWish!==t.isInWish||e.isWishlist!==t.isWishlist||e.currentTimetableId!==t.currentTimetableId||e.timetableLectures!==t.timetableLectures||e.isAddTimetablePending!==t.isAddTimetablePending||e.selectedLecture!==t.selectedLecture)return!1;const n=e.hoveredLecture,r=t.hoveredLecture;if(n===r)return!0;const i=e.course.lectures.map(s=>s.id),o=n?.some(s=>i.includes(s.id))??!1,a=r?.some(s=>i.includes(s.id))??!1;return!o&&!a}),oo=S(L)`
    width: 100%;
    height: 100%;
    overflow: hidden;
`,ao=S(L)`
...
`,Ht=50,qn=({timetableLectures:e,year:t,semester:n,hoveredLecture:r,setHoveredLecture:i,selectedLecture:o,setSelectedLecture:a,timeFilter:s,setTimeFilter:u,currentTimetableId:h})=>{const{t:d}=Ae(),f=je(),{user:m,status:g}=mn(),M=hn(),{ref:p,inView:v}=Tr({threshold:0}),[w,R]=l.useState(!1),y=$e("tablet"),A=l.useCallback(T=>{if(!T)return T;const E=new Map;return T.courses.forEach(k=>{const B=E.get(k.id);if(!B){E.set(k.id,{...k,lectures:[...k.lectures]});return}const _=new Set(B.lectures.map(se=>se.id)),ce=[...B.lectures];k.lectures.forEach(se=>{_.has(se.id)||(_.add(se.id),ce.push(se))}),E.set(k.id,{...B,lectures:ce})}),{...T,courses:Array.from(E.values())}},[]),{query:C,setParams:I,data:N}=Sr("GET","/lectures",{infinites:["courses"],limit:Ht,enabled:w,gcTime:0,select:A,iterate:T=>{let E=0;return T.courses.forEach(k=>{E+=k.lectures.length}),E<Ht?0:E}}),{mutation:x,requestFunction:D}=le("PATCH",`/timetables/${h}`,{onSuccess:()=>{M.invalidateQueries({queryKey:[`/timetables/${h}`]})}}),[O,z]=l.useState({courses:[]}),[q,Y]=l.useState([]),[V,ie]=l.useState(0),G=l.useRef(null),X=l.useRef(null),K=l.useRef(null),[H,oe]=l.useState(!1),{query:ue,setParams:Z}=le("GET",`/users/${m?.id}/wishlist`,{enabled:g==="success"&&t!=-1}),{requestFunction:he}=le("PATCH",`/users/${m?.id}/wishlist`,{onSuccess:()=>{M.invalidateQueries({queryKey:[`/users/${m?.id}/wishlist`]})}}),we=T=>{if(Ti(T)){alert(d("common.search.empty"));return}oe(!1);const E={year:t,semester:n,...T,order:["code","popular","studentCount"][V]??"code",offset:0,limit:Ht,day:T.time?.day??void 0,begin:T.time?.begin??void 0,end:T.time?.end??void 0};I(E),R(!0)};l.useEffect(()=>{oe(!1),I(T=>({...T,order:["code","popular","studentCount"][V]??"code",offset:0})),R(!0)},[V]),l.useEffect(()=>{z({courses:[]}),Z({year:t,semester:n})},[t,n]),l.useEffect(()=>{v&&C.hasNextPage&&!C.isFetchingNextPage&&C.fetchNextPage()},[v]),l.useEffect(()=>{N!==void 0&&(z(N),oe(!1)),C.hasNextPage||R(!1)},[N]),l.useEffect(()=>{ue.data!==void 0&&z(H?ue.data:N??{courses:[]})},[H]),l.useEffect(()=>{ue.data!==void 0&&(Y(ue.data.courses.flatMap(T=>T.lectures).map(T=>T.id)),H&&z(ue.data))},[ue.data]),l.useEffect(()=>{const T=E=>{G.current&&!G.current.contains(E.target)&&X.current&&X.current.contains(E.target)&&a(null)};return document.addEventListener("mousedown",T),()=>document.removeEventListener("mousedown",T)},[]);const Se=ne.useMemo(()=>O.courses.flatMap(T=>T.lectures),[O.courses]),Q=l.useCallback(()=>{if(!y||!K.current)return;const E=K.current.getBoundingClientRect(),k=E.top+E.height/2,B=document.elementFromPoint(E.left+50,k);if(!B)return;const _=B.closest("[data-lecture-id]");if(_){const ce=parseInt(_.getAttribute("data-lecture-id")||"",10),se=Se.find(ke=>ke.id===ce);se&&i([se])}},[y,Se,i,a]);l.useEffect(()=>{if(!y||!K.current)return;const T=K.current;return T.addEventListener("scroll",Q),()=>{T.removeEventListener("scroll",Q)}},[y,Q]),l.useEffect(()=>{if(!y||O.courses.length===0)return;let T;const E=requestAnimationFrame(()=>{T=requestAnimationFrame(()=>{Q()})});return()=>{cancelAnimationFrame(E),cancelAnimationFrame(T)}},[y,O.courses,Q]);const F=async(T,E)=>{if(g!=="idle"){Y(T?k=>k.filter(B=>B!==E):k=>[...k,E]);try{he({lectureId:E,mode:T?"delete":"add"})}catch(k){console.error("Failed to update wishlist:",k),Y(T?B=>[...B,E]:B=>B.filter(_=>_!==E))}}},U=async T=>{if(h){if(e.some(E=>fn(E.classes,T.classes))){alert(d("timetable.addLectureConflict"));return}}else{console.warn("No timetable selected");return}D({action:"add",lectureId:T.id})};return b(oo,{direction:"column",justify:"stretch",align:"stretch",gap:8,ref:X,children:[c(ao,{direction:"row",justify:"stretch",gap:0,children:c(Si,{options:["type","department","level","term","time"],timeFilter:s,setTimeFilter:u,onSearch:we})}),b(L,{direction:"row",gap:0,justify:"space-between",align:"center",children:[b(po,{isSelected:H,onClick:()=>{oe(T=>!T)},style:{paddingBlock:10},children:[c(re,{size:15,color:f.colors.Highlight.default,children:H?c(gn,{}):c(Cr,{})}),c(P,{type:"Normal",color:"Highlight.default",children:d("common.wishlist")})]}),O.courses.length!==0&&c(lo,{direction:"row",gap:0,children:c(Ai,{options:[d("dictionary.sortOptions.code"),d("dictionary.sortOptions.popularity"),d("dictionary.sortOptions.studentCount")],setSelectedOption:ie,selectedOption:V})})]}),O.courses.length!==0?c(co,{direction:"column",gap:0,ref:K,children:b(uo,{direction:"row",gap:0,children:[b(ho,{direction:"column",gap:12,ref:G,children:[O.courses.map(T=>c(io,{course:T,selectedLecture:o,hoveredLecture:r,isInWish:q,isWishlist:H,currentTimetableId:h,timetableLectures:e,isAddTimetablePending:x.isPending,setHoveredLecture:i,setSelectedLecture:a,handleLikeClick:F,handleAddToTimetable:U,t:d},T.id)),!H&&C.hasNextPage&&c(nn,{ref:p})]}),y&&c(fo,{})]})}):c(so,{type:"Bigger",color:"Text.placeholder",children:d("dictionary.noResults")})]})};function go(){for(var e=arguments.length,t=new Array(e),n=0;n<e;n++)t[n]=arguments[n];return l.useMemo(()=>r=>{t.forEach(i=>i(r))},t)}const Ot=typeof window<"u"&&typeof window.document<"u"&&typeof window.document.createElement<"u";function it(e){const t=Object.prototype.toString.call(e);return t==="[object Window]"||t==="[object global]"}function yn(e){return"nodeType"in e}function de(e){var t,n;return e?it(e)?e:yn(e)&&(t=(n=e.ownerDocument)==null?void 0:n.defaultView)!=null?t:window:window}function bn(e){const{Document:t}=de(e);return e instanceof t}function wt(e){return it(e)?!1:e instanceof de(e).HTMLElement}function Rr(e){return e instanceof de(e).SVGElement}function ot(e){return e?it(e)?e.document:yn(e)?bn(e)?e:wt(e)||Rr(e)?e.ownerDocument:document:document:document}const Re=Ot?l.useLayoutEffect:l.useEffect;function wn(e){const t=l.useRef(e);return Re(()=>{t.current=e}),l.useCallback(function(){for(var n=arguments.length,r=new Array(n),i=0;i<n;i++)r[i]=arguments[i];return t.current==null?void 0:t.current(...r)},[])}function mo(){const e=l.useRef(null),t=l.useCallback((r,i)=>{e.current=setInterval(r,i)},[]),n=l.useCallback(()=>{e.current!==null&&(clearInterval(e.current),e.current=null)},[]);return[t,n]}function vt(e,t){t===void 0&&(t=[e]);const n=l.useRef(e);return Re(()=>{n.current!==e&&(n.current=e)},t),n}function xt(e,t){const n=l.useRef();return l.useMemo(()=>{const r=e(n.current);return n.current=r,r},[...t])}function At(e){const t=wn(e),n=l.useRef(null),r=l.useCallback(i=>{i!==n.current&&t?.(i,n.current),n.current=i},[]);return[n,r]}function rn(e){const t=l.useRef();return l.useEffect(()=>{t.current=e},[e]),t.current}let qt={};function Et(e,t){return l.useMemo(()=>{if(t)return t;const n=qt[e]==null?0:qt[e]+1;return qt[e]=n,e+"-"+n},[e,t])}function Ar(e){return function(t){for(var n=arguments.length,r=new Array(n>1?n-1:0),i=1;i<n;i++)r[i-1]=arguments[i];return r.reduce((o,a)=>{const s=Object.entries(a);for(const[u,h]of s){const d=o[u];d!=null&&(o[u]=d+e*h)}return o},{...t})}}const _e=Ar(1),It=Ar(-1);function vo(e){return"clientX"in e&&"clientY"in e}function xn(e){if(!e)return!1;const{KeyboardEvent:t}=de(e.target);return t&&e instanceof t}function yo(e){if(!e)return!1;const{TouchEvent:t}=de(e.target);return t&&e instanceof t}function on(e){if(yo(e)){if(e.touches&&e.touches.length){const{clientX:t,clientY:n}=e.touches[0];return{x:t,y:n}}else if(e.changedTouches&&e.changedTouches.length){const{clientX:t,clientY:n}=e.changedTouches[0];return{x:t,y:n}}}return vo(e)?{x:e.clientX,y:e.clientY}:null}const Nt=Object.freeze({Translate:{toString(e){if(!e)return;const{x:t,y:n}=e;return"translate3d("+(t?Math.round(t):0)+"px, "+(n?Math.round(n):0)+"px, 0)"}},Scale:{toString(e){if(!e)return;const{scaleX:t,scaleY:n}=e;return"scaleX("+t+") scaleY("+n+")"}},Transform:{toString(e){if(e)return[Nt.Translate.toString(e),Nt.Scale.toString(e)].join(" ")}},Transition:{toString(e){let{property:t,duration:n,easing:r}=e;return t+" "+n+"ms "+r}}}),Yn="a,frame,iframe,input:not([type=hidden]):not(:disabled),select:not(:disabled),textarea:not(:disabled),button:not(:disabled),*[tabindex]";function bo(e){return e.matches(Yn)?e:e.querySelector(Yn)}const wo={display:"none"};function xo(e){let{id:t,value:n}=e;return ne.createElement("div",{id:t,style:wo},n)}function Eo(e){let{id:t,announcement:n,ariaLiveType:r="assertive"}=e;const i={position:"fixed",top:0,left:0,width:1,height:1,margin:-1,border:0,padding:0,overflow:"hidden",clip:"rect(0 0 0 0)",clipPath:"inset(100%)",whiteSpace:"nowrap"};return ne.createElement("div",{id:t,style:i,role:"status","aria-live":r,"aria-atomic":!0},n)}function So(){const[e,t]=l.useState("");return{announce:l.useCallback(r=>{r!=null&&t(r)},[]),announcement:e}}const Ir=l.createContext(null);function To(e){const t=l.useContext(Ir);l.useEffect(()=>{if(!t)throw new Error("useDndMonitor must be used within a children of <DndContext>");return t(e)},[e,t])}function Co(){const[e]=l.useState(()=>new Set),t=l.useCallback(r=>(e.add(r),()=>e.delete(r)),[e]);return[l.useCallback(r=>{let{type:i,event:o}=r;e.forEach(a=>{var s;return(s=a[i])==null?void 0:s.call(a,o)})},[e]),t]}const Do={draggable:`
  ...
  `},Ro={onDragStart(e){let{active:t}=e;return"Picked up draggable item "+t.id+"."},onDragOver(e){let{active:t,over:n}=e;return n?"Draggable item "+t.id+" was moved over droppable area "+n.id+".":"Draggable item "+t.id+" is no longer over a droppable area."},onDragEnd(e){let{active:t,over:n}=e;return n?"Draggable item "+t.id+" was dropped over droppable area "+n.id:"Draggable item "+t.id+" was dropped."},onDragCancel(e){let{active:t}=e;return"Dragging was cancelled. Draggable item "+t.id+" was dropped."}};function Ao(e){let{announcements:t=Ro,container:n,hiddenTextDescribedById:r,screenReaderInstructions:i=Do}=e;const{announce:o,announcement:a}=So(),s=Et("DndLiveRegion"),[u,h]=l.useState(!1);if(l.useEffect(()=>{h(!0)},[]),To(l.useMemo(()=>({onDragStart(f){let{active:m}=f;o(t.onDragStart({active:m}))},onDragMove(f){let{active:m,over:g}=f;t.onDragMove&&o(t.onDragMove({active:m,over:g}))},onDragOver(f){let{active:m,over:g}=f;o(t.onDragOver({active:m,over:g}))},onDragEnd(f){let{active:m,over:g}=f;o(t.onDragEnd({active:m,over:g}))},onDragCancel(f){let{active:m,over:g}=f;o(t.onDragCancel({active:m,over:g}))}}),[o,t])),!u)return null;const d=ne.createElement(ne.Fragment,null,ne.createElement(xo,{id:r,value:i.draggable}),ne.createElement(Eo,{id:s,announcement:a}));return n?ht.createPortal(d,n):d}var J;(function(e){e.DragStart="dragStart",e.DragMove="dragMove",e.DragEnd="dragEnd",e.DragCancel="dragCancel",e.DragOver="dragOver",e.RegisterDroppable="registerDroppable",e.SetDroppableDisabled="setDroppableDisabled",e.UnregisterDroppable="unregisterDroppable"})(J||(J={}));function Mt(){}function Vn(e,t){return l.useMemo(()=>({sensor:e,options:t??{}}),[e,t])}function Io(){for(var e=arguments.length,t=new Array(e),n=0;n<e;n++)t[n]=arguments[n];return l.useMemo(()=>[...t].filter(r=>r!=null),[...t])}const Ee=Object.freeze({x:0,y:0});function No(e,t){return Math.sqrt(Math.pow(e.x-t.x,2)+Math.pow(e.y-t.y,2))}function Mo(e,t){let{data:{value:n}}=e,{data:{value:r}}=t;return n-r}function Lo(e,t){let{data:{value:n}}=e,{data:{value:r}}=t;return r-n}function ko(e,t){if(!e||e.length===0)return null;const[n]=e;return n[t]}function Gn(e,t,n){return t===void 0&&(t=e.left),n===void 0&&(n=e.top),{x:t+e.width*.5,y:n+e.height*.5}}const Oo=e=>{let{collisionRect:t,droppableRects:n,droppableContainers:r}=e;const i=Gn(t,t.left,t.top),o=[];for(const a of r){const{id:s}=a,u=n.get(s);if(u){const h=No(Gn(u),i);o.push({id:s,data:{droppableContainer:a,value:h}})}}return o.sort(Mo)};function zo(e,t){const n=Math.max(t.top,e.top),r=Math.max(t.left,e.left),i=Math.min(t.left+t.width,e.left+e.width),o=Math.min(t.top+t.height,e.top+e.height),a=i-r,s=o-n;if(r<i&&n<o){const u=t.width*t.height,h=e.width*e.height,d=a*s,f=d/(u+h-d);return Number(f.toFixed(4))}return 0}const Bo=e=>{let{collisionRect:t,droppableRects:n,droppableContainers:r}=e;const i=[];for(const o of r){const{id:a}=o,s=n.get(a);if(s){const u=zo(s,t);u>0&&i.push({id:a,data:{droppableContainer:o,value:u}})}}return i.sort(Lo)};function Po(e,t,n){return{...e,scaleX:t&&n?t.width/n.width:1,scaleY:t&&n?t.height/n.height:1}}function Nr(e,t){return e&&t?{x:e.left-t.left,y:e.top-t.top}:Ee}function Uo(e){return function(n){for(var r=arguments.length,i=new Array(r>1?r-1:0),o=1;o<r;o++)i[o-1]=arguments[o];return i.reduce((a,s)=>({...a,top:a.top+e*s.y,bottom:a.bottom+e*s.y,left:a.left+e*s.x,right:a.right+e*s.x}),{...n})}}const Fo=Uo(1);function $o(e){if(e.startsWith("matrix3d(")){const t=e.slice(9,-1).split(/, /);return{x:+t[12],y:+t[13],scaleX:+t[0],scaleY:+t[5]}}else if(e.startsWith("matrix(")){const t=e.slice(7,-1).split(/, /);return{x:+t[4],y:+t[5],scaleX:+t[0],scaleY:+t[3]}}return null}function jo(e,t,n){const r=$o(t);if(!r)return e;const{scaleX:i,scaleY:o,x:a,y:s}=r,u=e.left-a-(1-i)*parseFloat(n),h=e.top-s-(1-o)*parseFloat(n.slice(n.indexOf(" ")+1)),d=i?e.width/i:e.width,f=o?e.height/o:e.height;return{width:d,height:f,top:h,right:u+d,bottom:h+f,left:u}}const Wo={ignoreTransform:!1};function at(e,t){t===void 0&&(t=Wo);let n=e.getBoundingClientRect();if(t.ignoreTransform){const{transform:h,transformOrigin:d}=de(e).getComputedStyle(e);h&&(n=jo(n,h,d))}const{top:r,left:i,width:o,height:a,bottom:s,right:u}=n;return{top:r,left:i,width:o,height:a,bottom:s,right:u}}function Xn(e){return at(e,{ignoreTransform:!0})}function Ho(e){const t=e.innerWidth,n=e.innerHeight;return{top:0,left:0,right:t,bottom:n,width:t,height:n}}function qo(e,t){return t===void 0&&(t=de(e).getComputedStyle(e)),t.position==="fixed"}function Yo(e,t){t===void 0&&(t=de(e).getComputedStyle(e));const n=/(auto|scroll|overlay)/;return["overflow","overflowX","overflowY"].some(i=>{const o=t[i];return typeof o=="string"?n.test(o):!1})}function En(e,t){const n=[];function r(i){if(t!=null&&n.length>=t||!i)return n;if(bn(i)&&i.scrollingElement!=null&&!n.includes(i.scrollingElement))return n.push(i.scrollingElement),n;if(!wt(i)||Rr(i)||n.includes(i))return n;const o=de(e).getComputedStyle(i);return i!==e&&Yo(i,o)&&n.push(i),qo(i,o)?n:r(i.parentNode)}return e?r(e):n}function Mr(e){const[t]=En(e,1);return t??null}function Yt(e){return!Ot||!e?null:it(e)?e:yn(e)?bn(e)||e===ot(e).scrollingElement?window:wt(e)?e:null:null}function Lr(e){return it(e)?e.scrollX:e.scrollLeft}function kr(e){return it(e)?e.scrollY:e.scrollTop}function an(e){return{x:Lr(e),y:kr(e)}}var ee;(function(e){e[e.Forward=1]="Forward",e[e.Backward=-1]="Backward"})(ee||(ee={}));function Or(e){return!Ot||!e?!1:e===document.scrollingElement}function zr(e){const t={x:0,y:0},n=Or(e)?{height:window.innerHeight,width:window.innerWidth}:{height:e.clientHeight,width:e.clientWidth},r={x:e.scrollWidth-n.width,y:e.scrollHeight-n.height},i=e.scrollTop<=t.y,o=e.scrollLeft<=t.x,a=e.scrollTop>=r.y,s=e.scrollLeft>=r.x;return{isTop:i,isLeft:o,isBottom:a,isRight:s,maxScroll:r,minScroll:t}}const Vo={x:.2,y:.2};function Go(e,t,n,r,i){let{top:o,left:a,right:s,bottom:u}=n;r===void 0&&(r=10),i===void 0&&(i=Vo);const{isTop:h,isBottom:d,isLeft:f,isRight:m}=zr(e),g={x:0,y:0},M={x:0,y:0},p={height:t.height*i.y,width:t.width*i.x};return!h&&o<=t.top+p.height?(g.y=ee.Backward,M.y=r*Math.abs((t.top+p.height-o)/p.height)):!d&&u>=t.bottom-p.height&&(g.y=ee.Forward,M.y=r*Math.abs((t.bottom-p.height-u)/p.height)),!m&&s>=t.right-p.width?(g.x=ee.Forward,M.x=r*Math.abs((t.right-p.width-s)/p.width)):!f&&a<=t.left+p.width&&(g.x=ee.Backward,M.x=r*Math.abs((t.left+p.width-a)/p.width)),{direction:g,speed:M}}function Xo(e){if(e===document.scrollingElement){const{innerWidth:o,innerHeight:a}=window;return{top:0,left:0,right:o,bottom:a,width:o,height:a}}const{top:t,left:n,right:r,bottom:i}=e.getBoundingClientRect();return{top:t,left:n,right:r,bottom:i,width:e.clientWidth,height:e.clientHeight}}function Br(e){return e.reduce((t,n)=>_e(t,an(n)),Ee)}function Ko(e){return e.reduce((t,n)=>t+Lr(n),0)}function Qo(e){return e.reduce((t,n)=>t+kr(n),0)}function Jo(e,t){if(t===void 0&&(t=at),!e)return;const{top:n,left:r,bottom:i,right:o}=t(e);Mr(e)&&(i<=0||o<=0||n>=window.innerHeight||r>=window.innerWidth)&&e.scrollIntoView({block:"center",inline:"center"})}const Zo=[["x",["left","right"],Ko],["y",["top","bottom"],Qo]];class Sn{constructor(t,n){this.rect=void 0,this.width=void 0,this.height=void 0,this.top=void 0,this.bottom=void 0,this.right=void 0,this.left=void 0;const r=En(n),i=Br(r);this.rect={...t},this.width=t.width,this.height=t.height;for(const[o,a,s]of Zo)for(const u of a)Object.defineProperty(this,u,{get:()=>{const h=s(r),d=i[o]-h;return this.rect[u]+d},enumerable:!0});Object.defineProperty(this,"rect",{enumerable:!1})}}class pt{constructor(t){this.target=void 0,this.listeners=[],this.removeAll=()=>{this.listeners.forEach(n=>{var r;return(r=this.target)==null?void 0:r.removeEventListener(...n)})},this.target=t}add(t,n,r){var i;(i=this.target)==null||i.addEventListener(t,n,r),this.listeners.push([t,n,r])}}function _o(e){const{EventTarget:t}=de(e);return e instanceof t?e:ot(e)}function Vt(e,t){const n=Math.abs(e.x),r=Math.abs(e.y);return typeof t=="number"?Math.sqrt(n**2+r**2)>t:"x"in t&&"y"in t?n>t.x&&r>t.y:"x"in t?n>t.x:"y"in t?r>t.y:!1}var ve;(function(e){e.Click="click",e.DragStart="dragstart",e.Keydown="keydown",e.ContextMenu="contextmenu",e.Resize="resize",e.SelectionChange="selectionchange",e.VisibilityChange="visibilitychange"})(ve||(ve={}));function Kn(e){e.preventDefault()}function ea(e){e.stopPropagation()}var j;(function(e){e.Space="Space",e.Down="ArrowDown",e.Right="ArrowRight",e.Left="ArrowLeft",e.Up="ArrowUp",e.Esc="Escape",e.Enter="Enter",e.Tab="Tab"})(j||(j={}));const Pr={start:[j.Space,j.Enter],cancel:[j.Esc],end:[j.Space,j.Enter,j.Tab]},ta=(e,t)=>{let{currentCoordinates:n}=t;switch(e.code){case j.Right:return{...n,x:n.x+25};case j.Left:return{...n,x:n.x-25};case j.Down:return{...n,y:n.y+25};case j.Up:return{...n,y:n.y-25}}};class Ur{constructor(t){this.props=void 0,this.autoScrollEnabled=!1,this.referenceCoordinates=void 0,this.listeners=void 0,this.windowListeners=void 0,this.props=t;const{event:{target:n}}=t;this.props=t,this.listeners=new pt(ot(n)),this.windowListeners=new pt(de(n)),this.handleKeyDown=this.handleKeyDown.bind(this),this.handleCancel=this.handleCancel.bind(this),this.attach()}attach(){this.handleStart(),this.windowListeners.add(ve.Resize,this.handleCancel),this.windowListeners.add(ve.VisibilityChange,this.handleCancel),setTimeout(()=>this.listeners.add(ve.Keydown,this.handleKeyDown))}handleStart(){const{activeNode:t,onStart:n}=this.props,r=t.node.current;r&&Jo(r),n(Ee)}handleKeyDown(t){if(xn(t)){const{active:n,context:r,options:i}=this.props,{keyboardCodes:o=Pr,coordinateGetter:a=ta,scrollBehavior:s="smooth"}=i,{code:u}=t;if(o.end.includes(u)){this.handleEnd(t);return}if(o.cancel.includes(u)){this.handleCancel(t);return}const{collisionRect:h}=r.current,d=h?{x:h.left,y:h.top}:Ee;this.referenceCoordinates||(this.referenceCoordinates=d);const f=a(t,{active:n,context:r.current,currentCoordinates:d});if(f){const m=It(f,d),g={x:0,y:0},{scrollableAncestors:M}=r.current;for(const p of M){const v=t.code,{isTop:w,isRight:R,isLeft:y,isBottom:A,maxScroll:C,minScroll:I}=zr(p),N=Xo(p),x={x:Math.min(v===j.Right?N.right-N.width/2:N.right,Math.max(v===j.Right?N.left:N.left+N.width/2,f.x)),y:Math.min(v===j.Down?N.bottom-N.height/2:N.bottom,Math.max(v===j.Down?N.top:N.top+N.height/2,f.y))},D=v===j.Right&&!R||v===j.Left&&!y,O=v===j.Down&&!A||v===j.Up&&!w;if(D&&x.x!==f.x){const z=p.scrollLeft+m.x,q=v===j.Right&&z<=C.x||v===j.Left&&z>=I.x;if(q&&!m.y){p.scrollTo({left:z,behavior:s});return}q?g.x=p.scrollLeft-z:g.x=v===j.Right?p.scrollLeft-C.x:p.scrollLeft-I.x,g.x&&p.scrollBy({left:-g.x,behavior:s});break}else if(O&&x.y!==f.y){const z=p.scrollTop+m.y,q=v===j.Down&&z<=C.y||v===j.Up&&z>=I.y;if(q&&!m.x){p.scrollTo({top:z,behavior:s});return}q?g.y=p.scrollTop-z:g.y=v===j.Down?p.scrollTop-C.y:p.scrollTop-I.y,g.y&&p.scrollBy({top:-g.y,behavior:s});break}}this.handleMove(t,_e(It(f,this.referenceCoordinates),g))}}}handleMove(t,n){const{onMove:r}=this.props;t.preventDefault(),r(n)}handleEnd(t){const{onEnd:n}=this.props;t.preventDefault(),this.detach(),n()}handleCancel(t){const{onCancel:n}=this.props;t.preventDefault(),this.detach(),n()}detach(){this.listeners.removeAll(),this.windowListeners.removeAll()}}Ur.activators=[{eventName:"onKeyDown",handler:(e,t,n)=>{let{keyboardCodes:r=Pr,onActivation:i}=t,{active:o}=n;const{code:a}=e.nativeEvent;if(r.start.includes(a)){const s=o.activatorNode.current;return s&&e.target!==s?!1:(e.preventDefault(),i?.({event:e.nativeEvent}),!0)}return!1}}];function Qn(e){return!!(e&&"distance"in e)}function Jn(e){return!!(e&&"delay"in e)}class Tn{constructor(t,n,r){var i;r===void 0&&(r=_o(t.event.target)),this.props=void 0,this.events=void 0,this.autoScrollEnabled=!0,this.document=void 0,this.activated=!1,this.initialCoordinates=void 0,this.timeoutId=null,this.listeners=void 0,this.documentListeners=void 0,this.windowListeners=void 0,this.props=t,this.events=n;const{event:o}=t,{target:a}=o;this.props=t,this.events=n,this.document=ot(a),this.documentListeners=new pt(this.document),this.listeners=new pt(r),this.windowListeners=new pt(de(a)),this.initialCoordinates=(i=on(o))!=null?i:Ee,this.handleStart=this.handleStart.bind(this),this.handleMove=this.handleMove.bind(this),this.handleEnd=this.handleEnd.bind(this),this.handleCancel=this.handleCancel.bind(this),this.handleKeydown=this.handleKeydown.bind(this),this.removeTextSelection=this.removeTextSelection.bind(this),this.attach()}attach(){const{events:t,props:{options:{activationConstraint:n,bypassActivationConstraint:r}}}=this;if(this.listeners.add(t.move.name,this.handleMove,{passive:!1}),this.listeners.add(t.end.name,this.handleEnd),t.cancel&&this.listeners.add(t.cancel.name,this.handleCancel),this.windowListeners.add(ve.Resize,this.handleCancel),this.windowListeners.add(ve.DragStart,Kn),this.windowListeners.add(ve.VisibilityChange,this.handleCancel),this.windowListeners.add(ve.ContextMenu,Kn),this.documentListeners.add(ve.Keydown,this.handleKeydown),n){if(r!=null&&r({event:this.props.event,activeNode:this.props.activeNode,options:this.props.options}))return this.handleStart();if(Jn(n)){this.timeoutId=setTimeout(this.handleStart,n.delay),this.handlePending(n);return}if(Qn(n)){this.handlePending(n);return}}this.handleStart()}detach(){this.listeners.removeAll(),this.windowListeners.removeAll(),setTimeout(this.documentListeners.removeAll,50),this.timeoutId!==null&&(clearTimeout(this.timeoutId),this.timeoutId=null)}handlePending(t,n){const{active:r,onPending:i}=this.props;i(r,t,this.initialCoordinates,n)}handleStart(){const{initialCoordinates:t}=this,{onStart:n}=this.props;t&&(this.activated=!0,this.documentListeners.add(ve.Click,ea,{capture:!0}),this.removeTextSelection(),this.documentListeners.add(ve.SelectionChange,this.removeTextSelection),n(t))}handleMove(t){var n;const{activated:r,initialCoordinates:i,props:o}=this,{onMove:a,options:{activationConstraint:s}}=o;if(!i)return;const u=(n=on(t))!=null?n:Ee,h=It(i,u);if(!r&&s){if(Qn(s)){if(s.tolerance!=null&&Vt(h,s.tolerance))return this.handleCancel();if(Vt(h,s.distance))return this.handleStart()}if(Jn(s)&&Vt(h,s.tolerance))return this.handleCancel();this.handlePending(s,h);return}t.cancelable&&t.preventDefault(),a(u)}handleEnd(){const{onAbort:t,onEnd:n}=this.props;this.detach(),this.activated||t(this.props.active),n()}handleCancel(){const{onAbort:t,onCancel:n}=this.props;this.detach(),this.activated||t(this.props.active),n()}handleKeydown(t){t.code===j.Esc&&this.handleCancel()}removeTextSelection(){var t;(t=this.document.getSelection())==null||t.removeAllRanges()}}const na={cancel:{name:"pointercancel"},move:{name:"pointermove"},end:{name:"pointerup"}};class Cn extends Tn{constructor(t){const{event:n}=t,r=ot(n.target);super(t,na,r)}}Cn.activators=[{eventName:"onPointerDown",handler:(e,t)=>{let{nativeEvent:n}=e,{onActivation:r}=t;return!n.isPrimary||n.button!==0?!1:(r?.({event:n}),!0)}}];const ra={move:{name:"mousemove"},end:{name:"mouseup"}};var sn;(function(e){e[e.RightClick=2]="RightClick"})(sn||(sn={}));class ia extends Tn{constructor(t){super(t,ra,ot(t.event.target))}}ia.activators=[{eventName:"onMouseDown",handler:(e,t)=>{let{nativeEvent:n}=e,{onActivation:r}=t;return n.button===sn.RightClick?!1:(r?.({event:n}),!0)}}];const Gt={cancel:{name:"touchcancel"},move:{name:"touchmove"},end:{name:"touchend"}};class Fr extends Tn{constructor(t){super(t,Gt)}static setup(){return window.addEventListener(Gt.move.name,t,{capture:!1,passive:!1}),function(){window.removeEventListener(Gt.move.name,t)};function t(){}}}Fr.activators=[{eventName:"onTouchStart",handler:(e,t)=>{let{nativeEvent:n}=e,{onActivation:r}=t;const{touches:i}=n;return i.length>1?!1:(r?.({event:n}),!0)}}];var gt;(function(e){e[e.Pointer=0]="Pointer",e[e.DraggableRect=1]="DraggableRect"})(gt||(gt={}));var Lt;(function(e){e[e.TreeOrder=0]="TreeOrder",e[e.ReversedTreeOrder=1]="ReversedTreeOrder"})(Lt||(Lt={}));function oa(e){let{acceleration:t,activator:n=gt.Pointer,canScroll:r,draggingRect:i,enabled:o,interval:a=5,order:s=Lt.TreeOrder,pointerCoordinates:u,scrollableAncestors:h,scrollableAncestorRects:d,delta:f,threshold:m}=e;const g=sa({delta:f,disabled:!o}),[M,p]=mo(),v=l.useRef({x:0,y:0}),w=l.useRef({x:0,y:0}),R=l.useMemo(()=>{switch(n){case gt.Pointer:return u?{top:u.y,bottom:u.y,left:u.x,right:u.x}:null;case gt.DraggableRect:return i}},[n,i,u]),y=l.useRef(null),A=l.useCallback(()=>{const I=y.current;if(!I)return;const N=v.current.x*w.current.x,x=v.current.y*w.current.y;I.scrollBy(N,x)},[]),C=l.useMemo(()=>s===Lt.TreeOrder?[...h].reverse():h,[s,h]);l.useEffect(()=>{if(!o||!h.length||!R){p();return}for(const I of C){if(r?.(I)===!1)continue;const N=h.indexOf(I),x=d[N];if(!x)continue;const{direction:D,speed:O}=Go(I,x,R,t,m);for(const z of["x","y"])g[z][D[z]]||(O[z]=0,D[z]=0);if(O.x>0||O.y>0){p(),y.current=I,M(A,a),v.current=O,w.current=D;return}}v.current={x:0,y:0},w.current={x:0,y:0},p()},[t,A,r,p,o,a,JSON.stringify(R),JSON.stringify(g),M,h,C,d,JSON.stringify(m)])}const aa={x:{[ee.Backward]:!1,[ee.Forward]:!1},y:{[ee.Backward]:!1,[ee.Forward]:!1}};function sa(e){let{delta:t,disabled:n}=e;const r=rn(t);return xt(i=>{if(n||!r||!i)return aa;const o={x:Math.sign(t.x-r.x),y:Math.sign(t.y-r.y)};return{x:{[ee.Backward]:i.x[ee.Backward]||o.x===-1,[ee.Forward]:i.x[ee.Forward]||o.x===1},y:{[ee.Backward]:i.y[ee.Backward]||o.y===-1,[ee.Forward]:i.y[ee.Forward]||o.y===1}}},[n,t,r])}function la(e,t){const n=t!=null?e.get(t):void 0,r=n?n.node.current:null;return xt(i=>{var o;return t==null?null:(o=r??i)!=null?o:null},[r,t])}function ca(e,t){return l.useMemo(()=>e.reduce((n,r)=>{const{sensor:i}=r,o=i.activators.map(a=>({eventName:a.eventName,handler:t(a.handler,r)}));return[...n,...o]},[]),[e,t])}var yt;(function(e){e[e.Always=0]="Always",e[e.BeforeDragging=1]="BeforeDragging",e[e.WhileDragging=2]="WhileDragging"})(yt||(yt={}));var ln;(function(e){e.Optimized="optimized"})(ln||(ln={}));const Zn=new Map;function da(e,t){let{dragging:n,dependencies:r,config:i}=t;const[o,a]=l.useState(null),{frequency:s,measure:u,strategy:h}=i,d=l.useRef(e),f=v(),m=vt(f),g=l.useCallback(function(w){w===void 0&&(w=[]),!m.current&&a(R=>R===null?w:R.concat(w.filter(y=>!R.includes(y))))},[m]),M=l.useRef(null),p=xt(w=>{if(f&&!n)return Zn;if(!w||w===Zn||d.current!==e||o!=null){const R=new Map;for(let y of e){if(!y)continue;if(o&&o.length>0&&!o.includes(y.id)&&y.rect.current){R.set(y.id,y.rect.current);continue}const A=y.node.current,C=A?new Sn(u(A),A):null;y.rect.current=C,C&&R.set(y.id,C)}return R}return w},[e,o,n,f,u]);return l.useEffect(()=>{d.current=e},[e]),l.useEffect(()=>{f||g()},[n,f]),l.useEffect(()=>{o&&o.length>0&&a(null)},[JSON.stringify(o)]),l.useEffect(()=>{f||typeof s!="number"||M.current!==null||(M.current=setTimeout(()=>{g(),M.current=null},s))},[s,f,g,...r]),{droppableRects:p,measureDroppableContainers:g,measuringScheduled:o!=null};function v(){switch(h){case yt.Always:return!1;case yt.BeforeDragging:return n;default:return!n}}}function $r(e,t){return xt(n=>e?n||(typeof t=="function"?t(e):e):null,[t,e])}function ua(e,t){return $r(e,t)}function ha(e){let{callback:t,disabled:n}=e;const r=wn(t),i=l.useMemo(()=>{if(n||typeof window>"u"||typeof window.MutationObserver>"u")return;const{MutationObserver:o}=window;return new o(r)},[r,n]);return l.useEffect(()=>()=>i?.disconnect(),[i]),i}function zt(e){let{callback:t,disabled:n}=e;const r=wn(t),i=l.useMemo(()=>{if(n||typeof window>"u"||typeof window.ResizeObserver>"u")return;const{ResizeObserver:o}=window;return new o(r)},[n]);return l.useEffect(()=>()=>i?.disconnect(),[i]),i}function fa(e){return new Sn(at(e),e)}function _n(e,t,n){t===void 0&&(t=fa);const[r,i]=l.useState(null);function o(){i(u=>{if(!e)return null;if(e.isConnected===!1){var h;return(h=u??n)!=null?h:null}const d=t(e);return JSON.stringify(u)===JSON.stringify(d)?u:d})}const a=ha({callback(u){if(e)for(const h of u){const{type:d,target:f}=h;if(d==="childList"&&f instanceof HTMLElement&&f.contains(e)){o();break}}}}),s=zt({callback:o});return Re(()=>{o(),e?(s?.observe(e),a?.observe(document.body,{childList:!0,subtree:!0})):(s?.disconnect(),a?.disconnect())},[e]),r}function pa(e){const t=$r(e);return Nr(e,t)}const er=[];function ga(e){const t=l.useRef(e),n=xt(r=>e?r&&r!==er&&e&&t.current&&e.parentNode===t.current.parentNode?r:En(e):er,[e]);return l.useEffect(()=>{t.current=e},[e]),n}function ma(e){const[t,n]=l.useState(null),r=l.useRef(e),i=l.useCallback(o=>{const a=Yt(o.target);a&&n(s=>s?(s.set(a,an(a)),new Map(s)):null)},[]);return l.useEffect(()=>{const o=r.current;if(e!==o){a(o);const s=e.map(u=>{const h=Yt(u);return h?(h.addEventListener("scroll",i,{passive:!0}),[h,an(h)]):null}).filter(u=>u!=null);n(s.length?new Map(s):null),r.current=e}return()=>{a(e),a(o)};function a(s){s.forEach(u=>{const h=Yt(u);h?.removeEventListener("scroll",i)})}},[i,e]),l.useMemo(()=>e.length?t?Array.from(t.values()).reduce((o,a)=>_e(o,a),Ee):Br(e):Ee,[e,t])}function tr(e,t){t===void 0&&(t=[]);const n=l.useRef(null);return l.useEffect(()=>{n.current=null},t),l.useEffect(()=>{const r=e!==Ee;r&&!n.current&&(n.current=e),!r&&n.current&&(n.current=null)},[e]),n.current?It(e,n.current):Ee}function va(e){l.useEffect(()=>{if(!Ot)return;const t=e.map(n=>{let{sensor:r}=n;return r.setup==null?void 0:r.setup()});return()=>{for(const n of t)n?.()}},e.map(t=>{let{sensor:n}=t;return n}))}function ya(e,t){return l.useMemo(()=>e.reduce((n,r)=>{let{eventName:i,handler:o}=r;return n[i]=a=>{o(a,t)},n},{}),[e,t])}function jr(e){return l.useMemo(()=>e?Ho(e):null,[e])}const nr=[];function ba(e,t){t===void 0&&(t=at);const[n]=e,r=jr(n?de(n):null),[i,o]=l.useState(nr);function a(){o(()=>e.length?e.map(u=>Or(u)?r:new Sn(t(u),u)):nr)}const s=zt({callback:a});return Re(()=>{s?.disconnect(),a(),e.forEach(u=>s?.observe(u))},[e]),i}function wa(e){if(!e)return null;if(e.children.length>1)return e;const t=e.children[0];return wt(t)?t:e}function xa(e){let{measure:t}=e;const[n,r]=l.useState(null),i=l.useCallback(h=>{for(const{target:d}of h)if(wt(d)){r(f=>{const m=t(d);return f?{...f,width:m.width,height:m.height}:m});break}},[t]),o=zt({callback:i}),a=l.useCallback(h=>{const d=wa(h);o?.disconnect(),d&&o?.observe(d),r(d?t(d):null)},[t,o]),[s,u]=At(a);return l.useMemo(()=>({nodeRef:s,rect:n,setRef:u}),[n,s,u])}const Ea=[{sensor:Cn,options:{}},{sensor:Ur,options:{}}],Sa={current:{}},Rt={draggable:{measure:Xn},droppable:{measure:Xn,strategy:yt.WhileDragging,frequency:ln.Optimized},dragOverlay:{measure:at}};class mt extends Map{get(t){var n;return t!=null&&(n=super.get(t))!=null?n:void 0}toArray(){return Array.from(this.values())}getEnabled(){return this.toArray().filter(t=>{let{disabled:n}=t;return!n})}getNodeFor(t){var n,r;return(n=(r=this.get(t))==null?void 0:r.node.current)!=null?n:void 0}}const Ta={activatorEvent:null,active:null,activeNode:null,activeNodeRect:null,collisions:null,containerNodeRect:null,draggableNodes:new Map,droppableRects:new Map,droppableContainers:new mt,over:null,dragOverlay:{nodeRef:{current:null},rect:null,setRef:Mt},scrollableAncestors:[],scrollableAncestorRects:[],measuringConfiguration:Rt,measureDroppableContainers:Mt,windowRect:null,measuringScheduled:!1},Ca={activatorEvent:null,activators:[],active:null,activeNodeRect:null,ariaDescribedById:{draggable:""},dispatch:Mt,draggableNodes:new Map,over:null,measureDroppableContainers:Mt},Bt=l.createContext(Ca),Wr=l.createContext(Ta);function Da(){return{draggable:{active:null,initialCoordinates:{x:0,y:0},nodes:new Map,translate:{x:0,y:0}},droppable:{containers:new mt}}}function Ra(e,t){switch(t.type){case J.DragStart:return{...e,draggable:{...e.draggable,initialCoordinates:t.initialCoordinates,active:t.active}};case J.DragMove:return e.draggable.active==null?e:{...e,draggable:{...e.draggable,translate:{x:t.coordinates.x-e.draggable.initialCoordinates.x,y:t.coordinates.y-e.draggable.initialCoordinates.y}}};case J.DragEnd:case J.DragCancel:return{...e,draggable:{...e.draggable,active:null,initialCoordinates:{x:0,y:0},translate:{x:0,y:0}}};case J.RegisterDroppable:{const{element:n}=t,{id:r}=n,i=new mt(e.droppable.containers);return i.set(r,n),{...e,droppable:{...e.droppable,containers:i}}}case J.SetDroppableDisabled:{const{id:n,key:r,disabled:i}=t,o=e.droppable.containers.get(n);if(!o||r!==o.key)return e;const a=new mt(e.droppable.containers);return a.set(n,{...o,disabled:i}),{...e,droppable:{...e.droppable,containers:a}}}case J.UnregisterDroppable:{const{id:n,key:r}=t,i=e.droppable.containers.get(n);if(!i||r!==i.key)return e;const o=new mt(e.droppable.containers);return o.delete(n),{...e,droppable:{...e.droppable,containers:o}}}default:return e}}function Aa(e){let{disabled:t}=e;const{active:n,activatorEvent:r,draggableNodes:i}=l.useContext(Bt),o=rn(r),a=rn(n?.id);return l.useEffect(()=>{if(!t&&!r&&o&&a!=null){if(!xn(o)||document.activeElement===o.target)return;const s=i.get(a);if(!s)return;const{activatorNode:u,node:h}=s;if(!u.current&&!h.current)return;requestAnimationFrame(()=>{for(const d of[u.current,h.current]){if(!d)continue;const f=bo(d);if(f){f.focus();break}}})}},[r,t,i,a,o]),null}function Ia(e,t){let{transform:n,...r}=t;return e!=null&&e.length?e.reduce((i,o)=>o({transform:i,...r}),n):n}function Na(e){return l.useMemo(()=>({draggable:{...Rt.draggable,...e?.draggable},droppable:{...Rt.droppable,...e?.droppable},dragOverlay:{...Rt.dragOverlay,...e?.dragOverlay}}),[e?.draggable,e?.droppable,e?.dragOverlay])}function Ma(e){let{activeNode:t,measure:n,initialRect:r,config:i=!0}=e;const o=l.useRef(!1),{x:a,y:s}=typeof i=="boolean"?{x:i,y:i}:i;Re(()=>{if(!a&&!s||!t){o.current=!1;return}if(o.current||!r)return;const h=t?.node.current;if(!h||h.isConnected===!1)return;const d=n(h),f=Nr(d,r);if(a||(f.x=0),s||(f.y=0),o.current=!0,Math.abs(f.x)>0||Math.abs(f.y)>0){const m=Mr(h);m&&m.scrollBy({top:f.y,left:f.x})}},[t,a,s,r,n])}const Hr=l.createContext({...Ee,scaleX:1,scaleY:1});var Fe;(function(e){e[e.Uninitialized=0]="Uninitialized",e[e.Initializing=1]="Initializing",e[e.Initialized=2]="Initialized"})(Fe||(Fe={}));const La=l.memo(function(t){var n,r,i,o;let{id:a,accessibility:s,autoScroll:u=!0,children:h,sensors:d=Ea,collisionDetection:f=Bo,measuring:m,modifiers:g,...M}=t;const p=l.useReducer(Ra,void 0,Da),[v,w]=p,[R,y]=Co(),[A,C]=l.useState(Fe.Uninitialized),I=A===Fe.Initialized,{draggable:{active:N,nodes:x,translate:D},droppable:{containers:O}}=v,z=N!=null?x.get(N):null,q=l.useRef({initial:null,translated:null}),Y=l.useMemo(()=>{var ae;return N!=null?{id:N,data:(ae=z?.data)!=null?ae:Sa,rect:q}:null},[N,z]),V=l.useRef(null),[ie,G]=l.useState(null),[X,K]=l.useState(null),H=vt(M,Object.values(M)),oe=Et("DndDescribedBy",a),ue=l.useMemo(()=>O.getEnabled(),[O]),Z=Na(m),{droppableRects:he,measureDroppableContainers:we,measuringScheduled:Se}=da(ue,{dragging:I,dependencies:[D.x,D.y],config:Z.droppable}),Q=la(x,N),F=l.useMemo(()=>X?on(X):null,[X]),U=fi(),T=ua(Q,Z.draggable.measure);Ma({activeNode:N!=null?x.get(N):null,config:U.layoutShiftCompensation,initialRect:T,measure:Z.draggable.measure});const E=_n(Q,Z.draggable.measure,T),k=_n(Q?Q.parentElement:null),B=l.useRef({activatorEvent:null,active:null,activeNode:Q,collisionRect:null,collisions:null,droppableRects:he,draggableNodes:x,draggingNode:null,draggingNodeRect:null,droppableContainers:O,over:null,scrollableAncestors:[],scrollAdjustedTranslate:null}),_=O.getNodeFor((n=B.current.over)==null?void 0:n.id),ce=xa({measure:Z.dragOverlay.measure}),se=(r=ce.nodeRef.current)!=null?r:Q,ke=I?(i=ce.rect)!=null?i:E:null,Nn=!!(ce.nodeRef.current&&ce.rect),Mn=pa(Nn?null:E),Ft=jr(se?de(se):null),Oe=ga(I?_??Q:null),St=ba(Oe),Tt=Ia(g,{transform:{x:D.x-Mn.x,y:D.y-Mn.y,scaleX:1,scaleY:1},activatorEvent:X,active:Y,activeNodeRect:E,containerNodeRect:k,draggingNodeRect:ke,over:B.current.over,overlayNodeRect:ce.rect,scrollableAncestors:Oe,scrollableAncestorRects:St,windowRect:Ft}),Ln=F?_e(F,D):null,kn=ma(Oe),ai=tr(kn),si=tr(kn,[E]),We=_e(Tt,ai),He=ke?Fo(ke,Tt):null,st=Y&&He?f({active:Y,collisionRect:He,droppableRects:he,droppableContainers:ue,pointerCoordinates:Ln}):null,On=ko(st,"id"),[ze,zn]=l.useState(null),li=Nn?Tt:_e(Tt,si),ci=Po(li,(o=ze?.rect)!=null?o:null,E),$t=l.useRef(null),Bn=l.useCallback((ae,fe)=>{let{sensor:pe,options:Be}=fe;if(V.current==null)return;const me=x.get(V.current);if(!me)return;const ge=ae.nativeEvent,Te=new pe({active:V.current,activeNode:me,event:ge,options:Be,context:B,onAbort(te){if(!x.get(te))return;const{onDragAbort:Ce}=H.current,Ie={id:te};Ce?.(Ie),R({type:"onDragAbort",event:Ie})},onPending(te,Pe,Ce,Ie){if(!x.get(te))return;const{onDragPending:ct}=H.current,Ue={id:te,constraint:Pe,initialCoordinates:Ce,offset:Ie};ct?.(Ue),R({type:"onDragPending",event:Ue})},onStart(te){const Pe=V.current;if(Pe==null)return;const Ce=x.get(Pe);if(!Ce)return;const{onDragStart:Ie}=H.current,lt={activatorEvent:ge,active:{id:Pe,data:Ce.data,rect:q}};ht.unstable_batchedUpdates(()=>{Ie?.(lt),C(Fe.Initializing),w({type:J.DragStart,initialCoordinates:te,active:Pe}),R({type:"onDragStart",event:lt}),G($t.current),K(ge)})},onMove(te){w({type:J.DragMove,coordinates:te})},onEnd:qe(J.DragEnd),onCancel:qe(J.DragCancel)});$t.current=Te;function qe(te){return async function(){const{active:Ce,collisions:Ie,over:lt,scrollAdjustedTranslate:ct}=B.current;let Ue=null;if(Ce&&ct){const{cancelDrop:dt}=H.current;Ue={activatorEvent:ge,active:Ce,collisions:Ie,delta:ct,over:lt},te===J.DragEnd&&typeof dt=="function"&&await Promise.resolve(dt(Ue))&&(te=J.DragCancel)}V.current=null,ht.unstable_batchedUpdates(()=>{w({type:te}),C(Fe.Uninitialized),zn(null),G(null),K(null),$t.current=null;const dt=te===J.DragEnd?"onDragEnd":"onDragCancel";if(Ue){const jt=H.current[dt];jt?.(Ue),R({type:dt,event:Ue})}})}}},[x]),di=l.useCallback((ae,fe)=>(pe,Be)=>{const me=pe.nativeEvent,ge=x.get(Be);if(V.current!==null||!ge||me.dndKit||me.defaultPrevented)return;const Te={active:ge};ae(pe,fe.options,Te)===!0&&(me.dndKit={capturedBy:fe.sensor},V.current=Be,Bn(pe,fe))},[x,Bn]),Pn=ca(d,di);va(d),Re(()=>{E&&A===Fe.Initializing&&C(Fe.Initialized)},[E,A]),l.useEffect(()=>{const{onDragMove:ae}=H.current,{active:fe,activatorEvent:pe,collisions:Be,over:me}=B.current;if(!fe||!pe)return;const ge={active:fe,activatorEvent:pe,collisions:Be,delta:{x:We.x,y:We.y},over:me};ht.unstable_batchedUpdates(()=>{ae?.(ge),R({type:"onDragMove",event:ge})})},[We.x,We.y]),l.useEffect(()=>{const{active:ae,activatorEvent:fe,collisions:pe,droppableContainers:Be,scrollAdjustedTranslate:me}=B.current;if(!ae||V.current==null||!fe||!me)return;const{onDragOver:ge}=H.current,Te=Be.get(On),qe=Te&&Te.rect.current?{id:Te.id,rect:Te.rect.current,data:Te.data,disabled:Te.disabled}:null,te={active:ae,activatorEvent:fe,collisions:pe,delta:{x:me.x,y:me.y},over:qe};ht.unstable_batchedUpdates(()=>{zn(qe),ge?.(te),R({type:"onDragOver",event:te})})},[On]),Re(()=>{B.current={activatorEvent:X,active:Y,activeNode:Q,collisionRect:He,collisions:st,droppableRects:he,draggableNodes:x,draggingNode:se,draggingNodeRect:ke,droppableContainers:O,over:ze,scrollableAncestors:Oe,scrollAdjustedTranslate:We},q.current={initial:ke,translated:He}},[Y,Q,st,He,x,se,ke,he,O,ze,Oe,We]),oa({...U,delta:D,draggingRect:He,pointerCoordinates:Ln,scrollableAncestors:Oe,scrollableAncestorRects:St});const ui=l.useMemo(()=>({active:Y,activeNode:Q,activeNodeRect:E,activatorEvent:X,collisions:st,containerNodeRect:k,dragOverlay:ce,draggableNodes:x,droppableContainers:O,droppableRects:he,over:ze,measureDroppableContainers:we,scrollableAncestors:Oe,scrollableAncestorRects:St,measuringConfiguration:Z,measuringScheduled:Se,windowRect:Ft}),[Y,Q,E,X,st,k,ce,x,O,he,ze,we,Oe,St,Z,Se,Ft]),hi=l.useMemo(()=>({activatorEvent:X,activators:Pn,active:Y,activeNodeRect:E,ariaDescribedById:{draggable:oe},dispatch:w,draggableNodes:x,over:ze,measureDroppableContainers:we}),[X,Pn,Y,E,w,oe,x,ze,we]);return ne.createElement(Ir.Provider,{value:y},ne.createElement(Bt.Provider,{value:hi},ne.createElement(Wr.Provider,{value:ui},ne.createElement(Hr.Provider,{value:ci},h)),ne.createElement(Aa,{disabled:s?.restoreFocus===!1})),ne.createElement(Ao,{...s,hiddenTextDescribedById:oe}));function fi(){const ae=ie?.autoScrollEnabled===!1,fe=typeof u=="object"?u.enabled===!1:u===!1,pe=I&&!ae&&!fe;return typeof u=="object"?{...u,enabled:pe}:{enabled:pe}}}),ka=l.createContext(null),rr="button",Oa="Draggable";function za(e){let{id:t,data:n,disabled:r=!1,attributes:i}=e;const o=Et(Oa),{activators:a,activatorEvent:s,active:u,activeNodeRect:h,ariaDescribedById:d,draggableNodes:f,over:m}=l.useContext(Bt),{role:g=rr,roleDescription:M="draggable",tabIndex:p=0}=i??{},v=u?.id===t,w=l.useContext(v?Hr:ka),[R,y]=At(),[A,C]=At(),I=ya(a,t),N=vt(n);Re(()=>(f.set(t,{id:t,key:o,node:R,activatorNode:A,data:N}),()=>{const D=f.get(t);D&&D.key===o&&f.delete(t)}),[f,t]);const x=l.useMemo(()=>({role:g,tabIndex:p,"aria-disabled":r,"aria-pressed":v&&g===rr?!0:void 0,"aria-roledescription":M,"aria-describedby":d.draggable}),[r,g,p,v,M,d.draggable]);return{active:u,activatorEvent:s,activeNodeRect:h,attributes:x,isDragging:v,listeners:r?void 0:I,node:R,over:m,setNodeRef:y,setActivatorNodeRef:C,transform:w}}function Ba(){return l.useContext(Wr)}const Pa="Droppable",Ua={timeout:25};function Fa(e){let{data:t,disabled:n=!1,id:r,resizeObserverConfig:i}=e;const o=Et(Pa),{active:a,dispatch:s,over:u,measureDroppableContainers:h}=l.useContext(Bt),d=l.useRef({disabled:n}),f=l.useRef(!1),m=l.useRef(null),g=l.useRef(null),{disabled:M,updateMeasurementsFor:p,timeout:v}={...Ua,...i},w=vt(p??r),R=l.useCallback(()=>{if(!f.current){f.current=!0;return}g.current!=null&&clearTimeout(g.current),g.current=setTimeout(()=>{h(Array.isArray(w.current)?w.current:[w.current]),g.current=null},v)},[v]),y=zt({callback:R,disabled:M||!a}),A=l.useCallback((x,D)=>{y&&(D&&(y.unobserve(D),f.current=!1),x&&y.observe(x))},[y]),[C,I]=At(A),N=vt(t);return l.useEffect(()=>{!y||!C.current||(y.disconnect(),f.current=!1,y.observe(C.current))},[C,y]),l.useEffect(()=>(s({type:J.RegisterDroppable,element:{id:r,key:o,disabled:n,node:C,rect:m,data:N}}),()=>s({type:J.UnregisterDroppable,key:o,id:r})),[r]),l.useEffect(()=>{n!==d.current.disabled&&(s({type:J.SetDroppableDisabled,id:r,key:o,disabled:n}),d.current.disabled=n)},[r,o,n,s]),{active:a,rect:m,isOver:u?.id===r,node:C,over:u,setNodeRef:I}}const $a=e=>{let{transform:t}=e;return{...t,y:0}};function ja(e,t,n){const r={...e};return t.top+e.y<=n.top?r.y=n.top-t.top:t.bottom+e.y>=n.top+n.height&&(r.y=n.top+n.height-t.bottom),t.left+e.x<=n.left?r.x=n.left-t.left:t.right+e.x>=n.left+n.width&&(r.x=n.left+n.width-t.right),r}const Wa=e=>{let{containerNodeRect:t,draggingNodeRect:n,transform:r}=e;return!n||!t?r:ja(r,n,t)};function Dn(e,t,n){const r=e.slice();return r.splice(n<0?r.length+n:n,0,r.splice(t,1)[0]),r}function Ha(e,t){return e.reduce((n,r,i)=>{const o=t.get(r);return o&&(n[i]=o),n},Array(e.length))}function Ct(e){return e!==null&&e>=0}function qa(e,t){if(e===t)return!0;if(e.length!==t.length)return!1;for(let n=0;n<e.length;n++)if(e[n]!==t[n])return!1;return!0}function Ya(e){return typeof e=="boolean"?{draggable:e,droppable:e}:e}const Dt={scaleX:1,scaleY:1},Va=e=>{var t;let{rects:n,activeNodeRect:r,activeIndex:i,overIndex:o,index:a}=e;const s=(t=n[i])!=null?t:r;if(!s)return null;const u=Ga(n,a,i);if(a===i){const h=n[o];return h?{x:i<o?h.left+h.width-(s.left+s.width):h.left-s.left,y:0,...Dt}:null}return a>i&&a<=o?{x:-s.width-u,y:0,...Dt}:a<i&&a>=o?{x:s.width+u,y:0,...Dt}:{x:0,y:0,...Dt}};function Ga(e,t,n){const r=e[t],i=e[t-1],o=e[t+1];return!r||!i&&!o?0:n<t?i?r.left-(i.left+i.width):o.left-(r.left+r.width):o?o.left-(r.left+r.width):r.left-(i.left+i.width)}const qr=e=>{let{rects:t,activeIndex:n,overIndex:r,index:i}=e;const o=Dn(t,r,n),a=t[i],s=o[i];return!s||!a?null:{x:s.left-a.left,y:s.top-a.top,scaleX:s.width/a.width,scaleY:s.height/a.height}},Yr="Sortable",Vr=ne.createContext({activeIndex:-1,containerId:Yr,disableTransforms:!1,items:[],overIndex:-1,useDragOverlay:!1,sortedRects:[],strategy:qr,disabled:{draggable:!1,droppable:!1}});function Xa(e){let{children:t,id:n,items:r,strategy:i=qr,disabled:o=!1}=e;const{active:a,dragOverlay:s,droppableRects:u,over:h,measureDroppableContainers:d}=Ba(),f=Et(Yr,n),m=s.rect!==null,g=l.useMemo(()=>r.map(I=>typeof I=="object"&&"id"in I?I.id:I),[r]),M=a!=null,p=a?g.indexOf(a.id):-1,v=h?g.indexOf(h.id):-1,w=l.useRef(g),R=!qa(g,w.current),y=v!==-1&&p===-1||R,A=Ya(o);Re(()=>{R&&M&&d(g)},[R,g,M,d]),l.useEffect(()=>{w.current=g},[g]);const C=l.useMemo(()=>({activeIndex:p,containerId:f,disabled:A,disableTransforms:y,items:g,overIndex:v,useDragOverlay:m,sortedRects:Ha(g,u),strategy:i}),[p,f,A.draggable,A.droppable,y,g,v,u,m,i]);return ne.createElement(Vr.Provider,{value:C},t)}const Ka=e=>{let{id:t,items:n,activeIndex:r,overIndex:i}=e;return Dn(n,r,i).indexOf(t)},Qa=e=>{let{containerId:t,isSorting:n,wasDragging:r,index:i,items:o,newIndex:a,previousItems:s,previousContainerId:u,transition:h}=e;return!h||!r||s!==o&&i===a?!1:n?!0:a!==i&&t===u},Ja={duration:200,easing:"ease"},Gr="transform",Za=Nt.Transition.toString({property:Gr,duration:0,easing:"linear"}),_a={roleDescription:"sortable"};function es(e){let{disabled:t,index:n,node:r,rect:i}=e;const[o,a]=l.useState(null),s=l.useRef(n);return Re(()=>{if(!t&&n!==s.current&&r.current){const u=i.current;if(u){const h=at(r.current,{ignoreTransform:!0}),d={x:u.left-h.left,y:u.top-h.top,scaleX:u.width/h.width,scaleY:u.height/h.height};(d.x||d.y)&&a(d)}}n!==s.current&&(s.current=n)},[t,n,r,i]),l.useEffect(()=>{o&&a(null)},[o]),o}function ts(e){let{animateLayoutChanges:t=Qa,attributes:n,disabled:r,data:i,getNewIndex:o=Ka,id:a,strategy:s,resizeObserverConfig:u,transition:h=Ja}=e;const{items:d,containerId:f,activeIndex:m,disabled:g,disableTransforms:M,sortedRects:p,overIndex:v,useDragOverlay:w,strategy:R}=l.useContext(Vr),y=ns(r,g),A=d.indexOf(a),C=l.useMemo(()=>({sortable:{containerId:f,index:A,items:d},...i}),[f,i,A,d]),I=l.useMemo(()=>d.slice(d.indexOf(a)),[d,a]),{rect:N,node:x,isOver:D,setNodeRef:O}=Fa({id:a,data:C,disabled:y.droppable,resizeObserverConfig:{updateMeasurementsFor:I,...u}}),{active:z,activatorEvent:q,activeNodeRect:Y,attributes:V,setNodeRef:ie,listeners:G,isDragging:X,over:K,setActivatorNodeRef:H,transform:oe}=za({id:a,data:C,attributes:{..._a,...n},disabled:y.draggable}),ue=go(O,ie),Z=!!z,he=Z&&!M&&Ct(m)&&Ct(v),we=!w&&X,Se=we&&he?oe:null,F=he?Se??(s??R)({rects:p,activeNodeRect:Y,activeIndex:m,overIndex:v,index:A}):null,U=Ct(m)&&Ct(v)?o({id:a,items:d,activeIndex:m,overIndex:v}):A,T=z?.id,E=l.useRef({activeId:T,items:d,newIndex:U,containerId:f}),k=d!==E.current.items,B=t({active:z,containerId:f,isDragging:X,isSorting:Z,id:a,index:A,items:d,newIndex:E.current.newIndex,previousItems:E.current.items,previousContainerId:E.current.containerId,transition:h,wasDragging:E.current.activeId!=null}),_=es({disabled:!B,index:A,node:x,rect:N});return l.useEffect(()=>{Z&&E.current.newIndex!==U&&(E.current.newIndex=U),f!==E.current.containerId&&(E.current.containerId=f),d!==E.current.items&&(E.current.items=d)},[Z,U,f,d]),l.useEffect(()=>{if(T===E.current.activeId)return;if(T!=null&&E.current.activeId==null){E.current.activeId=T;return}const se=setTimeout(()=>{E.current.activeId=T},50);return()=>clearTimeout(se)},[T]),{active:z,activeIndex:m,attributes:V,data:C,rect:N,index:A,newIndex:U,items:d,isOver:D,isSorting:Z,isDragging:X,listeners:G,node:x,overIndex:v,over:K,setNodeRef:ue,setActivatorNodeRef:H,setDroppableNodeRef:O,setDraggableNodeRef:ie,transform:_??F,transition:ce()};function ce(){if(_||k&&E.current.newIndex===A)return Za;if(!(we&&!xn(q)||!h)&&(Z||B))return Nt.Transition.toString({...h,property:Gr})}}function ns(e,t){var n,r;return typeof e=="boolean"?{draggable:e,droppable:!1}:{draggable:(n=e?.draggable)!=null?n:t.draggable,droppable:(r=e?.droppable)!=null?r:t.droppable}}j.Down,j.Right,j.Up,j.Left;const rs=S(L)`
    ...
    padding: 3px 10px;
    flex-shrink: 0;
`;function is({year:e,semester:t,setYear:n,setSemester:r,setCurrentTimetableId:i}){const o=je(),{query:a}=le("GET","/semesters");l.useEffect(()=>{const f=a.data?.semesters;if(f&&f.length>0){const m=f[f.length-1];m&&(n(m.year),r(m.semester))}},[a.data]);const{isFirstSemester:s,isLastSemester:u}=l.useMemo(()=>{if(!a.data)return{isFirstSemester:!1,isLastSemester:!1};const f=a.data.semesters,m=f[0],g=f[f.length-1];return!m||!g?{isFirstSemester:!0,isLastSemester:!0}:{isFirstSemester:e===m.year&&t===m.semester,isLastSemester:e===g.year&&t===g.semester}},[a.data,e,t]),h=()=>{s||(t===Ye.SPRING?(r(Ye.FALL),n(e-1)):r(Ye.SPRING),i(null))},d=()=>{u||(t===Ye.FALL?(r(Ye.SPRING),n(e+1)):r(Ye.FALL),i(null))};return b(rs,{direction:"row",gap:0,justify:"space-between",align:"center",children:[c(tt,{onClick:s?void 0:h,styles:{padding:2.5},children:c(re,{size:20,color:s?o.colors.Text.disable:o.colors.Highlight.default,onClick:s?void 0:()=>{},children:c(Mi,{})})}),c(P,{color:"Highlight.default",children:e}),c(P,{color:"Highlight.default",children:tn(t)}),c(tt,{onClick:u?void 0:d,styles:{padding:2.5},children:c(re,{size:20,color:u?o.colors.Text.disable:o.colors.Highlight.default,onClick:u?void 0:()=>{},children:c(Li,{})})})]})}const Xr=S.div`
    display: inline-flex;
    padding: 5px 12px;
    justify-content: center;
    align-items: center;
...
`,as=S(Xr)`
    ...
    cursor: pointer;
`,ss={default:os,selected:as},ls=S.div`
    width: 100%;
    height: 100%;
    justify-content: center;
    align-items: center;
    ...
    display: inline-flex;
    white-space: nowrap;
`,cs=e=>c(ls,{children:e}),cn=({type:e="default",children:t=void 0,buttonRef:n,...r})=>{const i=ss[e],o=()=>cs(t);return c(i,{ref:n,...r,onClick:r.onClick,children:c(o,{})})},ds=S(L)`
    width: 100%;
    max-width: 890px;
...
`,hs=S(P)`
    outline: none;
    user-select: none;
`,fs=({timetable:e,isSelected:t,onClick:n,onCopy:r,onDelete:i,onNameChange:o,isDragging:a})=>{const s=je(),{attributes:u,listeners:h,setNodeRef:d,transform:f,transition:m}=ts({id:e.id}),M={transform:(p=>{if(!p)return"";const{x:v,y:w,scaleX:R=1,scaleY:y=1}=p;return`translate3d(${v}px, ${w}px, 0) scaleX(${R}) scaleY(${y})`})(f),transition:m,touchAction:"none",opacity:a?.5:1};return c("div",{ref:d,style:M,...u,...h,children:b(cn,{type:t?"selected":"default",onClick:n,children:[c(hs,{onClick:p=>{t&&(p.stopPropagation(),p.currentTarget.contentEditable="true",p.currentTarget.focus())},onBlur:p=>{const v=p.currentTarget.textContent||"";p.currentTarget.contentEditable="false",o(e.id,v)},onKeyDown:p=>{p.key==="Enter"&&(p.preventDefault(),p.currentTarget.blur())},contentEditable:!1,suppressContentEditableWarning:!0,type:"Normal",color:t?"Highlight.default":"Text.lighter",style:{paddingTop:4,paddingBottom:3.5},children:e.name?e.name:"No Title"}),b(L,{direction:"row",gap:0,align:"center",children:[t&&c(tt,{onClick:r,styles:{padding:5},children:c(re,{size:15,onClick:()=>{},color:t?s.colors.Highlight.default:s.colors.Text.lighter,children:c(vn,{})})}),c(tt,{onClick:i,styles:{padding:3.75},children:c(re,{size:17.5,onClick:()=>{},color:t?s.colors.Highlight.default:s.colors.Text.lighter,children:c(Er,{})})})]})]})})},ir=({timeTableLectures:e,currentTimetableId:t,setCurrentTimetableId:n,setCurrentTimetableName:r,year:i,semester:o,setYear:a,setSemester:s})=>{const{t:u}=Ae(),{status:h}=mn(),d=je(),{query:f,setParams:m}=le("GET","/timetables"),{requestFunction:g}=le("POST","/timetables",{onSuccess:x=>{f.refetch(),n(x.id)}}),{requestFunction:M}=le("DELETE","/timetables",{onMutate:x=>{t===x.id&&n(null)},onSuccess:()=>{f.refetch()}}),{requestFunction:p}=le("PATCH","/timetables",{onSuccess:()=>{f.refetch()}}),[v,w]=l.useState([]),[R,y]=l.useState(null),A=Io(Vn(Cn,{activationConstraint:{distance:8}}),Vn(Fr,{activationConstraint:{delay:500,tolerance:5}}));l.useEffect(()=>{let x=f.data?.timetables??[];x=x.filter(D=>D.year===i&&D.semester===o),w(x.slice().sort((D,O)=>D.timeTableOrder-O.timeTableOrder)),t!=null&&f.data?.timetables.forEach(D=>{D.id===t&&r(D.name)})},[f.data,i,o]),l.useEffect(()=>{h==="success"&&i!==-1&&m({year:i,semester:o})},[i,o,h]),l.useEffect(()=>{r(t==null?u("timetable.myTimetable"):v.find(x=>x.id===t)?.name||"")},[t]);const C=x=>{y(x.active.id)},I=x=>{const{active:D,over:O}=x;if(y(null),O&&D.id!==O.id){const z=v.findIndex(ie=>ie.id===D.id),q=v.findIndex(ie=>ie.id===O.id),Y=Dn(v,z,q);w(Y);const V=D.id;p({id:V,order:q})}},N=x=>{if(x.deltaY===0)return;const D=x.currentTarget;D.scrollLeft=D.scrollLeft+x.deltaY};return b(ds,{direction:"row",justify:"space-between",align:"center",gap:4,children:[b(L,{direction:"row",align:"flex-start",gap:3,flex:"1 1 auto",style:{minWidth:0},children:[b(cn,{type:t==null?"selected":"default",onClick:()=>{n(null)},children:[c(P,{type:"Normal",color:t===null?"Highlight.default":"Text.lighter",style:{paddingTop:4,paddingBottom:3.5},children:u("timetable.myTimetable")}),t===null&&c(tt,{onClick:x=>{x.stopPropagation(),g({year:i,semester:o,lectureIds:e.map(D=>D.id)})},styles:{padding:5},children:c(re,{size:15,color:d.colors.Highlight.default,onClick:()=>{},children:c(vn,{})})})]},"my-timetable"),b(us,{direction:"row",gap:3,flex:"1 1 auto",onWheel:N,children:[c(La,{sensors:A,collisionDetection:Oo,onDragStart:C,onDragEnd:I,modifiers:[$a,Wa],children:c(Xa,{items:v.map(x=>x.id),strategy:Va,children:v.map(x=>c(fs,{timetable:x,isSelected:t===x.id,isDragging:R===x.id,onClick:()=>{n(x.id)},onCopy:D=>{D.stopPropagation(),g({year:i,semester:o,lectureIds:e.map(O=>O.id)})},onDelete:D=>{D.stopPropagation(),M({id:x.id})},onNameChange:(D,O)=>{w(z=>z.map(q=>q.id===D?{...q,name:O}:q)),p({id:D,name:O})}},x.id))})}),c(cn,{onClick:()=>{g({year:i,semester:o,lectureIds:[]})},children:c(tt,{onClick:x=>{},styles:{padding:3.75},children:c(re,{size:17.5,color:d.colors.Text.default,onClick:()=>{},children:c(pn,{})})})})]})]}),c(is,{year:i,semester:o,setYear:a,setSemester:s,setCurrentTimetableId:n})]})},ps=S.div`
    display: grid;
...
`),this.data.events.forEach(t=>e+=t.toString()),e+=An(this.data),e+="END:VCALENDAR",ks(e)}ttl(e){return e===void 0?this.data.ttl:(zs(e)?this.data.ttl=e.asSeconds():e&&e>0?this.data.ttl=e:this.data.ttl=null,this)}url(e){return e===void 0?this.data.url:(this.data.url=e||null,this)}x(e,t){if(e===void 0)return be(this.data);if(typeof e=="string"&&typeof t=="string")be(this.data,e,t);else if(typeof e=="object")be(this.data,e);else throw new Error("Either key or value is not a string!");return this}};function Fs(e){return new Us(e)}var $s=Fs;function js(e){const{ctx:t,x:n,y:r,width:i,height:o,radius:a,color:s}=e;t.fillStyle=s,t.beginPath(),t.moveTo(n+a,r),t.lineTo(n+i-a,r),t.quadraticCurveTo(n+i,r,n+i,r+a),t.lineTo(n+i,r+o-a),t.quadraticCurveTo(n+i,r+o,n+i-a,r+o),t.lineTo(n+a,r+o),t.quadraticCurveTo(n,r+o,n,r+o-a),t.lineTo(n,r+a),t.quadraticCurveTo(n,r,n+a,r),t.closePath(),t.fill()}function _t(e,t,n,r){const o=document.createElement("canvas").getContext("2d");if(!o)return[];o.font=`${r}px '${n}'`;let a="";const s=[];for(const u of e){const h=a+u;o.measureText(h).width>t&&a!==""?(s.push(a),a=u):a=h}return a&&s.push(a),s}function ii(e){const{ctx:t,x:n,y:r,text:i,font:o,fontSize:a,color:s,align:u="left"}=e;t.fillStyle=s,t.font=`${a}px '${o}'`,t.textAlign=u||"left",t.fillText(i,n,r)}function Ws(e){const{ctx:t,x:n,y:r,width:i,height:o,title:a,professor:s,location:u,font:h,fontSize:d}=e,f=_t(a,i,h,d),m=_t(s,i,h,d),g=_t(u,i,h,d);let M=0;const p=[...f,...g,...m].slice(0,3);M=p.reduce((R,y,A)=>y===""?R+2:R+d,0);let w=(o-M)/2+d-7;p.forEach((R,y)=>{R!==""?(ii({ctx:t,x:n,y:r+w,text:R,font:h,fontSize:d,color:`rgba(0, 0, 0, ${y<f.length?.8:.5})`}),w+=d+5):w+=2})}async function oi(e){const{timetableName:t,lectures:n,timetableType:r,semesterName:i,semesterFontSize:o,tileFontSize:a}=e,s=["#F2CECE","#F4B3AE","#F2BCA0","#F0D3AB","#F1E1A9","#f4f2b3","#dbf4be","#beedd7","#b7e2de","#c9eaf4","#B4D3ED","#B9C5ED","#CCC6ED","#D8C1F0","#EBCAEF","#f4badb"],u=`Image_template_${r}.png`,h=new Image;h.src=u,await new Promise((g,M)=>{h.onload=g,h.onerror=M});const d=await cr.loadImage(u),f=cr.createCanvas(d.width,d.height),m=f.getContext("2d");m.drawImage(d,0,0),ii({ctx:m,x:r==="5days"?952:1302,y:78,text:i+" "+t,font:"NotoSansKR",fontSize:o,color:"#CCCCCC",align:"right"});for(const g of n){const M=s[g.courseId%16]||"#F2CECE";for(const p of g.classes){const{day:v,begin:w,end:R}=p,[y,A,C,I]=[178*v+76,w*4/3-486,171,(R-w)*4/3-7];js({ctx:m,x:y,y:A,width:C,height:I,radius:4,color:M}),Ws({ctx:m,x:y+12,y:A+8,width:C-24,height:I-16,title:g.name,professor:Di(g.professors)||"",location:p.buildingCode+" "+p.roomName||"",font:"NotoSansKR",fontSize:a})}}return f}async function Hs(e){const n=(await oi(e)).toDataURL("image/png"),r=document.createElement("a");r.href=n,r.download=`${e.timetableName}.png`,r.click(),URL.revokeObjectURL(n)}async function qs(e){const n=(await oi(e)).toDataURL("image/png"),i=await(await fetch(n)).blob();if(!navigator.clipboard?.write)return;const o=new ClipboardItem({"image/png":i});await navigator.clipboard.write([o])}function Ys(e){const{name:t,lectures:n,semesterObject:r}=e,i=$s({name:t,prodId:"//SPARCS//OTL Plus",timezone:"Asia/Seoul"});for(const u of n)for(const h of u.classes){const d=h.buildingCode+" "+h.roomName,f=new Date(r.beginning),m=(h.day+1)%7,g=new Date(f),M=g.getDay(),p=(m+7-M)%7;g.setDate(g.getDate()+p);const v=Math.floor(h.begin/60),w=h.begin%60,R=Math.floor(h.end/60),y=h.end%60,A=new Date(g);A.setHours(v,w,0,0);const C=new Date(g);C.setHours(R,y,0,0),i.createEvent({start:A,end:C,summary:u.name,location:d,repeating:{freq:Rn.WEEKLY,until:new Date(r.end)},timezone:"Asia/Seoul"}).alarms([{type:In.display,trigger:900}])}const o=new Blob([i.toString()],{type:"text/calendar;charset=utf-8"}),a=URL.createObjectURL(o),s=document.createElement("a");s.href=a,s.download=`${t}.ics`,s.click(),URL.revokeObjectURL(a)}const Vs=S(L)`
    width: 100%;
...
`,Js=S(L)`
    ...
    border-radius: 12px;
    white-space: nowrap;
`,ml=gi(function(){const t=hn(),n=je(),r=$e("tablet"),i=$e("laptop"),o=$e("desktop"),a=l.useRef(null),s=l.useRef(null),u=l.useRef(null),[h,d]=l.useState(null),[f,m]=l.useState(null),[g,M]=l.useState(null),[p,v]=l.useState(null),[w,R]=l.useState(""),[y,A]=l.useState(-1),[C,I]=l.useState(1),[N,x]=l.useState(0),[D,O]=l.useState(0),[z,q]=l.useState(!1),{query:Y}=le("GET",`/timetables/${p}`,{enabled:p!==null}),{query:V,setParams:ie}=le("GET","/timetables/my-timetable",{enabled:p===null}),G=p===null?V.data?.lectures??[]:Y.data?.lectures??[],{requestFunction:X}=le("PATCH",`/timetables/${p}`,{onSuccess:()=>{t.invalidateQueries({queryKey:[`/timetables/${p}`]}).then(()=>{m(null),d(null)})}}),K=l.useCallback(H=>{X({action:"delete",lectureId:H})},[X]);return l.useEffect(()=>{function H(){s.current&&(x(s.current.offsetWidth),O(s.current.offsetHeight))}return H(),window.addEventListener("resize",H),()=>window.removeEventListener("resize",H)},[z]),l.useEffect(()=>{const H=oe=>{a.current&&!a.current.contains(oe.target)&&s.current&&!s.current.contains(oe.target)&&u.current&&u.current.contains(oe.target)&&m(null)};return document.addEventListener("mousedown",H),()=>document.removeEventListener("mousedown",H)},[]),l.useEffect(()=>{m(null),d(null),y!==-1&&ie({year:y,semester:C})},[y,C]),l.useEffect(()=>{m(null),d(null)},[p]),l.useEffect(()=>{g!==null&&r&&q(!0)},[g]),c(Xs,{direction:r?"column":"row",align:"stretch",justify:"center",gap:12,flex:"1 0 0",ref:u,children:r?b(et,{children:[b(vr,{direction:"column",gap:0,align:"stretch",justify:"stretch",style:z?{flex:"1 1 0",minHeight:0}:void 0,children:[c(ir,{timeTableLectures:G,currentTimetableId:p,setCurrentTimetableId:v,setCurrentTimetableName:R,year:y,semester:C,setYear:A,setSemester:I}),c(yr,{direction:"column",gap:12,align:"stretch",justify:"flex-start",flex:"1 0 0",children:c(wr,{direction:"column",gap:0,ref:s,children:c($n,{cellWidth:(N-60)/5,fullHeight:D-60,lectureSummary:G,setTimeFilter:M,hover:h,setHover:d,selected:f,setSelected:m,removeFunction:p===null?void 0:K})})})]}),c(xr,{children:c(gr,{timetableName:w,timetableLectures:G,hover:h,setHover:d,year:y,semester:C})}),b(Js,{direction:"row",gap:0,children:[c(un,{timetableName:w,timetableLectures:G,year:y,semester:C}),b(L,{direction:"row",gap:4,align:"center",style:{height:"100%"},onClick:()=>{q(!z)},children:[c(re,{size:16,color:n.colors.Highlight.default,children:c(mi,{})}),c(P,{type:"Normal",color:"Highlight.default",children:z?"검색 닫기":"과목 검색하기"})]})]}),z&&c(mr,{direction:"row",align:"flex-start",gap:12,ref:a,children:c(br,{children:c(qn,{timetableLectures:G,year:y,semester:C,hoveredLecture:h,selectedLecture:f,setSelectedLecture:m,setHoveredLecture:d,timeFilter:g,setTimeFilter:M,currentTimetableId:p})})}),f&&c(vi,{isOpen:!!f,onClose:()=>{},fullScreen:!0,header:!1,children:c(Wn,{selectedLecture:f||(h?.length==1?h[0]:null),year:y,semester:C,onMobileModalClose:()=>{d(null),m(null)},currentTimetableId:p,timetableLectures:G})})]}):b(et,{children:[b(mr,{direction:o?"column-reverse":"row",align:"flex-start",gap:12,ref:a,children:[i&&c(Qs,{children:c(un,{timetableName:w,timetableLectures:G,year:y,semester:C})}),c(br,{style:{overflow:"auto"},children:c(qn,{timetableLectures:G,year:y,semester:C,hoveredLecture:h,selectedLecture:f,setSelectedLecture:m,setHoveredLecture:d,timeFilter:g,setTimeFilter:M,currentTimetableId:p})}),!o&&c(ft,{direction:"column"}),c(Ks,{style:{overflow:"auto"},children:c(Wn,{selectedLecture:f||(h?.length==1?h[0]:null),year:y,semester:C})})]}),b(vr,{direction:"column",gap:0,align:"stretch",justify:"stretch",children:[c(ir,{timeTableLectures:G,currentTimetableId:p,setCurrentTimetableId:v,setCurrentTimetableName:R,year:y,semester:C,setYear:A,setSemester:I}),b(yr,{direction:i?"column":"row",gap:i?12:30,align:"stretch",justify:"flex-start",flex:"1 0 0",children:[c(wr,{direction:"column",gap:0,ref:s,children:c($n,{cellWidth:100,fullHeight:i?D-60:D-36,lectureSummary:G,setTimeFilter:M,hover:h,setHover:d,selected:f,setSelected:m,removeFunction:p===null?void 0:K})}),!i&&c(ft,{direction:"column"}),c(xr,{children:c(gr,{timetableName:w,timetableLectures:G,hover:h,setHover:d,year:y,semester:C})})]})]})]})})});export{ml as default};
//# sourceMappingURL=timetable-DzYQIcpJ.js.map
