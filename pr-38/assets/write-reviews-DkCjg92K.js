import{a as f,w as Y}from"./chunk-UIGDSWPH-NakEPbl8.js";import{n as b,F as l,j as h,a as r,b as Q}from"./FlexWrapper-C0dsngQo.js";import{A as ee,C as te,u as F,l as q,D as O,t as j,E as A,j as M,k as Z,F as re,G as ie,w as ne,H as se,e as B}from"./useIsDevice-BXIifVfm.js";import{L as G}from"./Line-DrU6Mk-V.js";import{W as J}from"./Widget-D7VP5HFl.js";import{E as oe,a as ae,S as ce,C as le,R as de}from"./ReviewWritingBlock-CCIA7MBT.js";import{T as m}from"./Typography-DTsae4U-.js";import{u as C}from"./useUserStore-Cs3WP2WQ.js";import{L as E}from"./LoadingCircle-BuapKrmT.js";import{R as V,F as ue,a as fe}from"./ReviewBlock-Cd-9DvRA.js";import{i as K,h as he,a as ge}from"./infiniteQueryBehavior-AEUHXKW8.js";import{T as z}from"./Trans-CHSuP0pc.js";import{j as N}from"./jsx-runtime-u17CrQMm.js";import"./TextInputArea-CshNKqX7.js";var me=class extends ee{constructor(e,t){super(e,t)}bindMethods(){super.bindMethods(),this.fetchNextPage=this.fetchNextPage.bind(this),this.fetchPreviousPage=this.fetchPreviousPage.bind(this)}setOptions(e){super.setOptions({...e,behavior:K()})}getOptimisticResult(e){return e.behavior=K(),super.getOptimisticResult(e)}fetchNextPage(e){return this.fetch({...e,meta:{fetchMore:{direction:"forward"}}})}fetchPreviousPage(e){return this.fetch({...e,meta:{fetchMore:{direction:"backward"}}})}createResult(e,t){const{state:i}=e,n=super.createResult(e,t),{isFetching:c,isRefetching:s,isError:o,isRefetchError:a}=n,u=i.fetchMeta?.fetchMore?.direction,g=o&&u==="forward",x=c&&u==="forward",d=o&&u==="backward",v=c&&u==="backward";return{...n,fetchNextPage:this.fetchNextPage,fetchPreviousPage:this.fetchPreviousPage,hasNextPage:ge(t,i.data),hasPreviousPage:he(t,i.data),isFetchNextPageError:g,isFetchingNextPage:x,isFetchPreviousPageError:d,isFetchingPreviousPage:v,isRefetchError:a&&!g&&!d,isRefetching:s&&!x&&!v}}};function pe(e,t){return te(e,me)}const xe=b.div`
    width: 200px;
    flex-shrink: 1;
    position: relative;
    user-select: none;
