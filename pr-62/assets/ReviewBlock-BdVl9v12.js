...
`,Tt=a.forwardRef(function(t,n){const o=le({props:t,name:"MuiTouchRipple"}),{center:i=!1,classes:r={},className:s,...u}=o,[c,d]=a.useState([]),f=a.useRef(0),p=a.useRef(null);a.useEffect(()=>{p.current&&(p.current(),p.current=null)},[c]);const h=a.useRef(!1),g=gt(),y=a.useRef(null),T=a.useRef(null),x=a.useCallback(m=>{const{pulsate:B,rippleX:C,rippleY:A,rippleSize:V,cb:H}=m;d(w=>[...w,R.jsx(kt,{classes:{ripple:k(r.ripple,M.ripple),rippleVisible:k(r.rippleVisible,M.rippleVisible),ripplePulsate:k(r.ripplePulsate,M.ripplePulsate),child:k(r.child,M.child),childLeaving:k(r.childLeaving,M.childLeaving),childPulsate:k(r.childPulsate,M.childPulsate)},timeout:ie,pulsate:B,rippleX:C,rippleY:A,rippleSize:V},f.current)]),f.current+=1,p.current=H},[r]),E=a.useCallback((m={},B={},C=()=>{})=>{const{pulsate:A=!1,center:V=i||B.pulsate,fakeElement:H=!1}=B;if(m?.type==="mousedown"&&h.current){h.current=!1;return}m?.type==="touchstart"&&(h.current=!0);const w=H?null:T.current,j=w?w.getBoundingClientRect():{width:0,height:0,left:0,top:0};let z,P,L;if(V||m===void 0||m.clientX===0&&m.clientY===0||!m.clientX&&!m.touches)z=Math.round(j.width/2),P=Math.round(j.height/2);else{const{clientX:X,clientY:O}=m.touches&&m.touches.length>0?m.touches[0]:m;z=Math.round(X-j.left),P=Math.round(O-j.top)}if(V)L=Math.sqrt((2*j.width**2+j.height**2)/3),L%2===0&&(L+=1);else{const X=Math.max(Math.abs((w?w.clientWidth:0)-z),z)*2+2,O=Math.max(Math.abs((w?w.clientHeight:0)-P),P)*2+2;L=Math.sqrt(X**2+O**2)}m?.touches?y.current===null&&(y.current=()=>{x({pulsate:A,rippleX:z,rippleY:P,rippleSize:L,cb:C})},g.start(xt,()=>{y.current&&(y.current(),y.current=null)})):x({pulsate:A,rippleX:z,rippleY:P,rippleSize:L,cb:C})},[i,x,g]),N=a.useCallback(()=>{E({},{pulsate:!0})},[E]),W=a.useCallback((m,B)=>{if(g.clear(),m?.type==="touchend"&&y.current){y.current(),y.current=null,g.start(0,()=>{W(m,B)});return}y.current=null,d(C=>C.length>0?C.slice(1):C),p.current=B},[g]);return a.useImperativeHandle(n,()=>({pulsate:N,start:E,stop:W}),[N,E,W]),R.jsx(It,{className:k(M.root,r.root,s),ref:T,...u,children:R.jsx(de,{component:null,exit:!0,children:c})})});function Et(e){return Te("MuiButtonBase",e)}const Bt=ae("MuiButtonBase",["root","disabled","focusVisible"]),wt=e=>{const{disabled:t,focusVisible:n,focusVisibleClassName:o,classes:i}=e,s=Ee({root:["root",t&&"disabled",n&&"focusVisible"]},Et,i);return n&&o&&(s.root+=` ${o}`),s},Pt=Z("button",{name:"MuiButtonBase",slot:"Root"})({display:"inline-flex",alignItems:"center",justifyContent:"center",position:"relative",boxSizing:"border-box",WebkitTapHighlightColor:"transparent",backgroundColor:"transparent",outline:0,border:0,margin:0,borderRadius:0,padding:0,cursor:"pointer",userSelect:"none",verticalAlign:"middle",MozAppearance:"none",WebkitAppearance:"none",textDecoration:"none",color:"inherit","&::-moz-focus-inner":{borderStyle:"none"},[`&.${Bt.disabled}`]:{pointerEvents:"none",cursor:"default"},"@media print":{colorAdjust:"exact"}}),$t=a.forwardRef(function(t,n){const o=le({props:t,name:"MuiButtonBase"}),{action:i,centerRipple:r=!1,children:s,className:u,component:c="button",disabled:d=!1,disableRipple:f=!1,disableTouchRipple:p=!1,focusRipple:h=!1,focusVisibleClassName:g,LinkComponent:y="a",onBlur:T,onClick:x,onContextMenu:E,onDragLeave:N,onFocus:W,onFocusVisible:m,onKeyDown:B,onKeyUp:C,onMouseDown:A,onMouseLeave:V,onMouseUp:H,onTouchEnd:w,onTouchMove:j,onTouchStart:z,tabIndex:P=0,TouchRippleProps:L,touchRippleRef:X,type:O,..._}=o,K=a.useRef(null),b=bt(),Pe=ve(b.ref,X),[F,J]=a.useState(!1);d&&F&&J(!1),a.useImperativeHandle(i,()=>({focusVisible:()=>{J(!0),K.current.focus()}}),[]);const $e=b.shouldMount&&!f&&!d;a.useEffect(()=>{F&&h&&!f&&b.pulsate()},[f,h,F,b]);const Se=$(b,"start",A,p),Ne=$(b,"stop",E,p),je=$(b,"stop",N,p),ze=$(b,"stop",H,p),Le=$(b,"stop",l=>{F&&l.preventDefault(),V&&V(l)},p),Ve=$(b,"start",z,p),Oe=$(b,"stop",w,p),Fe=$(b,"stop",j,p),Ue=$(b,"stop",l=>{Ie(l.target)||J(!1),T&&T(l)},!1),De=ee(l=>{K.current||(K.current=l.currentTarget),Ie(l.target)&&(J(!0),m&&m(l)),W&&W(l)}),ne=()=>{const l=K.current;return c&&c!=="button"&&!(l.tagName==="A"&&l.href)},We=ee(l=>{h&&!l.repeat&&F&&l.key===" "&&b.stop(l,()=>{b.start(l)}),l.target===l.currentTarget&&ne()&&l.key===" "&&l.preventDefault(),B&&B(l),l.target===l.currentTarget&&ne()&&l.key==="Enter"&&!d&&(l.preventDefault(),x&&x(l))}),Ae=ee(l=>{h&&l.key===" "&&F&&!l.defaultPrevented&&b.stop(l,()=>{b.pulsate(l)}),C&&C(l),x&&l.target===l.currentTarget&&ne()&&l.key===" "&&!l.defaultPrevented&&x(l)});let Q=c;Q==="button"&&(_.href||_.to)&&(Q=y);const q={};Q==="button"?(q.type=O===void 0?"button":O,q.disabled=d):(!_.href&&!_.to&&(q.role="button"),d&&(q["aria-disabled"]=d));const Ye=ve(n,K),fe={...o,centerRipple:r,component:c,disabled:d,disableRipple:f,disableTouchRipple:p,focusRipple:h,tabIndex:P,focusVisible:F},He=wt(fe);return R.jsxs(Pt,{as:Q,className:k(He.root,u),ownerState:fe,onBlur:Ue,onClick:x,onContextMenu:Ne,onFocus:De,onKeyDown:We,onKeyUp:Ae,onMouseDown:Se,onMouseLeave:Le,onMouseUp:ze,onDragLeave:je,onTouchEnd:Oe,onTouchMove:Fe,onTouchStart:Ve,ref:Ye,tabIndex:d?-1:P,type:O,...q,..._,children:[s,$e?R.jsx(Tt,{ref:Pe,center:r,...L}):null]})});function $(e,t,n,o=!1){return ee(i=>(n&&n(i),o||e[t](i),!0))}function St(e){return Te("MuiIconButton",e)}const ke=ae("MuiIconButton",["root","disabled","colorInherit","colorPrimary","colorSecondary","colorError","colorInfo","colorSuccess","colorWarning","edgeStart","edgeEnd","sizeSmall","sizeMedium","sizeLarge","loading","loadingIndicator","loadingWrapper"]),Nt=e=>{const{classes:t,disabled:n,color:o,edge:i,size:r,loading:s}=e,u={root:["root",s&&"loading",n&&"disabled",o!=="default"&&`color${Y(o)}`,i&&`edge${Y(i)}`,`size${Y(r)}`],loadingIndicator:["loadingIndicator"],loadingWrapper:["loadingWrapper"]};return Ee(u,St,t)},jt=Z($t,{name:"MuiIconButton",slot:"Root",overridesResolver:(e,t)=>{const{ownerState:n}=e;return[t.root,n.loading&&t.loading,n.color!=="default"&&t[`color${Y(n.color)}`],n.edge&&t[`edge${Y(n.edge)}`],t[`size${Y(n.size)}`]]}})(he(({theme:e})=>({textAlign:"center",flex:"0 0 auto",fontSize:e.typography.pxToRem(24),padding:8,borderRadius:"50%",color:(e.vars||e).palette.action.active,transition:e.transitions.create("background-color",{duration:e.transitions.duration.shortest}),variants:[{props:t=>!t.disableRipple,style:{"--IconButton-hoverBg":e.vars?`rgba(${e.vars.palette.action.activeChannel} / ${e.vars.palette.action.hoverOpacity})`:me(e.palette.action.active,e.palette.action.hoverOpacity),"&:hover":{backgroundColor:"var(--IconButton-hoverBg)","@media (hover: none)":{backgroundColor:"transparent"}}}},{props:{edge:"start"},style:{marginLeft:-12}},{props:{edge:"start",size:"small"},style:{marginLeft:-3}},{props:{edge:"end"},style:{marginRight:-12}},{props:{edge:"end",size:"small"},style:{marginRight:-3}}]})),he(({theme:e})=>({variants:[{props:{color:"inherit"},style:{color:"inherit"}},...Object.entries(e.palette).filter(ye()).map(([t])=>({props:{color:t},style:{color:(e.vars||e).palette[t].main}})),...Object.entries(e.palette).filter(ye()).map(([t])=>({props:{color:t},style:{"--IconButton-hoverBg":e.vars?`rgba(${(e.vars||e).palette[t].mainChannel} / ${e.vars.palette.action.hoverOpacity})`:me((e.vars||e).palette[t].main,e.palette.action.hoverOpacity)}})),{props:{size:"small"},style:{padding:5,fontSize:e.typography.pxToRem(18)}},{props:{size:"large"},style:{padding:12,fontSize:e.typography.pxToRem(28)}}],[`&.${ke.disabled}`]:{backgroundColor:"transparent",color:(e.vars||e).palette.action.disabled},[`&.${ke.loading}`]:{color:"transparent"}}))),zt=Z("span",{name:"MuiIconButton",slot:"LoadingIndicator"})(({theme:e})=>({display:"none",position:"absolute",visibility:"visible",top:"50%",left:"50%",transform:"translate(-50%, -50%)",color:(e.vars||e).palette.action.disabled,variants:[{props:{loading:!0},style:{display:"flex"}}]})),Lt=a.forwardRef(function(t,n){const o=le({props:t,name:"MuiIconButton"}),{edge:i=!1,children:r,className:s,color:u="default",disabled:c=!1,disableFocusRipple:d=!1,size:f="medium",id:p,loading:h=null,loadingIndicator:g,...y}=o,T=it(p),x=g??R.jsx(et,{"aria-labelledby":T,color:"inherit",size:16}),E={...o,edge:i,color:u,disabled:c,disableFocusRipple:d,loading:h,loadingIndicator:x,size:f},N=Nt(E);return R.jsxs(jt,{id:h?T:p,className:k(N.root,s),centerRipple:!0,focusRipple:!d,disabled:c||h,ref:n,...y,ownerState:E,children:[typeof h=="boolean"&&R.jsx("span",{className:N.loadingWrapper,style:{display:"contents"},children:R.jsx(zt,{className:N.loadingIndicator,ownerState:E,children:h&&x})}),r]})}),Vt=Ge(),Ot=e=>v(Ze,{theme:Vt,children:v(Lt,{onClick:e.onClick,style:e.styles??void 0,children:e.children})}),Ft=Be(R.jsx("path",{d:"m12 21.35-1.45-1.32C5.4 15.36 2 12.28 2 8.5 2 5.42 4.42 3 7.5 3c1.74 0 3.41.81 4.5 2.09C13.09 3.81 14.76 3 16.5 3 19.58 3 22 5.42 22 8.5c0 3.78-3.4 6.86-8.55 11.54z"})),Ut=Be(R.jsx("path",{d:"M16.5 3c-1.74 0-3.41.81-4.5 2.09C10.91 3.81 9.24 3 7.5 3 4.42 3 2 5.42 2 8.5c0 3.78 3.4 6.86 8.55 11.54L12 21.35l1.45-1.32C18.6 15.36 22 12.28 22 8.5 22 5.42 19.58 3 16.5 3m-4.4 15.55-.1.1-.1-.1C7.14 14.24 4 11.39 4 8.5 4 6.5 5.5 5 7.5 5c1.54 0 3.04.99 3.57 2.36h1.87C13.46 5.99 14.96 5 16.5 5c2 0 3.5 1.5 3.5 3.5 0 2.89-3.14 5.74-7.9 10.05"}));function Dt(e){return!e||e.length===0?"":`${e[0]?.name}${e.length>1?ge.t("common.professors.over")+(e.length-1)+ge.t("common.professors.people"):""}`}const Wt=se(S)`
    line-height: 1.5;
    width: 100%;
...
`;function Ht({review:e,withWrapper:t=!0,linkToDictionary:n=!0}){const{t:o}=nt(),{status:i}=tt(),r=Ke(),{query:s}=be("GET","/users/written-reviews",{enabled:i==="success"}),{requestFunction:u}=be("PATCH",`/reviews/${e.id}/liked`,{onSuccess:()=>{d(g=>g===null?!e.likedByUser:!g)}}),[c,d]=a.useState(null),f=a.useMemo(()=>s.data?s.data.reviews.map(g=>g.id):[],[s.data]);if(!e)return;const p=g=>{g.stopPropagation(),u({reviewId:e.id,action:c??e.likedByUser?"unlike":"like"})},h=I(Yt,{direction:"column",align:"stretch",gap:3,padding:"3px 4px 0px 4px",clickable:n,onClick:()=>{n&&r(`/dictionary?courseId=${e.courseId}`)},children:[I(U,{direction:"column",gap:8,children:[I(U,{direction:"row",gap:6,children:[v(S,{type:"NormalBold",color:"Text.default",children:e.courseName}),v(S,{type:"Normal",color:"Text.lighter",children:Dt(e.professors)}),I(S,{type:"Normal",color:"Text.lighter",children:[e.year," ",Je(e.semester)]})]}),v(U,{direction:"row",gap:0,style:{overflow:"hidden"},children:v(Wt,{type:"Normal",color:"Text.default",overflow:!t,children:e.content})})]}),I(U,{direction:"row",justify:"space-between",align:"center",gap:0,children:[I(U,{direction:"row",gap:8,children:[I(S,{type:"Normal",color:"Text.lighter",children:[o("common.review.like")," ",e.like]}),I(S,{type:"Normal",color:"Text.lighter",children:[o("common.grade")," ",oe[e.grade]]}),I(S,{type:"Normal",color:"Text.lighter",children:[o("common.load")," ",oe[e.load]]}),I(S,{type:"Normal",color:"Text.lighter",children:[o("common.speech")," ",oe[e.speech]]})]}),!f.includes(e.id)&&I(U,{direction:"row",gap:4,align:"center",children:[v(S,{type:"Normal",color:"Highlight.default",children:o("common.review.like")}),v(Ot,{onClick:g=>p(g),styles:{padding:3},children:v(Qe,{size:18,color:"crimson",onClick:()=>{},children:c??e.likedByUser?v(Ft,{}):v(Ut,{})})})]})]})]});return t?v(At,{clickable:n,children:h}):h}const en=a.memo(Ht);export{Ft as F,Ot as I,en as R,Ut as a,Dt as p};
//# sourceMappingURL=ReviewBlock-BdVl9v12.js.map
