import{j as i}from"./emotion-react-jsx-runtime.browser.esm-E_cGwdOa.js";import{r as f}from"./chunk-JZWAC4HX-9KoC3cCy.js";import{s as t}from"./FlexWrapper-C4koUj4A.js";(function(){try{var o=typeof window<"u"?window:typeof global<"u"?global:typeof globalThis<"u"?globalThis:typeof self<"u"?self:{};o.SENTRY_RELEASE={id:"aa4b834b366ac0b0132f13807ce2ff4bf1de11a2"};var e=new o.Error().stack;e&&(o._sentryDebugIds=o._sentryDebugIds||{},o._sentryDebugIds[e]="7f1ee06c-e9e8-4aa1-b1bd-df82c89b1f56",o._sentryDebugIdIdentifier="sentry-dbid-7f1ee06c-e9e8-4aa1-b1bd-df82c89b1f56")}catch{}})();const n=t.div`
    display: inline-flex;
...
`,x={default:h,disabled:p,selected:b,dark:$,highlighted:k,state5:B},m=t.div`
    ...
    gap: 4px;
    display: inline-flex;
`,w=o=>i(m,{children:o}),y=({type:o="default",$isFlexRow:e=!1,$isFlexColumn:r=!1,children:a=void 0,$paddingLeft:c=24,$paddingTop:s=9,...d})=>{const u=x[o],g=()=>w(a);return i(u,{...d,onClick:o==="disabled"?void 0:d.onClick,$isFlexRow:e??!1,$isFlexColumn:r??!1,$paddingTop:s??9,$paddingLeft:c??24,children:i(g,{})})},C=f.memo(y),l={mobile:720,tablet:960,laptop:1440,desktop:1700,wide:1/0},D=Object.keys(l).reduce((o,e)=>{const r=e;return o[r]=`@media (max-width: ${l[r]}px)`,o},{});export{C as B,l as b,D as m};
//# sourceMappingURL=media-BdZQAMqM.js.map
