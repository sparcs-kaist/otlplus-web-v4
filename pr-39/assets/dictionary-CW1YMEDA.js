import{a as i,y as z,w as V}from"./chunk-UIGDSWPH-NakEPbl8.js";import{n as r,a as o,j as a,F as c,u as L,b as k}from"./FlexWrapper-C0dsngQo.js";import{M as Z}from"./Modal-BmERvnJ2.js";import{W as J}from"./Widget-D7VP5HFl.js";import{m as Q,C as X}from"./proxy-CoplPWYs.js";import{e as F,j as P,I,u as E,D as $,g as B}from"./useIsDevice--kk7j9LI.js";import{R as Y,C as _,S as ee}from"./ReviewWritingBlock-BGFRgZ5l.js";import{L as O}from"./LoadingCircle-BvHCQln8.js";import{T as p}from"./Typography-DTsae4U-.js";import{j as A}from"./jsx-runtime-u17CrQMm.js";import{u as S,b as oe}from"./weekdayEnum-SNVXd-6_.js";import{p as te,R as re}from"./ReviewBlock-BXTgSwlx.js";import{c as H,S as ne}from"./checkEmpty-DhhQCEa3.js";import{T as ie}from"./Trans-BWb067g3.js";import"./index-CSYM8SEM.js";import"./TextInputArea-CFHeswcS.js";import"./useUserStore-Cs3WP2WQ.js";const G=F(A.jsx("path",{d:"M12 2C6.47 2 2 6.47 2 12s4.47 10 10 10 10-4.47 10-10S17.53 2 12 2"})),le=F(A.jsx("path",{d:"M7.41 8.59 12 13.17l4.59-4.58L18 10l-6 6-6-6z"})),U=r.div`
    width: 150px;
    height: 28px;
    display: inline-flex;
    padding: 8px 16px;
...
`,Le=r(c)`
    flex: 1 0 0;
`,R=100,Ie=({selectedCourseId:e,selectedProfessorId:n,writableReviewProps:s,ref:h})=>{const{t}=S(),[l,f]=i.useState(null),[x,y]=i.useState("all"),[g,b]=i.useState(!1),{query:d,setParams:v}=E("GET","/reviews",{enabled:g,gcTime:0}),w=()=>{g&&(d.isLoading||v(u=>({...u,offset:u.offset+R})))};return i.useImperativeHandle(h,()=>({loadMoreReviews:w,isLoading:d.isLoading})),i.useEffect(()=>{v({mode:"default",courseId:e||void 0,professorId:n||void 0,limit:R,offset:0})},[]),i.useEffect(()=>{f(null),v(u=>({...u??{},...e!==null?{courseId:e}:{},...n!==null?{professorId:n}:{},offset:0})),b(e!==null)},[n,e]),i.useEffect(()=>{d.data!==void 0&&(f(u=>u==null?d.data:{averageGrade:d.data.averageGrade,averageLoad:d.data.averageLoad,averageSpeech:d.data.averageSpeech,myReviewId:[],reviews:[...u.reviews,...d.data.reviews]}),d.data.reviews.length<R&&b(!1))},[d.data]),a(k,{children:[o(p,{type:"NormalBold",color:"Text.default",children:t("dictionary.review")}),a(c,{direction:"column",gap:6,children:[o(p,{type:"NormalBold",color:"Text.default",children:t("dictionary.reviewLanguage")}),o(c,{direction:"row",gap:6,children:["all","english"].map(u=>o(Se,{selected:x==u,chipText:t(`dictionary.reviewLanguageOptions.${u}`),onClick:()=>y(u)},u))})]}),l===null&&d.isLoading?o(O,{}):a(k,{children:[o(c,{direction:"row",gap:0,justify:"center",align:"center",style:{width:"100%"},children:o(Be,{direction:"row",gap:0,justify:"space-between",align:"center",children:[[$(l?.averageGrade,l?.reviews.length),t("common.grade")],[$(l?.averageLoad,l?.reviews.length),t("common.load")],[$(l?.averageSpeech,l?.reviews.length),t("common.speech")]].map(([u,m],C)=>a(Le,{direction:"column",gap:0,align:"center",children:[o(p,{type:"Bigger",color:"Text.default",children:u}),o(p,{type:"Smaller",color:"Text.default",children:m})]},C))})}),ve.reviews.length>0&&s.map(u=>o(Y,{...u})),l?.reviews.map(u=>x==="english"&&!/^[A-Za-z0-9\s\p{P}\p{S}]+$/u.test(u.content)?null:o(re,{review:u,linkToDictionary:!1},u.id))]})]})},$e=r(c)`
    width: 100%;
    height: 100%;
    overflow-y: auto;
...
`,so=V(function(){const n=P("tablet"),[s]=z(),[h,t]=i.useState(!1),[l,f]=i.useState(null);i.useEffect(()=>{const y=s.get("courseId");if(y){const g=parseInt(y,10);isNaN(g)?f(null):f(g)}},[]),i.useEffect(()=>{n?l!==null&&t(!0):t(!1)},[n]),i.useEffect(()=>{n&&l!==null&&t(!0)},[l]);const x=i.useCallback(()=>{t(!1),f(null)},[]);return a(Ge,{direction:"row",align:"stretch",justify:"center",gap:12,children:[o(Ue,{direction:"column",align:"stretch",gap:0,borderRadius:12,children:o(Ae,{selectedCourseId:l,setSelectedCourseId:f})}),o(qe,{direction:"column",align:"stretch",gap:0,borderRadius:12,children:o(M,{selectedCourseId:l})}),n&&o(Z,{isOpen:h,onClose:x,header:!1,fullScreen:!0,children:o(M,{selectedCourseId:l,isMobileModal:!0,onMobileModalClose:x})})]})});export{so as default};
