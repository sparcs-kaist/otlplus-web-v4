...
`;function R({review:e,withWrapper:d=!0,linkToDictionary:i=!0}){const{t:n}=w(),x=B(),{requestFunction:f}=C("PATCH",`/reviews/${e.id}/liked`,{onSuccess:()=>{y(l=>l===null?!e.likedByUser:!l)}}),[m,y]=h.useState(null);if(!e)return;const b=l=>{l.stopPropagation(),f({reviewId:e.id,action:m??e.likedByUser?"unlike":"like"})},u=o(F,{direction:"column",align:"stretch",gap:8,padding:"0 4px",clickable:i,onClick:()=>{i&&x(`/dictionary?courseId=${e.courseId}`)},children:[o(c,{direction:"row",gap:6,children:[r(t,{type:"NormalBold",color:"Text.default",children:e.courseName}),r(t,{type:"Normal",color:"Text.lighter",children:j(e.professors)}),o(t,{type:"Normal",color:"Text.lighter",children:[e.year," ",N(e.semester)]})]}),r(c,{direction:"row",gap:0,style:{overflow:"hidden"},children:r(I,{type:"Normal",color:"Text.default",overflow:!d,children:e.content})}),o(c,{direction:"row",justify:"space-between",gap:0,children:[o(c,{direction:"row",gap:8,children:[o(t,{type:"Normal",color:"Text.lighter",children:[n("common.review.like")," ",e.like]}),o(t,{type:"Normal",color:"Text.lighter",children:[n("common.grade")," ",a[e.grade]]}),o(t,{type:"Normal",color:"Text.lighter",children:[n("common.load")," ",a[e.load]]}),o(t,{type:"Normal",color:"Text.lighter",children:[n("common.speech")," ",a[e.speech]]})]}),o(c,{direction:"row",gap:4,onClick:l=>b(l),children:[r(t,{type:"Normal",color:"Highlight.default",children:n("common.review.like")}),r(T,{size:18,color:"crimson",children:m??e.likedByUser?r($,{}):r(v,{})})]})]})]});return d?r(S,{clickable:i,children:u}):u}const A=h.memo(R);export{$ as F,A as R,v as a,j as p};
