import{n as l,F as d,a as t}from"./FlexWrapper-C0dsngQo.js";import{x as n,V as h}from"./useIsDevice--kk7j9LI.js";import{a as x}from"./chunk-UIGDSWPH-NakEPbl8.js";import{T as b}from"./Typography-DTsae4U-.js";const y=o=>n`
...
`,W=({placeholder:o,errorMessage:r="",area:a=!1,disabled:e=!1,value:s="",handleChange:p=()=>{},setErrorStatus:c=()=>{},...u})=>{const g=i=>{const f=i.target.value;p(f)};return x.useEffect(()=>{c&&c(!!r)},[r,c]),t(d,{direction:"column",gap:0,align:"stretch",justify:"stretch",flex:"1",children:t(j,{as:a?"textarea":"input",placeholder:o,hasError:!!r,area:a,disabled:e,value:s,onChange:g,...u})})};export{V as G,W as T};
