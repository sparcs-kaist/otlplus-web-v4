...
`,ee=l.img`
    height: 40px;
    background: transparent;
`;function te(){const{t:o}=O(),c=F();return e(Z,{direction:"column",align:"stretch",gap:0,padding:"8px 8px",children:e(V,{options:["type","department","level","term"],onSearch:S=>{if(W(S)){alert(o("common.search.empty"));return}const u=new URLSearchParams;Object.entries(S).forEach(([k,a])=>{Array.isArray(a)?a.forEach(s=>{u.append(k,s.toString())}):a!=null&&a!==""&&u.append(k,a.toString())}),c(`/dictionary?${u.toString()}`)},SearchIcon:e(ee,{src:"/otlplus-web-v4/pr-40/searchIcon.png",alt:"search"})})})}const re=t.lazy(()=>y(()=>import("./index-CX0Yjh9o.js"),__vite__mapDeps([0,1,2,3,4,5,6,7,8]))),ne=t.lazy(()=>y(()=>import("./index-BTAXNBDY.js"),__vite__mapDeps([9,1,2,3,4,5,6,7,8]))),ie=t.lazy(()=>y(()=>import("./index-KlZE8ojV.js"),__vite__mapDeps([10,1,2,3,5,0,4,6,7,8,9,11]))),oe=t.lazy(()=>y(()=>import("./index-DhWPle7H.js"),__vite__mapDeps([11,1,2,3,4,5,6,7,8]))),A=t.lazy(()=>y(()=>import("./index-CtlYFMnk.js"),__vite__mapDeps([12,1,2,3,5,13,6,7,8]))),P=t.lazy(()=>y(()=>import("./index-C05IucWY.js"),__vite__mapDeps([14,1,2,3,15,6,5,7]))),I=t.lazy(()=>y(()=>import("./index-DUuS1aj4.js"),__vite__mapDeps([16,1,2,3,5,6,7,8]))),j=t.lazy(()=>y(()=>import("./index-DhuRzrZD.js"),__vite__mapDeps([17,1,2,3,5,6,18,7,8]))),ce=l(r)`
    margin-top: 60px;
`,ae=l(r)`
    max-width: 1298px;
    flex: 1 1 auto;
