import{j as i,a as T,u as Q,c as ne,g as Y,s as G,i as oe}from"./emotion-react-jsx-runtime.browser.esm-EwT5rpm-.js";import{p as J,r as g}from"./chunk-EPOLDU6W-e0R_ew34.js";import{n as v,F as E}from"./FlexWrapper-BEyb95p7.js";import{T as $}from"./Typography-BjDgUgBC.js";import{e as U,I as A,w as re,j as P,u as ie}from"./useIsDevice-Fh2KZYkF.js";import{u as k}from"./useTranslation-BkGIVc6H.js";import{C as ce,S as ae,m as se,A as le}from"./proxy-CEIbaCR3.js";import{B as L}from"./media-DkmiTHQm.js";(function(){try{var e=typeof window<"u"?window:typeof global<"u"?global:typeof globalThis<"u"?globalThis:typeof self<"u"?self:{};e.SENTRY_RELEASE={id:"ea3551b4879ab70a0689ce7c6da38d6820122aff"}}catch{}})();try{(function(){var e=typeof window<"u"?window:typeof global<"u"?global:typeof globalThis<"u"?globalThis:typeof self<"u"?self:{},n=new e.Error().stack;n&&(e._sentryDebugIds=e._sentryDebugIds||{},e._sentryDebugIds[n]="5879e0b2-a235-432e-af28-c95bc3a02011",e._sentryDebugIdIdentifier="sentry-dbid-5879e0b2-a235-432e-af28-c95bc3a02011")})()}catch{}const me=U(J.jsx("path",{d:"M19 13h-6v6h-2v-6H5v-2h6V5h2v6h6z"})),de=U(J.jsx("path",{d:"M9 16.17 4.83 12l-1.42 1.41L9 19 21 7l-1.41-1.41z"})),X=v.div`
    display: inline-flex;
    padding: 8px;
...
`;function xe({timeFilter:e,setTimeFilter:n}){const{t}=k(),c=Q();return i(E,{direction:"column",gap:0,style:{width:"100%"},children:i(Ee,{direction:"row",gap:0,children:e?T(E,{direction:"row",justify:"space-between",gap:10,align:"center",children:[i($,{color:"Text.default",type:"Normal",children:`${Ce(e)}`}),i(A,{size:15,onClick:()=>{n&&n(null)},color:c.colors.Text.default,children:i(ce,{})})]}):i(we,{color:"Text.light",type:"Normal",children:t("common.search.timeFilterPlaceholder")})})})}function F(e,n){return n in e}const Te={type:ge,department:ye,level:be,term:ve},Z=Object.fromEntries(Object.entries(Te).map(([e,n])=>[e,n()])),Ie=["term"],$e=new Set(Ie);function x(e){return $e.has(e)}const N=Z,Be=v(E)`
    flex: 1 1 auto;
    overflow: auto;
...
`;function Oe({options:e,onChange:n,timeFilter:t,setTimeFilter:c,resetTrigger:h,onResetTriggerComplete:d}){const{t:p}=k(),f=new Set(e);function m(o){return f.has(o)}const[a,s]=g.useState(B),[S,I]=g.useState({});function B(){const o={};return e.filter(r=>r in N).forEach(r=>{const l=N[r].length;x(r)?o[r]=null:o[r]=Array(l).fill(!1)}),o}function R(o){const r={};return Object.keys(o).forEach(l=>{const C=Z[l];x(l)?o[l]==null?r[l]=null:r[l]=C[o[l]]:r[l]=o[l].map((u,y)=>u?C[y]:null).filter(u=>u!=null)}),r}function O(o){const r={};for(const l in o){const C=o[l];C!=null&&(F(a,l)?x(l)?a[l]==null?delete r[l]:r[l]=C:!a[l].includes(!0)?delete r[l]:r[l]=C:l=="time"&&(r[l]=C))}return r}function D(o,r){s(l=>{if(x(r))return{...l,[r]:o};{const u=l[r].map((y,b)=>b===o?!y:y);return{...l,[r]:u}}})}function H(o){x(o)?s(r=>({...r,[o]:null})):s(r=>({...r,[o]:r[o].map(()=>!1)}))}function M(o,r){return x(r)?o[r]==null:!o[r].includes(!0)}return g.useEffect(()=>{const o=R(a),r={time:t};I(m("time")?{...o,...r}:o)},[a,t]),g.useEffect(()=>{const o=O(S);n(o)},[S]),g.useEffect(()=>{h&&(s(B()),m("time")&&c&&c(null),d())},[h]),i(Be,{direction:"column",align:"stretch",gap:12,children:e.map(o=>T(E,{direction:"column",gap:6,flex:"1 1 auto",children:[i($,{type:"NormalBold",color:"Text.default",children:p(`common.search.${o}`)}),i(E,{direction:"column",gap:0,style:{width:"100%"},children:(()=>{if(F(a,o)&&o in a)return i(Se,{nameList:N[o].map(r=>r[1]),chosenList:a[o],handleOptionClick:r=>{D(r,o)},handleSelectAllClick:()=>{H(o)},isSingleSelect:x(o),selectedAll:M(a,o)});if(o=="time")return i(xe,{timeFilter:t,setTimeFilter:c})})()})]},o))})}function V(e,n){if(e.inserted[n.name]===void 0)return e.insert("",n,e.sheet,!0)}function K(e,n,t){var c=[],h=Y(e,c,t);return c.length<2?t:h+n(c)}var je=function(n){var t=ne(n);t.sheet.speedy=function(f){this.isSpeedy=f},t.compat=!0;var c=function(){for(var m=arguments.length,a=new Array(m),s=0;s<m;s++)a[s]=arguments[s];var S=G(a,t.registered,void 0);return oe(t,S,!1),t.key+"-"+S.name},h=function(){for(var m=arguments.length,a=new Array(m),s=0;s<m;s++)a[s]=arguments[s];var S=G(a,t.registered),I="animation-"+S.name;return V(t,{name:S.name,styles:"@keyframes "+I+"{"+S.styles+"}"}),I},d=function(){for(var m=arguments.length,a=new Array(m),s=0;s<m;s++)a[s]=arguments[s];var S=G(a,t.registered);V(t,S)},p=function(){for(var m=arguments.length,a=new Array(m),s=0;s<m;s++)a[s]=arguments[s];return K(t.registered,c,Ae(a))};return{css:c,cx:p,injectGlobal:d,keyframes:h,hydrate:function(m){m.forEach(function(a){t.inserted[a]=!0})},flush:function(){t.registered={},t.inserted={},t.sheet.flush()},sheet:t.sheet,cache:t,getRegisteredStyles:Y.bind(null,t.registered),merge:K.bind(null,t.registered,c)}},Ae=function e(n){for(var t="",c=0;c<n.length;c++){var h=n[c];if(h!=null){var d=void 0;switch(typeof h){case"boolean":break;case"object":{if(Array.isArray(h))d=e(h);else{d="";for(var p in h)h[p]&&p&&(d&&(d+=" "),d+=p)}break}default:d=h}d&&(t&&(t+=" "),t+=d)}}return t},ke=je({key:"css"}),_=ke.css;const Re=_`
    border-color: red;
`,De=_`
