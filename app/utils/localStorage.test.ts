...
describe('localStorage utilities', () => {
  ...
  describe('subscribeLocalStorageSet', () => {
    it('adds event listener to window', () => {
      ...
      expect(addEventListenerSpy).toHaveBeenCalledWith('local-storage-set', callback)
    })
  })
  ...
  describe('unsubscribeLocalStorageSet', () => {
    it('removes event listener from window', () => {
      ...
      expect(removeEventListenerSpy).toHaveBeenCalledWith('local-storage-set', callback)
    })
  })
})
