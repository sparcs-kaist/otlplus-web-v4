    ...
    fields: [
      ...
      },
      {
        ...
        members: [
          ...
          { name: "박현우", nickname: "namu", hover: "리디자인 난이도 무엇;;" },
          { name: "권혁태", nickname: "larry", hover: "서버 리드 2023-03 ~ 2025.12" },
          ...
          { name: "박승범", nickname: "killerwhale", hover: "커스텀 블록 남기고 갑니다" },
          { name: "방승현", nickname: "cyber", hover: "띠링띠링 알림 나갑니다" },
          { name: "이동엽", nickname: "doxylee", hover: "학사 DB 동기화 500배 빠르게 만든 사람" },
          { name: "김현민", nickname: "scotch", hover: "21의라스트댄스" },
        ],
      },
    ],
  },
