    ...
    },
    {
        ...
        fields: [
            ...
            },
            {
                ...
                members: [
                    { name: "김희진", nickname: "gimme", hover: "" },
                    { name: "서인성", nickname: "cheese", hover: "" },
                ],
            },
            {
                role: "Developer",
                members: [
                    ...
                    { name: "강재환", nickname: "yaong", hover: "" },
                    { name: "박현우", nickname: "namu", hover: "리디자인 난이도 무엇;;" },
                    { name: "권혁태", nickname: "larry", hover: "" },
                    { name: "권혁원", nickname: "gb", hover: "" },
                    { name: "박종석", nickname: "jk", hover: "" },
                    { name: "배지훈", nickname: "badge", hover: "" },
                    { name: "박진웅", nickname: "jin", hover: "" },
                    { name: "박성빈", nickname: "ellen", hover: "" },
                    { name: "김지혁", nickname: "kevin", hover: "" },
                    { name: "박승범", nickname: "killerwhale", hover: "" },
                ],
            },
        ],
    },
