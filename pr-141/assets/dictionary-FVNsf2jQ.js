import{p as G,r as l,z as P,w as X}from"./chunk-JZWAC4HX-CLeHbtfV.js";import{j as t,a as i,u as N,F as C}from"./emotion-react-jsx-runtime.browser.esm-BHq_ahXg.js";import{s as r,F as c}from"./FlexWrapper-BaRQ9_z5.js";import{M as ee}from"./Modal-DYvfQvSb.js";import{W as te}from"./Widget-DuklSO3h.js";import{m as oe,C as re}from"./proxy-FxSjA3yC.js";import{u as V,b as q,C as ne,S as ie}from"./Credits-CfC2T8jw.js";import{L as T}from"./LoadingCircle-BTVAxPR0.js";import{R as ce}from"./ReviewWritingBlock-C1XxdnlA.js";import{e as K,g as W,I as $,k as le,v as L,w as ae,u as se}from"./useIsDevice-CH8UuJaQ.js";import{T as d}from"./Typography-Cc3HTqZr.js";import{I as de}from"./IconButton-BMUwbcrd.js";import{p as pe,R as ue}from"./ReviewBlock-DYbfw7gG.js";import{u as I}from"./useTranslation-C0_9qbUS.js";import{c as A,S as he}from"./checkEmpty-D_8R5ChP.js";import{t as H}from"./index-CawYci2H.js";import{T as z}from"./Trans-NyxbdgPJ.js";import{m as B}from"./media-CDT3hhFM.js";import"./index-BPagBQyW.js";import"./infiniteQueryBehavior-BLhbK-l8.js";import"./TextInputArea-C1ajc-DA.js";import"./useUserStore-BBmeOOnh.js";import"./env-DhyNnyJp.js";(function(){try{var e=typeof window<"u"?window:typeof global<"u"?global:typeof globalThis<"u"?globalThis:typeof self<"u"?self:{};e.SENTRY_RELEASE={id:"64a7705f3d8c179725f129fd34e40fa2dc97f053"};var o=new e.Error().stack;o&&(e._sentryDebugIds=e._sentryDebugIds||{},e._sentryDebugIds[o]="f9b9c746-a4e9-443b-a0aa-5de91f5bae5a",e._sentryDebugIdIdentifier="sentry-dbid-f9b9c746-a4e9-443b-a0aa-5de91f5bae5a")}catch{}})();const U=K(G.jsx("path",{d:"M12 2C6.47 2 2 6.47 2 12s4.47 10 10 10 10-4.47 10-10S17.53 2 12 2"})),fe=K(G.jsx("path",{d:"M7.41 8.59 12 13.17l4.59-4.58L18 10l-6 6-6-6z"})),Y=r.div`
    min-width: 150px;
    height: 28px;
    display: inline-flex;
    padding: 8px 16px;
...
`,xe=r.div`
    ...
    align-items: center;
    justify-content: flex-start;
`,ye=({selected:e=!1,chipIndex:o="",chipText:a="",...s})=>t(e?me:ge,{...s,children:t(()=>i(xe,{children:[t(d,{type:"NormalBold",children:o}),t(d,{type:"Normal",children:a})]}),{})}),we=r(oe.div)`
    width: 100%;
    overflow-x: auto;
    overflow-y: hidden;
    white-space: nowrap;
...
`,Ie=r(d)`
    white-space: nowrap;
`,Ne=({courseDetail:e})=>{const{t:o}=I();return i(C,{children:[t(Se,{direction:"column",gap:8,children:[[o("common.class"),e?.department.name+", "+e?.type],[o("common.description"),e?.summary]].map(([a,s],f)=>i(c,{direction:"row",gap:6,children:[t(Ie,{type:"NormalBold",color:"Text.default",children:a}),t(d,{type:"Normal",color:"Text.default",children:s})]},f))}),t(Te,{direction:"row",gap:0,justify:"space-around",align:"center",children:[[e?.classDuration,o("common.numClasses")],[e?.expDuration,o("common.numLabs")],e?.creditAU?[e?.creditAU,"AU"]:[e?.credit,o("common.credit")]].map(([a,s],f)=>i(Be,{direction:"column",gap:0,align:"center",children:[t(d,{type:"Bigger",color:"Text.default",children:a}),t(d,{type:"Smaller",color:"Text.default",children:s})]},f))})]})},Z=r.div`
    width: 58px;
    height: 28px;
    display: inline-flex;
    padding: 8px;
...
`,Le=r.div`
    ...
    justify-content: center;
    align-items: center;
`,je=({selected:e=!1,chipText:o="",...a})=>t(e?Ee:$e,{...a,children:t(()=>t(Le,{children:o}),{})}),Re=r(c)`
    width: 300px;
    padding: 10px;
`,Pe=r(c)`
    flex: 1 0 0;
`,We=20,He=({selectedCourseId:e,selectedProfessorId:o,writableReviewProps:a})=>{const{t:s}=I(),[f,y]=l.useState("all"),[n,g]=l.useState(!1),{query:m,setParams:x,data:u}=V("GET","/reviews",{infinites:["reviews"],limit:We,enabled:n}),{ref:h,inView:w}=q();return l.useEffect(()=>{x({mode:"default",courseId:e||void 0,professorId:o||void 0})},[]),l.useEffect(()=>{x(p=>{const k=p??{};return o===null&&delete k.professorId,{...k,...e!==null?{courseId:e}:{},...o!==null?{professorId:o}:{}}}),g(e!==null)},[o,e]),l.useEffect(()=>{w&&m.hasNextPage&&!m.isFetchingNextPage&&m.fetchNextPage()},[w]),i(C,{children:[t(d,{type:"NormalBold",color:"Text.default",children:s("dictionary.review")}),i(c,{direction:"column",gap:6,children:[t(d,{type:"NormalBold",color:"Text.default",children:s("dictionary.reviewLanguage")}),t(c,{direction:"row",gap:6,children:["all","english"].map(p=>t(je,{selected:f==p,chipText:s(`dictionary.reviewLanguageOptions.${p}`),onClick:()=>y(p)},p))})]}),u===null&&m.isLoading?t(T,{}):i(C,{children:[t(c,{direction:"row",gap:0,justify:"center",align:"center",style:{width:"100%"},children:t(Re,{direction:"row",gap:0,justify:"space-between",align:"center",children:[[L(u?.averageGrade,u?.reviews.length),s("common.grade")],[L(u?.averageLoad,u?.reviews.length),s("common.load")],[L(u?.averageSpeech,u?.reviews.length),s("common.speech")]].map(([p,k],v)=>i(Pe,{direction:"column",gap:0,align:"center",children:[t(d,{type:"Bigger",color:"Text.default",children:p}),t(d,{type:"Smaller",color:"Text.default",children:k})]},v))})}),a.map((p,k)=>ae(ce,{...p,key:k})),u?.reviews.map(p=>f==="english"&&!/^[A-Za-z0-9\s\p{P}\p{S}]+$/u.test(p.content)?null:t(ue,{review:p,linkToDictionary:!1},p.id)),m.hasNextPage&&t(T,{ref:h})]})]})},Me=r(c)`
    width: 100%;
    height: 100%;
    overflow-y: auto;
...
`,R=r(d)`
    white-space: nowrap;
`,Oe=({course:e,isSelected:o,selectCourseId:a})=>{const{t:s}=I(),f=N(),y=l.useCallback(()=>{o?a(null):(a(e.id),H("Select Course",{courseId:e.id,courseCode:e.code,courseName:e.name,department:e.department.name}))},[o,e.id,a]);return i(Ae,{onClick:y,selected:o,children:[i(c,{direction:"row",gap:0,justify:"space-between",align:"center",children:[i(c,{direction:"row",gap:6,align:"center",children:[t($,{size:12,color:e.open?f.colors.Highlight.default:f.colors.Text.disable,children:t(U,{})}),t(d,{type:"NormalBold",color:"Text.default",children:e.name}),t(d,{type:"Normal",color:"Text.placeholder",children:e.code})]}),e.completed&&t(d,{type:"Normal",color:"Text.lighter",children:s("common.completedCourse")})]}),t(ze,{}),i(c,{direction:"column",gap:4,children:[i(c,{direction:"row",gap:6,children:[t(R,{type:"NormalBold",color:"Text.default",children:s("common.class")}),i(d,{type:"Normal",color:"Text.default",children:[e.department.name,", ",e.type]})]}),i(c,{direction:"row",gap:6,children:[t(R,{type:"NormalBold",color:"Text.default",children:s("common.professor")}),t(d,{type:"Normal",color:"Text.default",children:e.professors.map(n=>n.name).join(", ")})]}),i(c,{direction:"row",gap:6,children:[t(R,{type:"NormalBold",color:"Text.default",children:s("common.description")}),t(d,{type:"Normal",color:"Text.default",children:e.summary})]})]})]})},Fe=l.memo(Oe),_e=r(c)`
    width: 100%;
    height: 100%;
    overflow: hidden;
`,Ge=r.div`
