import{j as d}from"./emotion-react-jsx-runtime.browser.esm-DKFWqk_f.js";import{r as f}from"./chunk-JZWAC4HX-7McQ17nL.js";import{s as t}from"./FlexWrapper-VbUniZHB.js";(function(){try{var o=typeof window<"u"?window:typeof global<"u"?global:typeof globalThis<"u"?globalThis:typeof self<"u"?self:{};o.SENTRY_RELEASE={id:"987424ef7db70c8bde41be03a352efdebe5f59e5"};var e=new o.Error().stack;e&&(o._sentryDebugIds=o._sentryDebugIds||{},o._sentryDebugIds[e]="7f1ee06c-e9e8-4aa1-b1bd-df82c89b1f56",o._sentryDebugIdIdentifier="sentry-dbid-7f1ee06c-e9e8-4aa1-b1bd-df82c89b1f56")}catch{}})();const n=t.div`
    display: inline-flex;
...
`,x={default:h,disabled:p,selected:b,dark:$,highlighted:k,state5:B},m=t.div`
    ...
    gap: 4px;
    display: inline-flex;
`,w=o=>d(m,{children:o}),y=({type:o="default",$isFlexRow:e=!1,$isFlexColumn:r=!1,children:s=void 0,$paddingLeft:c=24,$paddingTop:a=9,...i})=>{const u=x[o],g=()=>w(s);return d(u,{...i,onClick:o==="disabled"?void 0:i.onClick,$isFlexRow:e??!1,$isFlexColumn:r??!1,$paddingTop:a??9,$paddingLeft:c??24,children:d(g,{})})},C=f.memo(y),l={mobile:720,tablet:960,laptop:1440,desktop:1700,wide:1/0},D=Object.keys(l).reduce((o,e)=>{const r=e;return o[r]=`@media (max-width: ${l[r]}px)`,o},{});export{C as B,l as b,D as m};
//# sourceMappingURL=media-7QtoqW1P.js.map
