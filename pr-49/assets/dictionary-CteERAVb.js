import{a as c,y as z,w as Z}from"./chunk-UIGDSWPH-NakEPbl8.js";import{n as o,a as t,j as i,F as l,u as N,b as v}from"./FlexWrapper-C0dsngQo.js";import{M as Q}from"./Modal-BcmDXy7B.js";import{W as X}from"./Widget-D7VP5HFl.js";import{m as Y,C as _}from"./proxy-B7tUA8SG.js";import{e as O,u as S,t as D,l as $,E as ee,H as j,J as te,k as oe,j as B}from"./useIsDevice-C631H4qQ.js";import{u as F,b as G,C as re,S as ne}from"./Credits-DW_HHBnc.js";import{L as T}from"./LoadingCircle-DkwLqjX6.js";import{R as ie}from"./ReviewWritingBlock-CrXMp7my.js";import{T as d}from"./Typography-DTsae4U-.js";import{j as q}from"./jsx-runtime-u17CrQMm.js";import{p as ce,R as le}from"./ReviewBlock-8HFfz5bc.js";import{c as W,S as ae}from"./checkEmpty-DBupciBn.js";import{T as se}from"./Trans-CBufIDZY.js";import"./index-CSYM8SEM.js";import"./infiniteQueryBehavior-D0ONO_ff.js";import"./TextInputArea-nLt5tMHA.js";import"./useUserStore-mDIW_ILF.js";const U=O(q.jsx("path",{d:"M12 2C6.47 2 2 6.47 2 12s4.47 10 10 10 10-4.47 10-10S17.53 2 12 2"})),de=O(q.jsx("path",{d:"M7.41 8.59 12 13.17l4.59-4.58L18 10l-6 6-6-6z"})),V=o.div`
    width: 150px;
    height: 28px;
    display: inline-flex;
    padding: 8px 16px;
...
`,gt=Z(function(){const r=D("tablet"),[a]=z(),[s,n]=c.useState(!1),[p,f]=c.useState(null);c.useEffect(()=>{const m=a.get("courseId");if(m){const h=parseInt(m,10);isNaN(h)?f(null):f(h)}},[]),c.useEffect(()=>{r?p!==null&&n(!0):n(!1)},[r]),c.useEffect(()=>{r&&p!==null&&n(!0)},[p]);const y=c.useCallback(()=>{n(!1),f(null)},[]);return i(Ke,{direction:"row",align:"stretch",justify:"center",gap:12,children:[t(Je,{direction:"column",align:"stretch",gap:0,borderRadius:12,children:t(Ve,{selectedCourseId:p,setSelectedCourseId:f})}),t(Ze,{direction:"column",align:"stretch",gap:0,borderRadius:12,children:t(A,{selectedCourseId:p})}),r&&t(Q,{isOpen:s,onClose:y,header:!1,fullScreen:!0,children:t(A,{selectedCourseId:p,isMobileModal:!0,onMobileModalClose:y})})]})});export{gt as default};
