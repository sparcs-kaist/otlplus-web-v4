import{j as i}from"./emotion-react-jsx-runtime.browser.esm-BJ8pBGCa.js";import{r as f}from"./chunk-JZWAC4HX-DoXHMsGd.js";import{s as t}from"./FlexWrapper-BfffTCrz.js";(function(){try{var o=typeof window<"u"?window:typeof global<"u"?global:typeof globalThis<"u"?globalThis:typeof self<"u"?self:{};o.SENTRY_RELEASE={id:"bceeb3a7016bc57a84c0b8e0829cc0881af327bc"};var e=new o.Error().stack;e&&(o._sentryDebugIds=o._sentryDebugIds||{},o._sentryDebugIds[e]="7f1ee06c-e9e8-4aa1-b1bd-df82c89b1f56",o._sentryDebugIdIdentifier="sentry-dbid-7f1ee06c-e9e8-4aa1-b1bd-df82c89b1f56")}catch{}})();const n=t.div`
    display: inline-flex;
...
`,x={default:h,disabled:p,selected:b,dark:$,highlighted:k,state5:B},m=t.div`
    ...
    gap: 4px;
    display: inline-flex;
`,w=o=>i(m,{children:o}),y=({type:o="default",$isFlexRow:e=!1,$isFlexColumn:r=!1,children:l=void 0,$paddingLeft:s=24,$paddingTop:a=9,...d})=>{const u=x[o],g=()=>w(l);return i(u,{...d,onClick:o==="disabled"?void 0:d.onClick,$isFlexRow:e??!1,$isFlexColumn:r??!1,$paddingTop:a??9,$paddingLeft:s??24,children:i(g,{})})},C=f.memo(y),c={mobile:720,tablet:960,laptop:1440,desktop:1700,wide:1/0},D=Object.keys(c).reduce((o,e)=>{const r=e;return o[r]=`@media (max-width: ${c[r]}px)`,o},{});export{C as B,c as b,D as m};
//# sourceMappingURL=media-b0b7b4QL.js.map
