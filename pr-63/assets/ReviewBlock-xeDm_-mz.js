...
`,Ht=ne(U)`
    cursor: pointer;
`;function Xt({review:e,withWrapper:t=!0,linkToDictionary:n=!0}){const{t:o}=nt(),{status:i}=tt(),r=Ke(),{query:s}=be("GET","/users/written-reviews",{enabled:i==="success"}),{requestFunction:u}=be("PATCH",`/reviews/${e.id}/liked`,{onSuccess:()=>{d(g=>g===null?!e.likedByUser:!g)}}),[c,d]=a.useState(null),f=a.useMemo(()=>s.data?s.data.reviews.map(g=>g.id):[],[s.data]);if(!e)return;const p=g=>{g.stopPropagation(),u({reviewId:e.id,action:c??e.likedByUser?"unlike":"like"})},h=I(Yt,{direction:"column",align:"stretch",gap:3,padding:"3px 4px 0px 4px",clickable:n,onClick:()=>{n&&r(`/dictionary?courseId=${e.courseId}`)},children:[I(U,{direction:"column",gap:8,children:[I(U,{direction:"row",gap:6,children:[v(S,{type:"NormalBold",color:"Text.default",children:e.courseName}),v(S,{type:"Normal",color:"Text.lighter",children:Dt(e.professors)}),I(S,{type:"Normal",color:"Text.lighter",children:[e.year," ",Je(e.semester)]})]}),v(U,{direction:"row",gap:0,style:{overflow:"hidden"},children:v(Wt,{type:"Normal",color:"Text.default",overflow:!t,children:e.content})})]}),I(U,{direction:"row",justify:"space-between",align:"center",gap:0,children:[I(U,{direction:"row",gap:8,children:[I(S,{type:"Normal",color:"Text.lighter",children:[o("common.review.like")," ",e.like]}),I(S,{type:"Normal",color:"Text.lighter",children:[o("common.grade")," ",re[e.grade]]}),I(S,{type:"Normal",color:"Text.lighter",children:[o("common.load")," ",re[e.load]]}),I(S,{type:"Normal",color:"Text.lighter",children:[o("common.speech")," ",re[e.speech]]})]}),!f.includes(e.id)&&I(Ht,{direction:"row",gap:4,align:"center",onClick:g=>p(g),children:[v(S,{type:"Normal",color:"Highlight.default",children:o("common.review.like")}),v(Ot,{styles:{padding:3},children:v(Qe,{size:18,color:"crimson",onClick:()=>{},children:c??e.likedByUser?v(Ft,{}):v(Ut,{})})})]})]})]});return t?v(At,{clickable:n,children:h}):h}const tn=a.memo(Xt);export{Ft as F,Ot as I,tn as R,Ut as a,Dt as p};
//# sourceMappingURL=ReviewBlock-xeDm_-mz.js.map
