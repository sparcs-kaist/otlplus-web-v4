...
`,pe=v.div`
    ...
    justify-content: center;
    align-items: center;
`,q=({selected:e=!1,chipText:n="",...t})=>i(e?ue:he,{...t,children:i(()=>T(pe,{children:[n,e?i(A,{size:13,onClick:()=>{},children:i(de,{})}):i(A,{size:13,onClick:()=>{},children:i(me,{})})]}),{})}),fe=v.div`
    display: inline-flex;
    flex-direction: row;
    gap: 8px;
    width: 100%;
