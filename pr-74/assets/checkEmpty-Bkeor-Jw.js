import{j as i,a as T,u as F,c as ne,g as Y,s as G,i as re}from"./emotion-react-jsx-runtime.browser.esm-D2PZwVTC.js";import{p as J,r as v}from"./chunk-UIGDSWPH-ClhI_Z4l.js";import{n as y,F as E}from"./FlexWrapper-B6Hxm4Zw.js";import{T as B}from"./Typography-DeI78L6T.js";import{e as U,I as A,y as oe,k as q,u as ie,B as L}from"./useIsDevice-CTOCZjqh.js";import{u as k}from"./index-CHd--ufo.js";import{C as ce,S as ae,m as se,A as le}from"./proxy-D_MLfA2b.js";const me=U(J.jsx("path",{d:"M19 13h-6v6h-2v-6H5v-2h6V5h2v6h6z"})),de=U(J.jsx("path",{d:"M9 16.17 4.83 12l-1.42 1.41L9 19 21 7l-1.41-1.41z"})),X=y.div`
    display: inline-flex;
    padding: 8px;
...
`;function Oe({options:e,onChange:o,timeFilter:t,setTimeFilter:c,resetTrigger:h,onResetTriggerComplete:d}){const{t:f}=k(),p=new Set(e);function m(n){return p.has(n)}const[a,s]=v.useState(I),[S,$]=v.useState({});function I(){const n={};return e.filter(r=>r in P).forEach(r=>{const l=P[r].length;w(r)?n[r]=null:n[r]=Array(l).fill(!1)}),n}function H(n){const r={};return Object.keys(n).forEach(l=>{const x=Z[l];w(l)?n[l]==null?r[l]=null:r[l]=x[n[l]]:r[l]=n[l].map((u,g)=>u?x[g]:null).filter(u=>u!=null)}),r}function O(n){const r={};for(const l in n){const x=n[l];x!=null&&(V(a,l)?w(l)?a[l]==null?delete r[l]:r[l]=x:!a[l].includes(!0)?delete r[l]:r[l]=x:l=="time"&&(r[l]=x))}return r}function M(n,r){s(l=>{if(w(r))return{...l,[r]:n};{const u=l[r].map((g,C)=>C===n?!g:g);return{...l,[r]:u}}})}function R(n){w(n)?s(r=>({...r,[n]:null})):s(r=>({...r,[n]:r[n].map(()=>!1)}))}function z(n,r){return w(r)?n[r]==null:!n[r].includes(!0)}return v.useEffect(()=>{const n=H(a),r={time:t};$(m("time")?{...n,...r}:n)},[a,t]),v.useEffect(()=>{const n=O(S);o(n)},[S]),v.useEffect(()=>{h&&(s(I()),m("time")&&c&&c(null),d())},[h]),i(Ie,{direction:"column",align:"stretch",gap:12,children:e.map(n=>T(E,{direction:"column",gap:6,flex:"1 1 auto",children:[i(B,{type:"NormalBold",color:"Text.default",children:f(`common.search.${n}`)}),i(E,{direction:"column",gap:0,style:{width:"100%"},children:(()=>{if(V(a,n)&&n in a)return i(Se,{nameList:P[n].map(r=>r[1]),chosenList:a[n],handleOptionClick:r=>{M(r,n)},handleSelectAllClick:()=>{R(n)},isSingleSelect:w(n),selectedAll:z(a,n)});if(n=="time")return i(we,{timeFilter:t,setTimeFilter:c})})()})]},n))})}function K(e,o){if(e.inserted[o.name]===void 0)return e.insert("",o,e.sheet,!0)}function Q(e,o,t){var c=[],h=Y(e,c,t);return c.length<2?t:h+o(c)}var je=function(o){var t=ne(o);t.sheet.speedy=function(p){this.isSpeedy=p},t.compat=!0;var c=function(){for(var m=arguments.length,a=new Array(m),s=0;s<m;s++)a[s]=arguments[s];var S=G(a,t.registered,void 0);return re(t,S,!1),t.key+"-"+S.name},h=function(){for(var m=arguments.length,a=new Array(m),s=0;s<m;s++)a[s]=arguments[s];var S=G(a,t.registered),$="animation-"+S.name;return K(t,{name:S.name,styles:"@keyframes "+$+"{"+S.styles+"}"}),$},d=function(){for(var m=arguments.length,a=new Array(m),s=0;s<m;s++)a[s]=arguments[s];var S=G(a,t.registered);K(t,S)},f=function(){for(var m=arguments.length,a=new Array(m),s=0;s<m;s++)a[s]=arguments[s];return Q(t.registered,c,Ae(a))};return{css:c,cx:f,injectGlobal:d,keyframes:h,hydrate:function(m){m.forEach(function(a){t.inserted[a]=!0})},flush:function(){t.registered={},t.inserted={},t.sheet.flush()},sheet:t.sheet,cache:t,getRegisteredStyles:Y.bind(null,t.registered),merge:Q.bind(null,t.registered,c)}},Ae=function e(o){for(var t="",c=0;c<o.length;c++){var h=o[c];if(h!=null){var d=void 0;switch(typeof h){case"boolean":break;case"object":{if(Array.isArray(h))d=e(h);else{d="";for(var f in h)h[f]&&f&&(d&&(d+=" "),d+=f)}break}default:d=h}d&&(t&&(t+=" "),t+=d)}}return t},ke=je({key:"css"}),_=ke.css;const He=_`
    border-color: red;
`,Me=_`
...
`,De=y.div`
    ...
    display: flex;
    align-items: center;
`,ee=v.forwardRef(({placeholder:e,errorMessage:o="",disabled:t=!1,value:c="",handleChange:h,setErrorStatus:d,$placeholderColor:f,...p},m)=>{const a=s=>{h?.(s.target.value)};return v.useEffect(()=>{d?.(!!o)},[o,d]),i(ze,{children:i(De,{children:i(Re,{ref:m,placeholder:e,$hasError:!!o,disabled:t,value:c,onChange:a,$placeholderColor:f,...p})})})});ee.displayName="TextInput";const Ge={hidden:{opacity:0,height:0},visible:{opacity:1,height:"auto"},exit:{opacity:0,height:0}};function Qe({options:e,onSearch:o,SearchIcon:t,timeFilter:c,setTimeFilter:h}){const{t:d}=k(),f=F(),{query:p}=ie("GET","/department-options"),[m,a]=v.useState(!1),[s,S]=v.useState(""),[$,I]=v.useState({}),[H,O]=v.useState(!1);v.useEffect(()=>{c&&a(!0)},[c]);const M=(u,g,C)=>{u.nativeEvent.isComposing||u.key==="Enter"&&n(g,C)};function R(){I({}),S(""),O(!0)}function z(){a(!1)}function n(u,g){a(!1),o(r(u,g))}function r(u,g){const C={};return Object.keys(u).forEach(b=>{const j=u[b];j!=null&&(b=="time"?C[b]=j:(w(b)?C[b]=j[0]:C[b]=j.map(D=>D[0]),b=="department"&&(C[b]=C[b]?.map(D=>p.data?.departments.find(te=>te.code===D.toString())?.id))))}),C.keyword=g,C}function l(u){I(u)}function x(u,g){return u.includes("time")&&g!=null?{timeFilter:g,setTimeFilter:h}:{}}return T(E,{direction:"column",align:"stretch",justify:"stretch",gap:0,style:{maxHeight:"100%",width:"100%"},children:[T(E,{direction:"row",justify:"stretch",align:"center",onClick:()=>{m||a(!0)},gap:0,padding:"4px 16px",children:[t??i(A,{size:17.5,color:f.colors.Highlight.default,onClick:()=>{},children:i(ae,{})}),i(ee,{value:s,handleChange:u=>{S(u)},placeholder:d("common.search.placeholder"),onKeyDown:u=>{M(u,$,s)}})]}),i(le,{children:i(se.div,{initial:"hidden",animate:m?"visible":"hidden",exit:"exit",variants:Ge,transition:{duration:.3,ease:"easeInOut"},style:{display:"flex",flexShrink:1,width:"100%",minHeight:0},children:T(E,{direction:"column",align:"stretch",gap:16,padding:"16px",flex:"1 0 0",style:{overflowY:"auto",minHeight:0},children:[i(Oe,{options:e,onChange:l,...x(e,c),resetTrigger:H,onResetTriggerComplete:()=>{O(!1)}}),T(E,{direction:"row",justify:"flex-end",gap:8,children:[i(L,{$paddingLeft:24,$paddingTop:9,onClick:z,children:i(B,{children:d("common.search.close")})}),i(L,{$paddingLeft:24,$paddingTop:9,onClick:R,type:"state5",children:i(B,{children:d("common.search.reset")})}),i(L,{$paddingLeft:24,$paddingTop:9,type:"selected",onClick:()=>{n($,s)},children:i(B,{children:d("common.search.submit")})})]})]})})})]})}function Fe(e){return!(e.keyword&&e.keyword.trim()!==""||e.type&&e.type.length>0||e.department&&e.department.length>0||e.level&&e.level.length>0||e.term!==void 0||e.time!==void 0)}export{me as A,de as C,Qe as S,Fe as c};
//# sourceMappingURL=checkEmpty-Bkeor-Jw.js.map
