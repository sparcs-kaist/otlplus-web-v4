(function(){try{var e=typeof window<`u`?window:typeof global<`u`?global:typeof globalThis<`u`?globalThis:typeof self<`u`?self:{};e.SENTRY_RELEASE={id:`5e3489c88606a80b22946118536a2b67831212dd`};var t=new e.Error().stack;t&&(e._sentryDebugIds=e._sentryDebugIds||{},e._sentryDebugIds[t]=`a8e25d2a-2fd5-47b6-b00c-22e05f936fbf`,e._sentryDebugIdIdentifier=`sentry-dbid-a8e25d2a-2fd5-47b6-b00c-22e05f936fbf`)}catch{}})();import{n as e,s as t}from"./jsx-runtime-B382Yc7J.js";import{O as n,k as r}from"./chunk-62JRHF6Z-DZNJsNgA.js";import{l as i,n as a,r as o,t as s}from"./emotion-react-jsx-runtime.browser.esm-btUPeI25.js";import{n as c,t as l}from"./FlexWrapper-LYbwkIco.js";import{r as u}from"./emotion-react.browser.esm-fHQgm4RF.js";import{v as d,x as f}from"./axios-BlVP8w8m.js";import{_ as p,g as m,h,t as g}from"./useAPI-CeHLt5bs.js";import{i as _,n as v,r as y,t as b}from"./Credits-js3L3kUi.js";import{t as x}from"./Icon-Bje75kS_.js";import{t as S}from"./Trans-DjHUekSB.js";import{t as C}from"./useTranslation-BcI3bXMy.js";import{t as w}from"./IconButton-Cv4vJteK.js";import{t as T}from"./Close-YKcoYOB_.js";import{t as E}from"./Modal-B3d1cYvl.js";import{t as D}from"./Typography-Dn9fwDKI.js";import{t as O}from"./proxy-gZN2_Ifb.js";import{t as k}from"./media-C28cdZEj.js";import{t as A}from"./useIsDevice-DLV-i3oA.js";import{t as j}from"./Widget-Dxop5I_W.js";import{t as M}from"./LoadingCircle-CKS4HAD6.js";import{n as N,t as P}from"./ReviewBlock-DWnuSQ6K.js";import{n as ee,t as F}from"./checkEmpty-LBivPuD5.js";import{n as I,t as L}from"./ReviewScoreSummary-Dmzei9bk.js";import{t as R}from"./KeyboardArrowDown-DnbqPdqe.js";import{t as te}from"./ReviewWritingBlock-8hzpQ_h_.js";var z=t(e(),1),B=c.div`
    min-width: 150px;
    height: 28px;
    display: inline-flex;
    padding: 8px 16px;
...
`,H=({courseDetail:e,selectedProfessorId:t,setSelectedProfessorId:n})=>{let{t:r}=C(),c=i(),u=A(`mobile`),d=(0,z.useRef)(null),[p,m]=(0,z.useState)(!0);return(0,z.useEffect)(()=>{d.current&&(d.current.scrollLeft=d.current.scrollWidth)},[e]),(0,z.useEffect)(()=>{if(u){m(!0);return}let t=e?.history?.some(e=>e.classes.length>4)??!1;m(t)},[u,e]),o(s,{children:[o(l,{direction:`row`,gap:0,justify:`space-between`,align:`center`,style:{width:`100%`,cursor:`pointer`},onClick:()=>m(e=>!e),children:[a(D,{type:`NormalBold`,color:`Text.default`,children:r(`dictionary.courseHistory`)}),a(w,{onClick:()=>{},children:a(x,{size:20,color:c.colors.Text.default,onClick:()=>{},children:a(ce,{isfolded:p.toString()})})})]}),o(oe,{ref:d,initial:{height:p?0:`auto`},animate:{height:p?0:`auto`},transition:{duration:.2,ease:`easeInOut`},children:[a(`div`,{}),a(l,{direction:`row`,gap:20,style:{minWidth:`min-content`},children:[...e?.history||[]].reverse().map((e,i)=>o(se,{direction:`column`,gap:6,align:`center`,children:[o(D,{type:`Normal`,color:`Text.default`,children:[e.year,` `,f(e.semester)]}),e.classes.length===0?a(V,{color:`Text.disable`,type:`Normal`,children:r(`dictionary.notOffered`)}):a(l,{direction:`column`,gap:4,align:`stretch`,children:e.classes.map((e,r)=>a(ae,{selected:t==(e.professors[0]?.id??-1),chipIndex:e.classNo+` `+e.subtitle,chipText:N(e.professors),onClick:()=>{t===(e.professors[0]?.id??-1)?n(null):n(e.professors[0]?.id??null)}},r))})]},i))})]})]})},U=c(l)`
    width: 100%;
`,W=c(l)`
    width: 300px;
    padding: 10px;
...
`,Q=20;function je({selectedCourseId:e,setSelectedCourseId:t}){let{t:r}=C(),c=i(),u=A(`mobile`),f=(0,z.useRef)(null),[h]=n(),[g,b]=(0,z.useState)(0),[w,T]=(0,z.useState)(!1),[E,O]=(0,z.useState)({courses:[],totalCount:0}),{query:k,setParams:j,data:N}=v(`GET`,`/courses`,{infinites:[`courses`],limit:Q,enabled:w}),{inView:P,ref:L}=_({threshold:0});(0,z.useEffect)(()=>{P&&k.hasNextPage&&!k.isFetchingNextPage&&k.fetchNextPage()},[P]),(0,z.useEffect)(()=>{let e=h.get(`term`)?parseInt(h.get(`term`)):void 0,t={keyword:h.get(`keyword`)||``,type:h.getAll(`type`),department:h.getAll(`department`).map(e=>parseInt(e)),level:h.getAll(`level`).map(e=>parseInt(e))};e!==void 0&&(t.term=e),!F(t)&&R(t)},[]),(0,z.useEffect)(()=>{N!==void 0&&O(N)},[N]),(0,z.useEffect)(()=>{(g!=0||w!=0)&&(O({courses:[],totalCount:0}),j(e=>({...e,order:m[g]??p.CODE,offset:0})),T(!0),f.current?.scrollTo(0,0))},[g]);let R=e=>{if(F(e)){alert(r(`common.search.empty`));return}let t={...e,order:m[g]??p.CODE,offset:0,limit:Q};j(t),T(!0),f.current?.scrollTo(0,0),d(`Search Courses`,{keyword:e.keyword??``,department:e.department??``,type:e.type??``,level:e.level??``,term:e.term??``})};return o(Te,{direction:`column`,justify:`stretch`,align:`stretch`,gap:8,children:[a(Ee,{children:a(ee,{options:[`type`,`department`,`level`,`term`],onSearch:R})}),E.courses.length===0?k.isLoading?a(M,{}):a(De,{type:`Bigger`,color:`Text.placeholder`,children:r(`dictionary.noResults`)}):o(s,{children:[o(l,{direction:`row`,gap:0,justify:`space-between`,align:`center`,children:[o(Oe,{color:`Text.default`,direction:u?`column`:`row`,children:[a(l,{direction:`row`,gap:4,align:`center`,children:a(S,{i18nKey:`dictionary.courseCountInfo1`,count:N?.totalCount,components:{bold:a(D,{type:`NormalBold`,children:void 0}),space:a(s,{children:`\xA0`})}})}),a(l,{direction:`row`,gap:1,align:`center`,children:a(S,{i18nKey:`dictionary.courseCountInfo2`,count:N?.totalCount,components:{icon:a(x,{size:12,color:c.colors.Highlight.default,children:a(I,{})}),space:a(s,{children:`\xA0`})}})})]}),o(ke,{direction:`row`,gap:8,align:`center`,children:[a(D,{type:`NormalBold`,color:`Text.default`,children:r(`dictionary.sort`)}),a(Z,{direction:`row`,gap:0,children:a(y,{options:[r(`dictionary.sortOptions.code`),r(`dictionary.sortOptions.popularity`),r(`dictionary.sortOptions.studentCount`)],setSelectedOption:b,selectedOption:g})})]})]}),o(Ae,{direction:`column`,gap:12,ref:f,children:[E.courses.map((n,r)=>a(we,{course:n,isSelected:e==n.id,selectCourseId:t},r)),k.hasNextPage&&a(M,{ref:L})]})]})]})}var Me=c(l)`
    flex: 1 0 0;
    min-height: 0;
...
`,Fe=r(function(){let e=A(`tablet`),{t}=C(),[r,i]=n(),[s,c]=(0,z.useState)(!1),[l,u]=(0,z.useState)(null);(0,z.useEffect)(()=>{d(`Page View`,{page:`Dictionary`})},[]),(0,z.useEffect)(()=>{let e=r.get(`courseId`);if(e){let t=parseInt(e,10);isNaN(t)?u(null):(u(t),i(e=>(e.delete(`courseId`),e)))}},[]),(0,z.useEffect)(()=>{e?l!==null&&c(!0):c(!1)},[e]),(0,z.useEffect)(()=>{e&&l!==null&&c(!0)},[l]);let f=(0,z.useCallback)(()=>{c(!1),u(null)},[]);return o(Me,{direction:`row`,align:`stretch`,justify:`center`,gap:12,children:[a(Ne,{direction:`column`,align:`stretch`,gap:0,borderRadius:12,children:a(je,{selectedCourseId:l,setSelectedCourseId:u})}),a(Pe,{direction:`column`,align:`stretch`,gap:0,borderRadius:12,children:a(Y,{selectedCourseId:l})}),e&&a(E,{ariaLabel:t(`header.dictionary`),isOpen:s,onClose:f,header:!1,fullScreen:!0,children:a(Y,{selectedCourseId:l,isMobileModal:!0,onMobileModalClose:f})})]})});export{Fe as default};
//# sourceMappingURL=dictionary-CLx0ADT9.js.map