(function(){try{var e=typeof window<`u`?window:typeof global<`u`?global:typeof globalThis<`u`?globalThis:typeof self<`u`?self:{};e.SENTRY_RELEASE={id:`cf3e386fd2c75004da41b840c60e6c06199f8d23`};var t=new e.Error().stack;t&&(e._sentryDebugIds=e._sentryDebugIds||{},e._sentryDebugIds[t]=`e85ce834-fd76-496d-98c7-63c53e48afeb`,e._sentryDebugIdIdentifier=`sentry-dbid-e85ce834-fd76-496d-98c7-63c53e48afeb`)}catch{}})();import{n as e,s as t,t as n}from"./jsx-runtime-CWyXLUtn.js";import{_ as r,g as i,h as a,v as o}from"./sentryEventFilter-JlumNbGQ.js";import{k as s}from"./chunk-62JRHF6Z-Bc-MzIDp.js";import{n as c,r as l,t as u}from"./emotion-react-jsx-runtime.browser.esm-fI3_ye4K.js";import{n as d,t as f}from"./FlexWrapper-DeR0OeXE.js";import{i as p,v as m}from"./axios-Dp9LeCAT.js";import{C as h,S as g,a as _,b as v,i as y,o as b,s as x,t as S,u as C,v as w,x as T,y as ee}from"./useAPI-Df4uYxpE.js";import{r as te,t as E}from"./Icon-JwALgO0w.js";import{t as D}from"./useTranslation-D1dFAkDV.js";import{t as O}from"./Typography-Clp122iA.js";import{t as k}from"./media-Bb-Ew1B4.js";import{t as ne}from"./Widget-qZAZd7gc.js";import{t as re}from"./LoadingCircle-fcB0LPPd.js";import{t as ie}from"./Add-CsY5iTh2.js";import{t as ae}from"./ContentCopy-_a-ahJkL.js";import{t as oe}from"./KeyboardArrowDown-DIJm_xkm.js";var A=t(e(),1),j=t(n(),1),M=te((0,j.jsx)(`path`,{d:`M16 9v10H8V9zm-1.5-6h-5l-1 1H5v2h14V4h-3.5zM18 7H6v12c0 1.1.9 2 2 2h8c1.1 0 2-.9 2-2z`}),`DeleteOutlined`),se=te((0,j.jsx)(`path`,{d:`M7.41 15.41 12 10.83l4.59 4.58L18 14l-6-6-6 6z`}),`KeyboardArrowUp`),N=d.button`
    appearance: none;
    border: 1px solid
...
`,We=[1,2,3,4];function Ge({planner:e,departments:t,busy:n,year:r,semester:i,onYearChange:a,onSemesterChange:o,keywordInputRef:s,onAddFuture:u,onAddArbitrary:d}){let{t:f,i18n:p}=D(),[m,h]=(0,A.useState)(``),[_,v]=(0,A.useState)(null),[y,b]=(0,A.useState)(!1),x=S(`GET`,`/planner-courses`,{enabled:y,apiPrefix:`/api`,apiPath:`/courses`,select:e=>C.parse(e)}),w=x.query.data?.find(e=>e.id===_)??null,T=w===null?`none`:je(e,w);return l(Le,{"aria-labelledby":`planner-course-search-title`,children:[c(R,{id:`planner-course-search-title`,children:f(`planner.search.title`)}),l(Re,{onSubmit:e=>{e.preventDefault(),m.trim()!==``&&(x.setParams({keyword:m.trim(),offset:0,limit:20}),b(!0))},children:[c(F,{"aria-label":f(`planner.search.keyword`),ref:s,value:m,onChange:e=>h(e.target.value),placeholder:f(`planner.search.placeholder`)}),c(N,{$primary:!0,type:`submit`,disabled:n,children:f(`planner.actions.search`)})]}),c(ze,{children:x.query.data?.map(e=>l(Be,{type:`button`,$selected:e.id===_,"aria-pressed":e.id===_,onClick:()=>v(e.id),children:[c(Ve,{children:e.old_code}),p.resolvedLanguage===`en`?e.title_en:e.title]},e.id))}),l(He,{children:[l(L,{children:[f(`planner.grid.targetYear`),c(I,{value:r,onChange:e=>a(Number(e.target.value)),children:Array.from({length:e.end_year-e.start_year+1},(t,n)=>e.start_year+n).map(e=>c(`option`,{value:e,children:e},e))})]}),l(L,{children:[f(`planner.grid.targetSemester`),c(I,{value:i,onChange:e=>o(g.parse(Number(e.target.value))),children:We.map(e=>c(`option`,{value:e,children:f(`planner.semesters.${e}`)},e))})]})]}),T===`future`?c(P,{role:`status`,"aria-live":`polite`,children:f(`planner.search.duplicate`)}):c(N,{$primary:!0,type:`button`,disabled:n||w===null,onClick:()=>{if(w===null)return;let e=T===`taken`&&window.confirm(f(`planner.search.takenDuplicateConfirm`));T===`taken`&&!e||u(w,r,i,{excludeTakenDuplicates:e})},children:f(`planner.actions.addCourse`)}),c(Ue,{}),c(Ie,{departments:t,defaultDepartmentId:e.major_track.department.id,year:r,semester:i,busy:n,onAdd:d})]})}var Ke=d.nav`
    display: flex;
    width: 100%;
    min-width: 0;
...
`,yt=d(I)`
    ...
    min-width: 96px;
    flex: 1 1 96px;
`,bt=[1,2,3,4];function xt(e){return e.item_type===`TAKEN`?{credit:e.lecture.credit,creditAU:e.lecture.credit_au}:e.item_type===`FUTURE`?{credit:e.course.credit,creditAU:e.course.credit_au}:{credit:e.credit,creditAU:e.credit_au}}function St({planner:e,item:t,title:n,code:r,busy:i,onUpdate:a,onRemove:o}){let{t:s}=D(),d=xt(t);return l(mt,{$excluded:t.is_excluded,children:[c(ht,{title:n,children:n}),l(gt,{children:[r,` · `,d.credit,s(`planner.items.credits`),d.creditAU>0&&l(u,{children:[` · `,d.creditAU,` `,s(`planner.items.au`)]}),Me(e,t)&&c(_t,{"aria-label":s(`planner.items.duplicate`),title:s(`planner.items.duplicate`),children:`!`})]}),l(vt,{children:[c(N,{type:`button`,disabled:i,onClick:()=>void a(t,{isExcluded:!t.is_excluded}),children:s(t.is_excluded?`planner.actions.include`:`planner.actions.exclude`)}),t.item_type!==`TAKEN`&&c(yt,{"aria-label":s(`planner.actions.changeSemester`),value:t.semester,disabled:i,onChange:e=>void a(t,{semester:g.parse(Number(e.target.value))}),children:bt.map(e=>c(`option`,{value:e,children:s(`planner.semesters.${e}`)},e))}),t.item_type!==`TAKEN`&&c(N,{$danger:!0,type:`button`,disabled:i,"aria-label":s(`planner.actions.removeItem`),onClick:()=>{window.confirm(s(`planner.actions.removeItemConfirm`))&&o(t)},children:c(E,{size:14,color:`inherit`,children:c(M,{})})})]})]})}var Ct=d.div`
    display: flex;
    flex-direction: column;
    gap: 16px;
`,wt=d.section`
...
`,zt=d(ne)`
    min-height: 240px;
    padding: 24px;
`,Bt=s(function(){let{t:e}=D(),t=Ae(),n=t.selectedPlanner?.id??null,r=(0,A.useRef)(t.planners);r.current=t.planners;let i=(0,A.useRef)(null),[a,o]=(0,A.useState)({year:new Date().getFullYear(),semester:1});(0,A.useEffect)(()=>{m(`Page View`,{page:`Planner`})},[]),(0,A.useEffect)(()=>{if(n===null)return;let e=r.current.find(e=>e.id===n);e!==void 0&&o({year:e.start_year,semester:1})},[n]);let s=(e,t)=>{o({year:e,semester:t}),requestAnimationFrame(()=>{let e=i.current;e?.scrollIntoView({behavior:`smooth`,block:`center`}),e?.focus({preventScroll:!0})})},u=(0,A.useMemo)(()=>{let e=[...t.tracks?.major.map(e=>e.department)??[],...t.tracks?.additional.flatMap(e=>e.department===null?[]:[e.department])??[]];return e.filter((t,n)=>e.findIndex(e=>e.id===t.id)===n)},[t.tracks]);return t.isLoading?c(Ft,{children:l(zt,{direction:`column`,align:`center`,justify:`center`,gap:12,children:[c(re,{}),c(O,{type:`Normal`,color:`Text.placeholder`,children:e(`planner.status.loading`)})]})}):l(Ft,{children:[c(Ze,{planners:t.planners,selectedPlannerId:t.selectedPlannerId,busy:t.isBusy,onSelect:t.setSelectedPlannerId,onCreate:t.createPlanner,onDelete:t.deletePlanner,onReorder:t.reorderPlanner}),t.error!==null&&t.error!==void 0&&l($,{direction:`column`,gap:6,children:[c(O,{type:`NormalBold`,color:`Highlight.dark`,children:e(`planner.status.error`)}),c(O,{type:`Small`,color:`Text.light`,children:t.error.message})]}),t.selectedPlanner===null||t.tracks===void 0?l(zt,{direction:`column`,align:`center`,justify:`center`,gap:12,children:[c(O,{type:`BiggerBold`,color:`Text.default`,children:e(`planner.empty.title`)}),c(O,{type:`Normal`,color:`Text.placeholder`,children:e(`planner.empty.description`)}),c(N,{$primary:!0,disabled:t.isBusy||t.tracks===void 0,onClick:()=>void t.createPlanner(!1),children:e(`planner.actions.create`)})]}):l(It,{children:[l(Lt,{children:[c($,{direction:`column`,gap:12,children:c(Nt,{planner:t.selectedPlanner,busy:t.isBusy,onUpdate:t.updateItem,onRemove:t.removeItem,onRequestAdd:s})}),c($,{direction:`column`,gap:12,children:c(Ge,{planner:t.selectedPlanner,departments:u,busy:t.isBusy,year:a.year,semester:a.semester,onYearChange:e=>o(t=>({...t,year:e})),onSemesterChange:e=>o(t=>({...t,semester:e})),keywordInputRef:i,onAddFuture:t.addFuture,onAddArbitrary:t.addArbitrary})})]}),l(Rt,{"aria-label":e(`planner.settings.title`),children:[c($,{direction:`column`,gap:12,children:c(Pt,{planner:t.selectedPlanner,tracks:t.tracks,busy:t.isBusy,onSave:t.updateTracks})}),c($,{direction:`column`,gap:12,children:c(pt,{planner:t.selectedPlanner})})]})]})]})});export{Bt as default};
//# sourceMappingURL=planner-DA816zBp.js.map