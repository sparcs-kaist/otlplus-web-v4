import{p as D,r as l,z as P,w as Y}from"./chunk-UIGDSWPH-ClhI_Z4l.js";import{j as t,a as n,u as N,F as v}from"./emotion-react-jsx-runtime.browser.esm-D2PZwVTC.js";import{n as r,F as a}from"./FlexWrapper-B6Hxm4Zw.js";import{M as Z}from"./Modal-DiXVtux5.js";import{W as J}from"./Widget-e9ONaX_D.js";import{m as Q,C as _}from"./proxy-BPr2KyJK.js";import{u as O,b as F,C as ee,S as te}from"./Credits-DNqEmA7Y.js";import{L as B}from"./LoadingCircle-D6gxPBw5.js";import{R as oe}from"./ReviewWritingBlock-vWjRFdBA.js";import{e as G,g as q,I as $,k as re,t as E,v as ne,u as ie}from"./useIsDevice-DO0EICOs.js";import{T as u}from"./Typography-DeI78L6T.js";import{I as ce,p as le,R as ae}from"./ReviewBlock-DmnEfFvO.js";import{u as S}from"./useTranslation-DrmvPmDd.js";import{c as R,S as se}from"./checkEmpty-8Yvv3Wfw.js";import{T as de}from"./Trans-B2m4vlKq.js";import{m as I}from"./media-MLnbxw48.js";import"./index-Dp_NaqTT.js";import"./infiniteQueryBehavior-6a3eV7-Q.js";import"./index-ZBsVm-Fx.js";import"./env-QLE-jYCt.js";import"./TextInputArea-CnDje9kG.js";import"./useUserStore-B4JDZcv5.js";const U=G(D.jsx("path",{d:"M12 2C6.47 2 2 6.47 2 12s4.47 10 10 10 10-4.47 10-10S17.53 2 12 2"})),pe=G(D.jsx("path",{d:"M7.41 8.59 12 13.17l4.59-4.58L18 10l-6 6-6-6z"})),V=r.div`
    width: 150px;
    height: 28px;
    display: inline-flex;
    padding: 8px 16px;
...
`,yt=Y(function(){const o=q("tablet"),[d,p]=P(),[f,x]=l.useState(!1),[s,y]=l.useState(null);l.useEffect(()=>{const i=d.get("courseId");if(i){const g=parseInt(i,10);isNaN(g)?y(null):(y(g),p(c=>(c.delete("courseId"),c)))}},[]),l.useEffect(()=>{o?s!==null&&x(!0):x(!1)},[o]),l.useEffect(()=>{o&&s!==null&&x(!0)},[s]);const w=l.useCallback(()=>{x(!1),y(null)},[]);return n(Xe,{direction:"row",align:"stretch",justify:"center",gap:12,children:[t(Ye,{direction:"column",align:"stretch",gap:0,borderRadius:12,children:t(Ke,{selectedCourseId:s,setSelectedCourseId:y})}),t(Ze,{direction:"column",align:"stretch",gap:0,borderRadius:12,children:t(z,{selectedCourseId:s})}),o&&t(Z,{isOpen:f,onClose:w,header:!1,fullScreen:!0,children:t(z,{selectedCourseId:s,isMobileModal:!0,onMobileModalClose:w})})]})});export{yt as default};
//# sourceMappingURL=dictionary-DQUjIDbs.js.map
