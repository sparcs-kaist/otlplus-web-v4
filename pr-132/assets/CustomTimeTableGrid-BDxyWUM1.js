import{j as n,a as m,T as ee}from"./emotion-react-jsx-runtime.browser.esm-PTQtYfCW.js";import{r as o}from"./chunk-JZWAC4HX-Vj8onlRB.js";import{s as u,F as c}from"./FlexWrapper-DKR19g_5.js";import{l as te,I as re}from"./useIsDevice-BNNp6-Vj.js";import{T as $}from"./Typography-CCZ7rBZJ.js";import{I as ne}from"./IconButton-BbQTytIh.js";import{l as oe}from"./index-CKO-o_SB.js";import{C as ae}from"./proxy-BistTYm1.js";import{u as ve}from"./useTranslation-Kwjulw0f.js";(function(){try{var e=typeof window<"u"?window:typeof global<"u"?global:typeof globalThis<"u"?globalThis:typeof self<"u"?self:{};e.SENTRY_RELEASE={id:"e8d89222aeeb3c67f1c6f1e6e657f73d9c86c1d7"};var t=new e.Error().stack;t&&(e._sentryDebugIds=e._sentryDebugIds||{},e._sentryDebugIds[t]="55392597-0364-4cf9-bc1c-5a4d3e832a58",e._sentryDebugIdIdentifier="sentry-dbid-55392597-0364-4cf9-bc1c-5a4d3e832a58")}catch{}})();const ie=u.div`
    width: 100%;
    height: 100%;
    display: grid;
    position: relative;
...
`;function Ee({block:e,deleteBlock:t,handleBlockTileHover:a,handleBlockTileSelect:s,isGhost:h=!1}){return n($e,{direction:"column",gap:0,padding:"1px 0px",justify:"stretch",align:"stretch",col:e.day+1,rowStart:e.begin/30-14,rowEnd:e.end/30-14,blockId:e.id,onPointerEnter:()=>a?.(e),onPointerDown:()=>s?.(e),onTouchMove:()=>a?.(e),...h?{"data-ghost":!0}:{},children:m(ke,{direction:"row",gap:0,flex:"1 1 auto",align:"stretch",justify:"stretch",padding:"2px",blockId:e.id,className:K,children:[n(c,{direction:"column",justify:"flex-start",flex:"1 1 auto",gap:0,padding:"4px 0px 4px 4px",children:n(c,{direction:"column",gap:0,align:"flex-start",style:{overflow:"hidden"},children:m(ee,{theme:oe,children:[n($,{type:"Small",color:"Text.dark",className:"block-title",children:e.block_name}),e.place&&n($,{type:"Small",color:"Text.lighter",className:"block-info",children:e.place})]})})}),n(we,{direction:"column",flex:"0 1 0",gap:0,align:"flex-end",justify:"flex-start",className:"block-delete-wrapper",children:n(ne,{styles:{padding:3},onClick:t,children:n(re,{size:12,style:{color:"rgba(255, 255, 255, 0.6)",opacity:t?1:0,pointerEvents:t?"auto":"none"},children:n(ae,{})})})})]})})}const Te=o.memo(Ee),Ce=e=>[e.red[1],e.red[2],e.orange[1],e.orange[2],e.yellow[1],e.yellow[2],e.green[1],e.green[2],e.green[3],e.blue[1],e.blue[2],e.purple[1],e.purple[2],e.pink[1],e.pink[2]],Se=u(c)`
    display: none;
