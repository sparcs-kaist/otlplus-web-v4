(function(){try{var e=typeof window<`u`?window:typeof global<`u`?global:typeof globalThis<`u`?globalThis:typeof self<`u`?self:{};e.SENTRY_RELEASE={id:`dffc4b5d78ff7732700ecb8afede2241d7fe845e`};var t=new e.Error().stack;t&&(e._sentryDebugIds=e._sentryDebugIds||{},e._sentryDebugIds[t]=`e1f09cfa-d61f-43d4-abe2-66e7e95b495f`,e._sentryDebugIdIdentifier=`sentry-dbid-e1f09cfa-d61f-43d4-abe2-66e7e95b495f`)}catch{}})();import{n as e,s as t}from"./jsx-runtime-BBsoE34y.js";import{n,o as r,r as i}from"./emotion-react-jsx-runtime.browser.esm-DsP7x62g.js";import{n as a,t as o}from"./FlexWrapper-D1OeJB0D.js";import{i as s,n as c}from"./emotion-react.browser.esm-BK51Fhu3.js";import{i as l}from"./useAPI-CU8JiwIG.js";import{t as u}from"./Icon-BrBs2Alf.js";import{t as d}from"./IconButton-h8BYtBFZ.js";import{t as f}from"./useTranslation-DS7_6j-P.js";import{t as p}from"./Close-CDoJP8nu.js";import{t as m}from"./Typography-BYxYqF8O.js";import{t as h}from"./light-CtTHawp5.js";var g=t(e()),_=a.div`
    width: 100%;
    height: 100%;
    display: grid;
    position: relative;
...
`;function k({lecture:e,classIdx:t,deleteLecture:r,handleLectureTileSelect:a,handleLectureTileHover:s,handleLectureTileLeave:c}){let l=e.classes[t];if(l==null)return null;let f=(0,g.useCallback)(t=>{a?.(e,t)},[a,e]),h=(0,g.useCallback)(()=>{s?.(e)},[s,e]),_=(0,g.useCallback)(()=>{c?.()},[c]);return n(E,{direction:`column`,gap:0,padding:`1px 0px`,justify:`stretch`,align:`stretch`,col:l.day+1,rowStart:l.begin/30-14,rowEnd:l.end/30-14,lectureId:e.id,"data-class-time":l.day*24*60+l.begin,onPointerDown:f,onPointerEnter:h,onPointerLeave:_,children:i(D,{direction:`row`,gap:0,flex:`1 1 auto`,align:`stretch`,justify:`stretch`,padding:`2px`,courseId:e.courseId,lectureId:e.id,className:C,children:[n(o,{direction:`column`,justify:`center`,flex:`1 1 auto`,gap:0,padding:`4px`,children:i(o,{direction:`column`,gap:0,align:`flex-start`,style:{overflow:`hidden`},children:[n(m,{type:`SmallMedium`,className:`lecture-title`,color:`TimeTable.title`,children:e.name+` `+e.subtitle}),n(m,{type:`Small`,className:`lecture-info`,color:`TimeTable.detail`,children:e.professors.map(e=>e.name).join(`, `)}),n(m,{type:`Small`,className:`lecture-info`,color:`TimeTable.detail`,children:`(${l.buildingCode}) ${l.roomName}`})]})}),r&&n(O,{direction:`column`,flex:`1 1 auto`,gap:0,className:`lecture-delete-wrapper`,onPointerDown:e=>e.stopPropagation(),onClick:e=>e.stopPropagation(),children:n(d,{styles:{padding:3},onClick:()=>r(e),children:n(u,{size:12,style:{color:`rgba(255, 255, 255, 0.6)`,opacity:1,pointerEvents:`auto`},children:n(p,{})})})})]})})}var A=(0,g.memo)(k,(e,t)=>e.lecture===t.lecture&&e.classIdx===t.classIdx),j=a(o)`
...
`;function I({lecture:e,classIdx:t,deleteLecture:r}){let a=t==null?null:e.classes[t],{t:s}=f();return i(P,{direction:`column`,gap:2,align:`stretch`,justify:`stretch`,padding:`2px`,flex:`1 1 auto`,lectureId:e.id,children:[n(o,{direction:`column`,gap:0,align:`center`,children:a!=null&&v[a.day]&&a.begin!=null&&a.end!=null?i(m,{type:`Smaller`,color:`Text.light`,children:[s(`common.days.${v[a.day]}`),` `,Math.floor(a.begin/60),`:`,a.begin%60==0?`00`:`30`,` - `,Math.floor(a.end/60),`:`,a.end%60==0?`00`:`30`]}):n(m,{type:`Smaller`,color:`Text.light`,children:s(`timetable.noTimeInfo`)})}),i(F,{direction:`column`,gap:0,align:`flex-start`,padding:`6px`,courseId:e.courseId,lectureId:e.id,flex:`1 1 auto`,className:C,children:[n(m,{type:`SmallMedium`,className:`lecture-title`,color:`TimeTable.title`,children:e.name+` `+e.subtitle}),n(m,{type:`Small`,className:`lecture-info`,color:`TimeTable.detail`,children:e.professors.map(e=>e.name).join(`, `)}),n(m,{type:`Small`,className:`lecture-info`,color:`TimeTable.detail`,children:a==null?``:`(${a.buildingCode}) ${a.roomName}`}),r&&n(O,{direction:`column`,flex:`1 1 auto`,gap:0,className:`lecture-delete-wrapper`,onPointerDown:e=>e.stopPropagation(),onClick:e=>e.stopPropagation(),children:n(d,{styles:{padding:3},onClick:()=>r(),children:n(u,{size:12,style:{color:`rgba(255, 255, 255, 0.6)`,opacity:1,pointerEvents:`auto`},children:n(p,{})})})})]})]})}var L=`custom-block-tile`,R=e=>c`
    background: ${e.colors.Highlight.default};
